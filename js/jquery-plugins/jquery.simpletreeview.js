            ...
            function setup($nodes) {
                ...
                $nodes.each(function() {
                    ...
                    if($childs.size() > 0) {
                        ...
                        $node.prepend('<span class="handle" style="margin-right:3px;">' + (settings.collapsed || $ul.is(":hidden") ? settings.close : settings.open) + '</span>');
                    ...
                    {
                        $node.html('<span style="position:relative;left:16px;">'+$node.html()+' </span>');
