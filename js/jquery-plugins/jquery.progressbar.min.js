...
(function($){$.extend({progressBar:new function(){this.defaults={steps:20,stepDuration:20,max:100,showText:true,textFormat:'percentage',width:120,height:12,callback:null,boxImage:document.location.protocol + '//' + location.host + '/cieprev/img/bar_progresso/progressbar.gif',barImage:{0:document.location.protocol + '//' + location.host + '/cieprev/img/bar_progresso/progressbg_red.gif',30:document.location.protocol + '//' + location.host + '/cieprev/img/bar_progresso/progressbg_orange.gif',70:document.location.protocol + '//' + location.host + '/cieprev/img/bar_progresso/progressbg_green.gif'},running_value:0,value:0,image:null};this.construct=function(arg1,arg2){var argvalue=null;var argconfig=null;if(arg1!=null){if(!isNaN(arg1)){argvalue=arg1;if(arg2!=null){argconfig=arg2;}}else{argconfig=arg1;}}
