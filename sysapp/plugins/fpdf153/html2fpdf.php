...
//! @return An object (a class instance)
  ...
  $this->DisplayPreferences('');
	...
	$this->SetFont('Courier','',10); // Changeable?(not yet...)
  ...
  $this->row=-1; 
	...
	$this->fontlist=array("courier","arial","times","courier","helvetica","symbol","monospace","serif","sans");
...
//! @desc Prepares buffered text to be printed with FlowingBlock()
    ...
    for($i=0;$i < $array_size; $i++)
    {
      ...
      if(isset($vetor[4]) and $vetor[4] != '') $this->SetFont('Courier','',10);
