...
class FpdiProtection extends \setasign\Fpdi\Fpdi
{
    ...
    /**
     * Whether document is public or not
     *
     * @var bool
     */
     ...
     * @return string
      */
    public function computeOValue($userPassword, $ownerPassword = '')
    {
     ...
     * @return string
     */
    public function computeEncryptionKey($password = '')
    {
        $revision = $this->revision;
     ...
     * @return string
     */
    public function computeUValue($encryptionKey)
    {
        $revision = $this->revision;
     ...
     * @return string
     */
    public function arcfour($key, $data)
    {
     ...
     * @return bool|string
     */
    public function getEncryptionKeyByObjectNumber($objectNumber)
    {
        return substr(
            substr(
