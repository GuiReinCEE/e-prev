...
class CI_Email {
	...
	var	$useragent		= "FundacaoCEEEMail";
	...
	public function from($from, $name = '')
	{
		...
		$this->_set_header('From', $name.' <'.$from.'>\r\n'); ### Para internamente manter o alias (apelido) ex.: Controle de Atividade <fundacao@eletroceee.com.br>
