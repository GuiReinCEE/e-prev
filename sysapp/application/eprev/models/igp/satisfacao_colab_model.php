...
class Satisfacao_colab_model extends Model
{
	...
	function carregar($cd)
	{
		$qr_sql = " 
					SELECT cd_satisfacao_colab,
					 ...
					 WHERE cd_satisfacao_colab = ".intval($cd)."
			      ";
	...
	function salvar($args,&$msg=array())
	{
		...
		{
			$qr_sql = "
						INSERT INTO igp.satisfacao_colab 
						     ( 
							    dt_referencia,
								nr_satisfacao,
								nr_meta,
		...
		else
		{
			$qr_sql = "
						UPDATE igp.satisfacao_colab 
			             ...
			             WHERE cd_satisfacao_colab = ".intval($args['cd_satisfacao_colab'])."
			          ";			
		}
	...
	function excluir($id)
	{
		$qr_sql = " 
					UPDATE igp.satisfacao_colab 
		             ...
		             WHERE MD5(cd_satisfacao_colab::TEXT) = '".trim($id)."' 
		          "; 
		$this->db->query($qr_sql);
	}	
}
