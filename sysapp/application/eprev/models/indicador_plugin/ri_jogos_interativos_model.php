<?php
class ri_jogos_interativos_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_ri_jogos_interativos,
			       cd_indicador_tabela,
			       dt_referencia,
				   ...
				   nr_percentual_f,
				   nr_meta
		      FROM indicador_plugin.ri_jogos_interativos
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_ri_jogos_interativos,
				   ...
				   nr_meta 
		      FROM indicador_plugin.ri_jogos_interativos 
			 WHERE cd_ri_jogos_interativos = ".intval($args['cd']).";";
	...
	{
		if(intval($args['cd_ri_jogos_interativos']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.ri_jogos_interativos 
				     (
						dt_referencia,
						dt_inclusao,
						cd_usuario_inclusao,
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.ri_jogos_interativos
			     ...
			     WHERE cd_ri_jogos_interativos = ".intval($args['cd_ri_jogos_interativos']).";";
		}
