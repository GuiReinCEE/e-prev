<?php
class Juridico_sucesso_acoes_civel_fundacao_autora_model extends Model
{
    public function listar($cd_indicador_tabela)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_civel_fundacao_autora,
    ...
    public function carrega($cd_juridico_sucesso_acoes_civel_fundacao_autora)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_civel_fundacao_autora,
				   ...
				   nr_proc_max
              FROM indicador_plugin.juridico_sucesso_acoes_civel_fundacao_autora
             WHERE cd_juridico_sucesso_acoes_civel_fundacao_autora = ".intval($cd_juridico_sucesso_acoes_civel_fundacao_autora).";";
    ...
    {
        $qr_sql = "
            INSERT INTO indicador_plugin.juridico_sucesso_acoes_civel_fundacao_autora
            (
                cd_indicador_tabela, 
                dt_referencia, 
                ds_observacao,
    ...
    public function atualizar($cd_juridico_sucesso_acoes_civel_fundacao_autora, $args = array())
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_civel_fundacao_autora 
    ...
    public function excluir($cd_juridico_sucesso_acoes_civel_fundacao_autora, $cd_usuario)
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_civel_fundacao_autora 
