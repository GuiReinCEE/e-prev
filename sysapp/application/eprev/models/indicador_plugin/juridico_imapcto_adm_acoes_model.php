<?php
class Juridico_imapcto_adm_acoes_model extends Model
{
    ...
    {
        $qr_sql = "
            SELECT cd_juridico_imapcto_adm_acoes,
                   cd_indicador_tabela,
                   dt_referencia,
                   ...
                   nr_percentual_f,
                   nr_meta
              FROM indicador_plugin.juridico_imapcto_adm_acoes
    ...
    function carrega_referencia(&$result, $args=array())
    {
        $qr_sql = "
            SELECT TO_CHAR(dt_referencia + '1 month'::interval,'DD/MM/YYYY') AS dt_referencia, 
              ...
              FROM indicador_plugin.juridico_imapcto_adm_acoes 
             WHERE dt_exclusao IS NULL 
             ORDER BY juridico_imapcto_adm_acoes.dt_referencia DESC 
             LIMIT 1;";
    ...
    function carrega(&$result, $args=array())
    {
        $qr_sql = "
            SELECT cd_juridico_imapcto_adm_acoes,
                   ...
                   observacao
              FROM indicador_plugin.juridico_imapcto_adm_acoes
             WHERE cd_juridico_imapcto_adm_acoes = ".intval($args['cd_juridico_imapcto_adm_acoes']).";";
    ...
    function salvar(&$result, $args=array())
    {
        ...
        {
            $qr_sql = "
                INSERT INTO indicador_plugin.juridico_imapcto_adm_acoes 
                     (
                        dt_referencia, 
                        nr_valor_1, 
                        nr_valor_2, 
        ...
        {
            $qr_sql = "
                UPDATE indicador_plugin.juridico_imapcto_adm_acoes
    ...
    function salvar_fechar_periodo(&$result, $args=array())
    {
      $qr_sql = "
              INSERT INTO indicador_plugin.juridico_imapcto_adm_acoes 
                   (
