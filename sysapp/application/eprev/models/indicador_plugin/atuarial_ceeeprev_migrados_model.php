<?php
class Atuarial_ceeeprev_migrados_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_atuarial_ceeeprev_migrados,
	...
	public function carrega($cd_atuarial_ceeeprev_migrados)
	{
		$qr_sql = "
            SELECT cd_atuarial_ceeeprev_migrados,
                   ...
                   observacao
		      FROM indicador_plugin.atuarial_ceeeprev_migrados 
			 WHERE cd_atuarial_ceeeprev_migrados = ".intval($cd_atuarial_ceeeprev_migrados).";";
	...
	{
		if(intval($args['cd_atuarial_ceeeprev_migrados']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.atuarial_ceeeprev_migrados 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.atuarial_ceeeprev_migrados
			     ...
			     WHERE cd_atuarial_ceeeprev_migrados = ".intval($args['cd_atuarial_ceeeprev_migrados']).";";
		}

		$this->db->query($qr_sql);
	}
	
	public function excluir($cd_atuarial_ceeeprev_migrados, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.atuarial_ceeeprev_migrados
