<?php
class Controladoria_cobertura_benf_cd_inpel_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT i.cd_controladoria_cobertura_benf_cd_inpel,
	...
	public function carrega($cd_controladoria_cobertura_benf_cd_inpel)
	{
		$qr_sql = "
            SELECT cd_controladoria_cobertura_benf_cd_inpel,
                   ...
                   nr_meta,
                   observacao
		      FROM indicador_plugin.controladoria_cobertura_benf_cd_inpel 
			 WHERE cd_controladoria_cobertura_benf_cd_inpel = ".intval($cd_controladoria_cobertura_benf_cd_inpel).";";
	...
	{
		if(intval($args['cd_controladoria_cobertura_benf_cd_inpel']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.controladoria_cobertura_benf_cd_inpel 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.controladoria_cobertura_benf_cd_inpel
			     ...
			     WHERE cd_controladoria_cobertura_benf_cd_inpel = ".intval($args['cd_controladoria_cobertura_benf_cd_inpel']).";";
		}

		$this->db->query($qr_sql);
	}
	
	public  function excluir($cd_controladoria_cobertura_benf_cd_inpel, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.controladoria_cobertura_benf_cd_inpel
