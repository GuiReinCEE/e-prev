<?php
class ri_acessos_boletim_em_pauta_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_ri_acessos_boletim_em_pauta,
			       cd_indicador_tabela,
			       dt_referencia,
				   ...
				   nr_percentual_f,
				   nr_meta
		      FROM indicador_plugin.ri_acessos_boletim_em_pauta
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_ri_acessos_boletim_em_pauta,
				   ...
				   nr_meta 
		      FROM indicador_plugin.ri_acessos_boletim_em_pauta 
			 WHERE cd_ri_acessos_boletim_em_pauta = ".intval($args['cd']).";";
	...
	{
		if(intval($args['cd_ri_acessos_boletim_em_pauta']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.ri_acessos_boletim_em_pauta 
				     (
						dt_referencia,
						dt_inclusao,
						cd_usuario_inclusao,
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.ri_acessos_boletim_em_pauta
			     ...
			     WHERE cd_ri_acessos_boletim_em_pauta = ".intval($args['cd_ri_acessos_boletim_em_pauta']).";";
		}
