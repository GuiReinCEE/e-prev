...
<?php
class Controladoria_cobertura_benf_cd_foz_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT i.cd_controladoria_cobertura_benf_cd_foz,
	...
	public function carrega($cd_controladoria_cobertura_benf_cd_foz)
	{
		$qr_sql = "
            SELECT cd_controladoria_cobertura_benf_cd_foz,
                   ...
                   nr_meta,
                   observacao
		      FROM indicador_plugin.controladoria_cobertura_benf_cd_foz 
			 WHERE cd_controladoria_cobertura_benf_cd_foz = ".intval($cd_controladoria_cobertura_benf_cd_foz).";";
	...
	{
		if(intval($args['cd_controladoria_cobertura_benf_cd_foz']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.controladoria_cobertura_benf_cd_foz 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.controladoria_cobertura_benf_cd_foz
			     ...
			     WHERE cd_controladoria_cobertura_benf_cd_foz = ".intval($args['cd_controladoria_cobertura_benf_cd_foz']).";";
		}

		$this->db->query($qr_sql);
	}
	
	public  function excluir($cd_controladoria_cobertura_benf_cd_foz, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.controladoria_cobertura_benf_cd_foz
