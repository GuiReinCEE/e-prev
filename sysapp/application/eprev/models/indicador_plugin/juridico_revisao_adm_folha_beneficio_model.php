<?php
class Juridico_revisao_adm_folha_beneficio_model extends Model
{
    ...
    {
        $qr_sql = "
            SELECT cd_juridico_revisao_adm_folha_beneficio,
                   cd_indicador_tabela,
                   dt_referencia,
                   ...
                   nr_percentual_f,
                   nr_meta
              FROM indicador_plugin.juridico_revisao_adm_folha_beneficio
    ...
    function carrega_referencia(&$result, $args=array())
    {
        $qr_sql = "
            SELECT TO_CHAR(dt_referencia + '1 month'::interval,'DD/MM/YYYY') AS dt_referencia, 
              ...
              FROM indicador_plugin.juridico_revisao_adm_folha_beneficio 
             WHERE dt_exclusao IS NULL 
             ORDER BY juridico_revisao_adm_folha_beneficio.dt_referencia DESC 
             LIMIT 1;";
    ...
    function carrega(&$result, $args=array())
    {
        $qr_sql = "
            SELECT cd_juridico_revisao_adm_folha_beneficio,
                   ...
                   observacao
              FROM indicador_plugin.juridico_revisao_adm_folha_beneficio
             WHERE cd_juridico_revisao_adm_folha_beneficio = ".intval($args['cd_juridico_revisao_adm_folha_beneficio']).";";
    ...
    function salvar(&$result, $args=array())
    {
        ...
        {
            $qr_sql = "
                INSERT INTO indicador_plugin.juridico_revisao_adm_folha_beneficio 
                     (
                        dt_referencia, 
                        nr_valor_1, 
                        nr_valor_3, 
        ...
        {
            $qr_sql = "
                UPDATE indicador_plugin.juridico_revisao_adm_folha_beneficio
