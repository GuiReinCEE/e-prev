<?php
class Igp_sat_participantes_instituidores_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_igp_sat_participantes_instituidores,
				   cd_indicador_tabela,
				   TO_CHAR(dt_referencia,'YYYY') AS ano_referencia,
				   TO_CHAR(dt_referencia,'YYYY') AS mes_referencia,
				   dt_referencia,
				   nr_valor_1,
				   nr_valor_2,
				   nr_resultado,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_plugin.igp_sat_participantes_instituidores 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_igp_sat_participantes_instituidores,
				   ...
				   observacao
			  FROM indicador_plugin.igp_sat_participantes_instituidores
			 WHERE cd_igp_sat_participantes_instituidores = ".intval($args['cd_igp_sat_participantes_instituidores']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.igp_sat_participantes_instituidores
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.igp_sat_participantes_instituidores
