<?php
class Atuarial_exigencia_previc_novo_plano_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_atuarial_exigencia_previc_novo_plano,
				   cd_indicador_tabela,
				   ...
				   nr_meta_resultado,
				   ds_observacao
			  FROM indicador_plugin.atuarial_exigencia_previc_novo_plano 
	...
	public function carrega($cd_atuarial_exigencia_previc_novo_plano)
	{
		$qr_sql = "
			SELECT cd_atuarial_exigencia_previc_novo_plano,
				   cd_indicador_tabela,
			  ...
			  FROM indicador_plugin.atuarial_exigencia_previc_novo_plano 
			 WHERE dt_exclusao IS NULL
			   AND cd_atuarial_exigencia_previc_novo_plano = ".intval($cd_atuarial_exigencia_previc_novo_plano)."
			 ORDER BY dt_referencia ASC;";
	...
	{
		$qr_sql = "
			INSERT INTO indicador_plugin.atuarial_exigencia_previc_novo_plano
			     (
                   dt_referencia, 
                   cd_indicador_tabela, 
                   fl_media, 
	...
	public function atualizar($cd_atuarial_exigencia_previc_novo_plano, $args)
	{
		$qr_sql = "
			UPDATE indicador_plugin.atuarial_exigencia_previc_novo_plano
			 ...
			 WHERE cd_atuarial_exigencia_previc_novo_plano = ".intval($cd_atuarial_exigencia_previc_novo_plano).";";

		$this->db->query($qr_sql);	
	}

	public function excluir($cd_atuarial_exigencia_previc_novo_plano, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.atuarial_exigencia_previc_novo_plano 
