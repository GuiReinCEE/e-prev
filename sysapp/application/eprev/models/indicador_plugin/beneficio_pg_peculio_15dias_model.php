<?php
class beneficio_pg_peculio_15dias_model extends Model
{
	...
	function listar( &$result, $args=array() )
	{
		...
		cd_beneficio_pg_peculio_15dias
	...
	function carregar($cd)
	{
		...
		if( intval($cd)>0 )
		{
			$sql .= " WHERE cd_beneficio_pg_peculio_15dias={cd_beneficio_pg_peculio_15dias} ";
			esc( "{cd_beneficio_pg_peculio_15dias}", intval($cd), $sql );
	...
	{
		if(intval($args['cd_beneficio_pg_peculio_15dias'])==0)
		{
			$sql="
			INSERT INTO indicador_plugin.beneficio_pg_peculio_15dias ( 
		...
		{
			$sql="
			UPDATE indicador_plugin.beneficio_pg_peculio_15dias 
			SET 
			
			cd_beneficio_pg_peculio_15dias = {cd_beneficio_pg_peculio_15dias} 
		...
		esc("{cd_beneficio_pg_peculio_15dias}", $args["cd_beneficio_pg_peculio_15dias"], $sql, "int", FALSE);
	...
	function excluir($id)
	{
		...
		WHERE md5(cd_beneficio_pg_peculio_15dias::varchar)='{cd_beneficio_pg_peculio_15dias}' 
		"; 
		esc('{cd_usuario_exclusao}', usuario_id(), $sql, 'int'); 
		esc('{cd_beneficio_pg_peculio_15dias}', $id, $sql, 'str'); 
