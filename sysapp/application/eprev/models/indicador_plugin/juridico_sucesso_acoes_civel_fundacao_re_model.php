<?php
class Juridico_sucesso_acoes_civel_fundacao_re_model extends Model
{
    public function listar($cd_indicador_tabela)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_civel_fundacao_re,
    ...
    public function carrega($cd_juridico_sucesso_acoes_civel_fundacao_re)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_civel_fundacao_re,
				   ...
				   nr_proc_max
              FROM indicador_plugin.juridico_sucesso_acoes_civel_fundacao_re
             WHERE cd_juridico_sucesso_acoes_civel_fundacao_re = ".intval($cd_juridico_sucesso_acoes_civel_fundacao_re).";";
    ...
    {
        $qr_sql = "
            INSERT INTO indicador_plugin.juridico_sucesso_acoes_civel_fundacao_re
            (
                cd_indicador_tabela, 
                dt_referencia, 
                ds_observacao,
    ...
    public function atualizar($cd_juridico_sucesso_acoes_civel_fundacao_re, $args = array())
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_civel_fundacao_re 
    ...
    public function excluir($cd_juridico_sucesso_acoes_civel_fundacao_re, $cd_usuario)
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_civel_fundacao_re 
