<?php
class juridico_sucesso_acoes_juchem_model extends Model
{
	...
	{
		$qr_sql = "
					SELECT i.cd_juridico_sucesso_acoes_juchem,
						   ...
						   i.nr_total_geral,
						   i.nr_meta
					  FROM indicador_plugin.juridico_sucesso_acoes_juchem i
		...
		$qr_sql = "
					SELECT x.value, 
					 ...
					 WHERE x.value NOT IN (SELECT i.cd_etapa
					                         FROM indicador_plugin.juridico_sucesso_acoes_juchem i
								            WHERE i.dt_exclusao IS NULL
											  AND i.cd_juridico_sucesso_acoes_juchem <> ".intval($args['cd_juridico_sucesso_acoes_juchem'])."
	...
	{
		$qr_sql = "
					SELECT cd_juridico_sucesso_acoes_juchem,
					 ...
					 WHERE cd_juridico_sucesso_acoes_juchem = ".intval($args['cd_juridico_sucesso_acoes_juchem']).";
			      ";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
						INSERT INTO indicador_plugin.juridico_sucesso_acoes_juchem 
							 (
								dt_referencia, 
						        cd_etapa,
						        nr_inicial,
		...
		{
			$qr_sql = "
						UPDATE indicador_plugin.juridico_sucesso_acoes_juchem
