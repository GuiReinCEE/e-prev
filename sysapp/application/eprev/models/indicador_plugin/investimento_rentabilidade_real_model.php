<?php
class Investimento_rentabilidade_real_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT i.cd_investimento_rentabilidade_real,
				   ...
				   CASE WHEN (SELECT MAX(i1.dt_referencia)
                                FROM indicador_plugin.investimento_rentabilidade_real i1
					    ...
					    ELSE 'N'
				   END AS fl_editar
		      FROM indicador_plugin.investimento_rentabilidade_real i
	...
	{
		$qr_sql = "
            SELECT cd_investimento_rentabilidade_real,
                   ...
                   nr_valor_7,
                   observacao
		      FROM indicador_plugin.investimento_rentabilidade_real 
			 WHERE cd_investimento_rentabilidade_real = ".intval($args['cd_investimento_rentabilidade_real']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.investimento_rentabilidade_real 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.investimento_rentabilidade_real
