<?php
class Administrativo_correspondencias_devolvidas_model extends Model
{
    public function listar($cd_indicador_tabela)
    {
        $qr_sql = "
            SELECT cd_administrativo_correspondencias_devolvidas,
                   ...
                   nr_meta,
                   nr_resultado
              FROM indicador_plugin.administrativo_correspondencias_devolvidas
    ...
    public function carrega($cd_administrativo_correspondencias_devolvidas)
    {
        $qr_sql = "
            SELECT cd_administrativo_correspondencias_devolvidas,
                   ...
                   nr_meta
              FROM indicador_plugin.administrativo_correspondencias_devolvidas
             WHERE cd_administrativo_correspondencias_devolvidas = ".intval($cd_administrativo_correspondencias_devolvidas).";";
    ...
    {
        $qr_sql = "
            INSERT INTO indicador_plugin.administrativo_correspondencias_devolvidas
            (
                cd_indicador_tabela, 
                dt_referencia, 
                ds_observacao,
        ...
        VALUES 
            ( 
                ...
                ".(trim($args['nr_expedidas']) != '' ? floatval($args['nr_expedidas']) : "DEFAULT").",
                ".(trim($args['nr_devolvidas']) != '' ? floatval($args['nr_devolvidas']) : "DEFAULT").",
    ...
    public function atualizar($cd_administrativo_correspondencias_devolvidas, $args = array())
    {
        $qr_sql = "
            UPDATE indicador_plugin.administrativo_correspondencias_devolvidas 
               SET dt_referencia        = ".(trim($args['dt_referencia']) != '' ?  "TO_DATE('".trim($args['dt_referencia'])."', 'DD/MM/YYYY')" : "DEFAULT").", 
                   ...
                   nr_expedidas         = ".(trim($args['nr_expedidas']) != '' ? floatval($args['nr_expedidas']) : "DEFAULT").",    
                   nr_devolvidas        = ".(trim($args['nr_devolvidas']) != '' ? floatval($args['nr_devolvidas']) : "DEFAULT").", 
    ...
    public function excluir($cd_administrativo_correspondencias_devolvidas, $cd_usuario)
    {
        $qr_sql = "
            UPDATE indicador_plugin.administrativo_correspondencias_devolvidas 
