<?php
class Atuarial_rge_model extends Model
{
	...
	public function carrega($cd_atuarial_rge)
	{
		$qr_sql = "
            SELECT cd_atuarial_rge,
                   ...
                   observacao
		      FROM indicador_plugin.atuarial_rge 
			 WHERE cd_atuarial_rge = ".intval($cd_atuarial_rge).";";
	...
	{
		if(intval($args['cd_atuarial_rge']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.atuarial_rge 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.atuarial_rge
			     ...
			     WHERE cd_atuarial_rge = ".intval($args['cd_atuarial_rge']).";";
		}

		$this->db->query($qr_sql);
	}
	
	public function excluir($cd_atuarial_rge, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.atuarial_rge
