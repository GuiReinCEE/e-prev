<?php
class Beneficio_inc_seprorgs_model extends Model
{
    ...
    public function listar($cd_indicador_tabela, $args = array())
	{
		$qr_sql = "
			SELECT cd_beneficio_inc_seprorgs,
				   ...
				   nr_percentual_f,
				   nr_meta 
			  FROM indicador_plugin.beneficio_inc_seprorgs 
	...
	public function carrega($cd_beneficio_inc_seprorgs)
	{
		$qr_sql = " 
			SELECT cd_beneficio_inc_seprorgs,
				   TO_CHAR(dt_referencia,'YYYY') as ano_referencia,
				   ...
				   nr_meta 
		      FROM indicador_plugin.beneficio_inc_seprorgs 
		     WHERE cd_beneficio_inc_seprorgs = ".intval($cd_beneficio_inc_seprorgs).";";
	...
	{
		$qr_sql="
			INSERT INTO indicador_plugin.beneficio_inc_seprorgs 
					( 
						dt_referencia,
						cd_indicador_tabela,
						fl_media,
	...
	public function atualizar($cd_beneficio_inc_seprorgs, $args = array())
	{
		$qr_sql = "
			UPDATE indicador_plugin.beneficio_inc_seprorgs
	...
	public function excluir($cd_beneficio_inc_seprorgs, $cd_usuario)
	{
		$qr_sql = "
			UPDATE indicador_plugin.beneficio_inc_seprorgs
