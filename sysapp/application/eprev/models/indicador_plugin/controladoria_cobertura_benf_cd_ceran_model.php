<?php
class Controladoria_cobertura_benf_cd_ceran_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT i.cd_controladoria_cobertura_benf_cd_ceran,
	...
	public function carrega($cd_controladoria_cobertura_benf_cd_ceran)
	{
		$qr_sql = "
            SELECT cd_controladoria_cobertura_benf_cd_ceran,
                   ...
                   nr_meta,
                   observacao
		      FROM indicador_plugin.controladoria_cobertura_benf_cd_ceran 
			 WHERE cd_controladoria_cobertura_benf_cd_ceran = ".intval($cd_controladoria_cobertura_benf_cd_ceran).";";
	...
	{
		if(intval($args['cd_controladoria_cobertura_benf_cd_ceran']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.controladoria_cobertura_benf_cd_ceran 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.controladoria_cobertura_benf_cd_ceran
			     ...
			     WHERE cd_controladoria_cobertura_benf_cd_ceran = ".intval($args['cd_controladoria_cobertura_benf_cd_ceran']).";";
		}

		$this->db->query($qr_sql);
	}
	
	public  function excluir($cd_controladoria_cobertura_benf_cd_ceran, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.controladoria_cobertura_benf_cd_ceran
