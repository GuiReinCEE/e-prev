<?php
class Juridico_sucesso_acoes_judiciais_cons_mensal_model extends Model
{
    public function listar($cd_indicador_tabela)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_judiciais_cons_mensal,
				   ...
				   fl_meta_proc,
				   fl_direcao_proc
              FROM indicador_plugin.juridico_sucesso_acoes_judiciais_cons_mensal
    ...
    public function carrega($cd_juridico_sucesso_acoes_judiciais_cons_mensal)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_judiciais_cons_mensal,
				   ...
				   nr_proc_max
              FROM indicador_plugin.juridico_sucesso_acoes_judiciais_cons_mensal
             WHERE cd_juridico_sucesso_acoes_judiciais_cons_mensal = ".intval($cd_juridico_sucesso_acoes_judiciais_cons_mensal).";";
    ...
    {
        $qr_sql = "
            INSERT INTO indicador_plugin.juridico_sucesso_acoes_judiciais_cons_mensal
            (
                cd_indicador_tabela, 
                dt_referencia, 
                ds_observacao,
    ...
    public function atualizar($cd_juridico_sucesso_acoes_judiciais_cons_mensal, $args = array())
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_judiciais_cons_mensal 
    ...
    public function excluir($cd_juridico_sucesso_acoes_judiciais_cons_mensal, $cd_usuario)
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_judiciais_cons_mensal 
