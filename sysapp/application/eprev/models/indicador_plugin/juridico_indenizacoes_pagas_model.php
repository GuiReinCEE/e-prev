<?php
class Juridico_indenizacoes_pagas_model extends Model
{
    ...
    {
        $qr_sql = "
            SELECT cd_juridico_indenizacoes_pagas,
                   cd_indicador_tabela,
                   dt_referencia,
                   ...
                   nr_percentual_f,
                   nr_meta
              FROM indicador_plugin.juridico_indenizacoes_pagas
    ...
    function carrega_referencia(&$result, $args=array())
    {
        $qr_sql = "
            SELECT TO_CHAR(dt_referencia + '1 month'::interval,'DD/MM/YYYY') AS dt_referencia, 
              ...
              FROM indicador_plugin.juridico_indenizacoes_pagas 
             WHERE dt_exclusao IS NULL 
             ORDER BY juridico_indenizacoes_pagas.dt_referencia DESC 
             LIMIT 1;";
    ...
    function carrega(&$result, $args=array())
    {
        $qr_sql = "
            SELECT cd_juridico_indenizacoes_pagas,
                   ...
                   observacao
              FROM indicador_plugin.juridico_indenizacoes_pagas
             WHERE cd_juridico_indenizacoes_pagas = ".intval($args['cd_juridico_indenizacoes_pagas']).";";
    ...
    function salvar(&$result, $args=array())
    {
        ...
        {
            $qr_sql = "
                INSERT INTO indicador_plugin.juridico_indenizacoes_pagas 
                     (
                        dt_referencia, 
                        nr_valor_1, 
                        nr_valor_3, 
        ...
        {
            $qr_sql = "
                UPDATE indicador_plugin.juridico_indenizacoes_pagas
