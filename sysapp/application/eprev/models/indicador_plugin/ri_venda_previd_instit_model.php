<?php
class ri_venda_previd_instit_model extends Model
{
    ...
    {
        $qr_sql = "
            SELECT cd_ri_venda_previd_instit,
                   cd_indicador_tabela,
                   dt_referencia,
                   ...
                   nr_percentual_f,
                   nr_meta
              FROM indicador_plugin.ri_venda_previd_instit
    ...
    function carrega_referencia(&$result, $args=array())
    {
        $qr_sql = "
            SELECT TO_CHAR(dt_referencia + '1 month'::interval,'DD/MM/YYYY') AS dt_referencia, 
              ...
              FROM indicador_plugin.ri_venda_previd_instit 
             WHERE dt_exclusao IS NULL 
             ORDER BY ri_venda_previd_instit.dt_referencia DESC 
             LIMIT 1;";
    ...
    function carrega(&$result, $args=array())
    {
        $qr_sql = "
            SELECT cd_ri_venda_previd_instit,
                   ...
                   observacao
              FROM indicador_plugin.ri_venda_previd_instit
             WHERE cd_ri_venda_previd_instit = ".intval($args['cd_ri_venda_previd_instit']).";";
    ...
    function salvar(&$result, $args=array())
    {
        ...
        {
            $qr_sql = "
                INSERT INTO indicador_plugin.ri_venda_previd_instit 
                     (
                        dt_referencia, 
                        nr_valor_1, 
                        nr_valor_2, 
        ...
        {
            $qr_sql = "
                UPDATE indicador_plugin.ri_venda_previd_instit
