<?php
class ri_acessos_email_marketing_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_ri_acessos_email_marketing,
			       cd_indicador_tabela,
			       dt_referencia,
				   ...
				   nr_percentual_f,
				   nr_meta
		      FROM indicador_plugin.ri_acessos_email_marketing
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_ri_acessos_email_marketing,
				   ...
				   nr_meta 
		      FROM indicador_plugin.ri_acessos_email_marketing 
			 WHERE cd_ri_acessos_email_marketing = ".intval($args['cd']).";";
	...
	{
		if(intval($args['cd_ri_acessos_email_marketing']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.ri_acessos_email_marketing 
				     (
						dt_referencia,
						dt_inclusao,
						cd_usuario_inclusao,
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.ri_acessos_email_marketing
			     ...
			     WHERE cd_ri_acessos_email_marketing = ".intval($args['cd_ri_acessos_email_marketing']).";";
		}
