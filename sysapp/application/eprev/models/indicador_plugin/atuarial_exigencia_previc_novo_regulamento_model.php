<?php
class Atuarial_exigencia_previc_novo_regulamento_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_atuarial_exigencia_previc_novo_regulamento,
				   cd_indicador_tabela,
				   ...
				   nr_meta_resultado,
				   ds_observacao
			  FROM indicador_plugin.atuarial_exigencia_previc_novo_regulamento 
	...
	public function carrega($cd_atuarial_exigencia_previc_novo_regulamento)
	{
		$qr_sql = "
			SELECT cd_atuarial_exigencia_previc_novo_regulamento,
				   cd_indicador_tabela,
			  ...
			  FROM indicador_plugin.atuarial_exigencia_previc_novo_regulamento 
			 WHERE dt_exclusao IS NULL
			   AND cd_atuarial_exigencia_previc_novo_regulamento = ".intval($cd_atuarial_exigencia_previc_novo_regulamento)."
			 ORDER BY dt_referencia ASC;";
	...
	{
		$qr_sql = "
			INSERT INTO indicador_plugin.atuarial_exigencia_previc_novo_regulamento
			     (
                   dt_referencia, 
                   cd_indicador_tabela, 
                   fl_media, 
	...
	public function atualizar($cd_atuarial_exigencia_previc_novo_regulamento, $args)
	{
		$qr_sql = "
			UPDATE indicador_plugin.atuarial_exigencia_previc_novo_regulamento
			 ...
			 WHERE cd_atuarial_exigencia_previc_novo_regulamento = ".intval($cd_atuarial_exigencia_previc_novo_regulamento).";";

		$this->db->query($qr_sql);	
	}

	public function excluir($cd_atuarial_exigencia_previc_novo_regulamento, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.atuarial_exigencia_previc_novo_regulamento 
