<?php
class ri_cumprimento_planej_marketing_model extends Model
{
	...
	function listar( &$result, $args=array() )
	{
		...
		cd_ri_cumprimento_planej_marketing
	...
	function carregar($cd)
	{
		...
		if( intval($cd)>0 )
		{
			$sql .= " WHERE cd_ri_cumprimento_planej_marketing={cd_ri_cumprimento_planej_marketing} ";
			esc( "{cd_ri_cumprimento_planej_marketing}", intval($cd), $sql );
	...
	{
		if(intval($args['cd_ri_cumprimento_planej_marketing'])==0)
		{
			$sql="
			INSERT INTO indicador_plugin.ri_cumprimento_planej_marketing (
		...
		{
			$sql="
			UPDATE indicador_plugin.ri_cumprimento_planej_marketing
			SET 
			
			cd_ri_cumprimento_planej_marketing = {cd_ri_cumprimento_planej_marketing}
		...
		esc("{cd_ri_cumprimento_planej_marketing}", $args["cd_ri_cumprimento_planej_marketing"], $sql, "int", FALSE);
	...
	function excluir($id)
	{
		...
		WHERE md5(cd_ri_cumprimento_planej_marketing::varchar)='{cd_ri_cumprimento_planej_marketing}'
		"; 
		esc('{cd_usuario_exclusao}', usuario_id(), $sql, 'int'); 
		esc('{cd_ri_cumprimento_planej_marketing}', $id, $sql, 'str');
