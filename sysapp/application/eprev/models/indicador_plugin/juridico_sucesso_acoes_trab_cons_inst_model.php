<?php
class Juridico_sucesso_acoes_trab_cons_inst_model extends Model
{
    public function listar($cd_indicador_tabela)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_trab_cons_inst,
				   ...
				   fl_meta_proc,
				   fl_direcao_proc
              FROM indicador_plugin.juridico_sucesso_acoes_trab_cons_inst
    ...
    public function carrega($cd_juridico_sucesso_acoes_trab_cons_inst)
    {
        $qr_sql = "
            SELECT cd_juridico_sucesso_acoes_trab_cons_inst,
				   ...
				   nr_proc_max
              FROM indicador_plugin.juridico_sucesso_acoes_trab_cons_inst
             WHERE cd_juridico_sucesso_acoes_trab_cons_inst = ".intval($cd_juridico_sucesso_acoes_trab_cons_inst).";";
    ...
    {
        $qr_sql = "
            INSERT INTO indicador_plugin.juridico_sucesso_acoes_trab_cons_inst
            (
                cd_indicador_tabela, 
                dt_referencia, 
                ds_observacao,
    ...
    public function atualizar($cd_juridico_sucesso_acoes_trab_cons_inst, $args = array())
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_trab_cons_inst 
    ...
    public function excluir($cd_juridico_sucesso_acoes_trab_cons_inst, $cd_usuario)
    {
        $qr_sql = "
            UPDATE indicador_plugin.juridico_sucesso_acoes_trab_cons_inst 
