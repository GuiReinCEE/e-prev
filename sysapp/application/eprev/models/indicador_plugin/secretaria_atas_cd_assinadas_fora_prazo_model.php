<?php
class Secretaria_atas_cd_assinadas_fora_prazo_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_secretaria_atas_cd_assinadas_fora_prazo,
			       cd_indicador_tabela,
				   ...
				   fl_media,
				   observacao
		      FROM indicador_plugin.secretaria_atas_cd_assinadas_fora_prazo
	...
	public function carrega($cd_secretaria_atas_cd_assinadas_fora_prazo)
	{
		$qr_sql = "
            SELECT cd_secretaria_atas_cd_assinadas_fora_prazo,
                   ...
                   observacao
		      FROM indicador_plugin.secretaria_atas_cd_assinadas_fora_prazo 
			 WHERE cd_secretaria_atas_cd_assinadas_fora_prazo = ".intval($cd_secretaria_atas_cd_assinadas_fora_prazo).";";
	...
	{
		if(intval($args['cd_secretaria_atas_cd_assinadas_fora_prazo']) == 0)
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.secretaria_atas_cd_assinadas_fora_prazo 
				     (
				        cd_indicador_tabela, 
						dt_referencia, 
					    nr_valor_1, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.secretaria_atas_cd_assinadas_fora_prazo
			     ...
			     WHERE cd_secretaria_atas_cd_assinadas_fora_prazo = ".intval($args['cd_secretaria_atas_cd_assinadas_fora_prazo']).";";
		}

		$this->db->query($qr_sql);
	}
	
	public function excluir($cd_secretaria_atas_cd_assinadas_fora_prazo, $cd_usuario)
	{
		$qr_sql = " 
			UPDATE indicador_plugin.secretaria_atas_cd_assinadas_fora_prazo
