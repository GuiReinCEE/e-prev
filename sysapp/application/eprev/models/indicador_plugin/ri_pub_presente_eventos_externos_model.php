<?php
class ri_pub_presente_eventos_externos_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_ri_pub_presente_eventos_externos,
			       cd_indicador_tabela,
			       dt_referencia,
				   ...
				   nr_percentual_f,
				   nr_meta
		      FROM indicador_plugin.ri_pub_presente_eventos_externos
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_ri_pub_presente_eventos_externos,
				   ...
				   observacao
			  FROM indicador_plugin.ri_pub_presente_eventos_externos
			 WHERE cd_ri_pub_presente_eventos_externos = ".intval($args['cd_ri_pub_presente_eventos_externos']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.ri_pub_presente_eventos_externos 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.ri_pub_presente_eventos_externos
