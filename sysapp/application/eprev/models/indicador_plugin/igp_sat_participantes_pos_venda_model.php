<?php
class Igp_sat_participantes_pos_venda_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_igp_sat_participantes_pos_venda,
				   cd_indicador_tabela,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_plugin.igp_sat_participantes_pos_venda 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_igp_sat_participantes_pos_venda,
				   ...
				   observacao
			  FROM indicador_plugin.igp_sat_participantes_pos_venda
			 WHERE cd_igp_sat_participantes_pos_venda = ".intval($args['cd_igp_sat_participantes_pos_venda']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.igp_sat_participantes_pos_venda
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.igp_sat_participantes_pos_venda
