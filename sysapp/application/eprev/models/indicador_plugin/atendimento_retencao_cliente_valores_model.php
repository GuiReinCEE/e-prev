<?php
class Atendimento_retencao_cliente_valores_model extends Model
{
    public function listar($cd_indicador_tabela)
    {
        $qr_sql = "
            SELECT cd_atendimento_retencao_cliente_valores,
                   ...
                   ds_observacao,
                   fl_media
              FROM indicador_plugin.atendimento_retencao_cliente_valores
    ...
    public function carrega($cd_atendimento_retencao_cliente_valores)
    {
        $qr_sql = "
            SELECT cd_atendimento_retencao_cliente_valores,
              ...
              FROM indicador_plugin.atendimento_retencao_cliente_valores
             WHERE dt_exclusao IS NULL 
               AND cd_atendimento_retencao_cliente_valores = ".intval($cd_atendimento_retencao_cliente_valores).";";
    ...
    {
        $qr_sql = "
        INSERT INTO indicador_plugin.atendimento_retencao_cliente_valores
            (
                cd_indicador_tabela, 
                dt_referencia, 
                ds_observacao,
    ...
    public function atualizar($cd_atendimento_retencao_cliente_valores, $args = array())
    {
        $qr_sql = "
            UPDATE indicador_plugin.atendimento_retencao_cliente_valores 
             ...
             WHERE cd_atendimento_retencao_cliente_valores = ".intval($cd_atendimento_retencao_cliente_valores).";";

        $this->db->query($qr_sql);
    }

    public function excluir($cd_atendimento_retencao_cliente_valores, $cd_usuario)
    {
        $qr_sql = "
            UPDATE indicador_plugin.atendimento_retencao_cliente_valores 
