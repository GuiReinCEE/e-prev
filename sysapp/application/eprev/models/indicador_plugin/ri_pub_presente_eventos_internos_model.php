<?php
class ri_pub_presente_eventos_internos_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_ri_pub_presente_eventos_internos,
			       cd_indicador_tabela,
			       dt_referencia,
				   ...
				   nr_percentual_f,
				   nr_meta
		      FROM indicador_plugin.ri_pub_presente_eventos_internos
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_ri_pub_presente_eventos_internos,
				   ...
				   observacao
			  FROM indicador_plugin.ri_pub_presente_eventos_internos
			 WHERE cd_ri_pub_presente_eventos_internos = ".intval($args['cd_ri_pub_presente_eventos_internos']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.ri_pub_presente_eventos_internos 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.ri_pub_presente_eventos_internos
