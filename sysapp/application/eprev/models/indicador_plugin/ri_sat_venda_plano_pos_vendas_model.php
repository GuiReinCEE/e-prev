<?php
class ri_sat_venda_plano_pos_vendas_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_ri_sat_venda_plano_pos_vendas,
			       cd_indicador_tabela,
			       dt_referencia,
				   ...
				   nr_percentual_f,
				   nr_meta
		      FROM indicador_plugin.ri_sat_venda_plano_pos_vendas
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_ri_sat_venda_plano_pos_vendas,
				   ...
				   observacao
			  FROM indicador_plugin.ri_sat_venda_plano_pos_vendas
			 WHERE cd_ri_sat_venda_plano_pos_vendas = ".intval($args['cd_ri_sat_venda_plano_pos_vendas']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.ri_sat_venda_plano_pos_vendas 
				     (
						dt_referencia, 
					    nr_valor_1, 
                        nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.ri_sat_venda_plano_pos_vendas
