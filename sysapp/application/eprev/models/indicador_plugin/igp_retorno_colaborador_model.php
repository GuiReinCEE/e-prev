<?php
class Igp_retorno_colaborador_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_igp_retorno_colaborador,
				   cd_indicador_tabela,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_plugin.igp_retorno_colaborador 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_igp_retorno_colaborador,
				   ...
				   observacao
			  FROM indicador_plugin.igp_retorno_colaborador
			 WHERE cd_igp_retorno_colaborador = ".intval($args['cd_igp_retorno_colaborador']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_plugin.igp_retorno_colaborador
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_plugin.igp_retorno_colaborador
