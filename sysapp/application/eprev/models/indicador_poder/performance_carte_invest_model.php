<?php
class performance_carte_invest_model extends Model
{
	...
	{
		$qr_sql = "
					SELECT i.cd_performance_carte_invest,
					  ...
					  FROM indicador_poder.performance_carte_invest i
	...
	{
		$sql = "
            SELECT cd_performance_carte_invest,
		...
		if( intval($cd)>0 )
		{
			$sql .= " WHERE cd_performance_carte_invest=".intval($cd);
	...
	{
		if(intval($args['cd_performance_carte_invest'])==0)
		{
			$sql="
			INSERT INTO indicador_poder.performance_carte_invest
                      (
                        dt_referencia,
                        dt_inclusao,
                        cd_usuario_inclusao ,
		...
		{
			$sql="
			UPDATE indicador_poder.performance_carte_invest
			   SET cd_performance_carte_invest = ".intval($args["cd_performance_carte_invest"]).",
			 ...
			 WHERE cd_performance_carte_invest = ".intval($args["cd_performance_carte_invest"])."
			";
		}
	...
	function excluir($id)
	{
		...
		UPDATE indicador_poder.performance_carte_invest
		 ...
		 WHERE md5(cd_performance_carte_invest::varchar)='".$id."'
		";
