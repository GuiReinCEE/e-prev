					 ...
					 WHERE
					    (
							...
							(
								...
								OR 
								(
									CASE WHEN '".trim($args['cd_usuario_documento_gerencia'])."' = 'GC' 
										 THEN (d.fl_area_monitorar = 'S' AND d.cd_area = '".trim($args['cd_usuario_documento_gerencia'])."' AND funcoes.get_usuario_unidade(d.cd_usuario) = funcoes.get_usuario_unidade(".intval($args['cd_usuario_documento']).")) 
