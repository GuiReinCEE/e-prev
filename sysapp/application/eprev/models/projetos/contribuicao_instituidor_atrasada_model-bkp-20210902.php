    ...
    function atrasada(&$result, $args=array())
    {
        $qr_sql = "
            SELECT CASE WHEN b.cd_empresa = 7
                        ...
                        ELSE 'ERRO'
                     END
                        WHEN b.cd_empresa IN (8,10,12)
                        THEN CASE WHEN b.codigo_lancamento = 2450 THEN 'COBDL'
                        WHEN b.codigo_lancamento = 2460 THEN 'CODCC'
                        WHEN b.codigo_lancamento = 2480 THEN 'COFOL'
                        ELSE 'ERRO'
                     END
                        WHEN b.cd_empresa IN (19,20,24,25,26,27,28,29,30,31) 
