...
class atividade_atendimento_model extends Model
{
    ...
    var $ar_status_inicio = Array('AINI','AIST', 'AICS', 'AINF', 'GCAI', 'AIGA','AISB','AIGJ','SGAI');  
    
    #### STATUS DE CONCLUIDO ####
    var $ar_status_concluido = Array('COSB','COST','CONC','CONF','COGA','COCS','GCCO','COGJ','SGCA','SGCO','COGD');        
    
    #### STATUS QUE DEFINE FIM REAL ####
    var $ar_status_fim_real = Array('CAST','COST','CONC','COGA','COGJ','GCCA','GCCO','CANF','CONF','CANC','AGDF','COCS','CACS','COSB','CASB','SGCA','SGCO','CAGD','COGD');
    ...
    function cb_sistema(&$result, $args=array())
    {
        $qr_sql = "
                    SELECT codigo AS value, 
                     ...
                     WHERE (area         = '".$args['cd_gerencia_destino']."' ".(trim($args['cd_gerencia_destino']) == 'GI' ? "OR area = 'GGS'" : "")." )
