	...
	function listar( &$result, $args=array() )
	{
		$qr_sql = "
					SELECT a.cd_atendimento,
                           ...
                           COALESCE(ac.nome_arquivo, TO_CHAR(act.data,'YYYY_MM_DD') || '/' || act.nome_arquivo) AS nome_arquivo,
					 ...
					 WHERE CAST(a.dt_hora_inicio_atendimento AS  DATE) BETWEEN TO_DATE('".trim($args["dt_inicio"])."','DD/MM/YYYY')  AND TO_DATE('".trim($args["dt_fim"])."','DD/MM/YYYY')
		               AND (a.dt_hora_fim_atendimento - a.dt_hora_inicio_atendimento) > CAST('00:00:10' AS INTERVAL)
		             ...
		             GROUP BY a.cd_atendimento,
                              ...
                              a.dt_hora_inicio_atendimento,
                              a.tipo_atendimento_indicado,
                              COALESCE(ac.nome_arquivo, TO_CHAR(act.data,'YYYY_MM_DD') || '/' || act.nome_arquivo)
		          ";
