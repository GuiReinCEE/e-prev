<?php
class senhas_liberadas_model extends Model
{
	...
	function carregar($cd)
	{
		...
		if( intval($cd)>0 )
		{
			$qr_sql .= " WHERE cd_senhas_liberadas=".intval($cd);
	...
	{
		if(intval($args['cd_senhas_liberadas'])==0)
		{
			$qr_sql="
		...
		{
			$qr_sql="
                UPDATE indicador_atendimento.senhas_liberadas
		           SET cd_senhas_liberadas     = ".intval($args["cd_senhas_liberadas"]).",
			     ...
			     WHERE cd_senhas_liberadas = ".intval($args["cd_senhas_liberadas"])."
			";
		}
	...
	function excluir($id)
	{
		$qr_sql = "
            UPDATE indicador_atendimento.senhas_liberadas
		     ...
		     WHERE md5(cd_senhas_liberadas::varchar)='".$id."'
		"; 
