<?php
class central_quantidade_model extends Model
{
	...
	function carregar($cd)
	{
		...
		if( intval($cd)>0 )
		{
			$qr_sql .= " WHERE cd_central_quantidade=".intval($cd);
	...
	{
		if(intval($args['cd_central_quantidade'])==0)
		{
			$qr_sql="
		...
		{
			$qr_sql="
                UPDATE indicador_atendimento.central_quantidade
		           SET cd_central_quantidade     = ".intval($args["cd_central_quantidade"]).",
			     ...
			     WHERE cd_central_quantidade = ".intval($args["cd_central_quantidade"])."
			";
		}
	...
	function excluir($id)
	{
		$qr_sql = "
            UPDATE indicador_atendimento.central_quantidade
		     ...
		     WHERE md5(cd_central_quantidade::varchar)='".$id."'
		"; 
