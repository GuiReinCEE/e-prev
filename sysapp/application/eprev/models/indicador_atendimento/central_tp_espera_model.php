<?php
class central_tp_espera_model extends Model
{
	...
	function carregar($cd)
	{
		...
		if( intval($cd)>0 )
		{
			$qr_sql .= " WHERE cd_central_tp_espera=".intval($cd);
	...
	{
		if(intval($args['cd_central_tp_espera'])==0)
		{
			$qr_sql="
		...
		{
			$qr_sql="
                UPDATE indicador_atendimento.central_tp_espera
		           SET cd_central_tp_espera     = ".intval($args["cd_central_tp_espera"]).",
			     ...
			     WHERE cd_central_tp_espera = ".intval($args["cd_central_tp_espera"])."
			";
		}
	...
	function excluir($id)
	{
		$qr_sql = "
            UPDATE indicador_atendimento.central_tp_espera
		     ...
		     WHERE md5(cd_central_tp_espera::varchar)='".$id."'
		"; 
