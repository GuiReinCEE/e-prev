<?php
class Despesa_sobre_receita_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_despesa_sobre_receita,
				   cd_indicador_tabela,
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_despesa_sobre_receita,
				   ...
				   observacao
			  FROM indicador_pga.despesa_sobre_receita
			 WHERE cd_despesa_sobre_receita = ".intval($args['cd_despesa_sobre_receita']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_pga.despesa_sobre_receita
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_pga.despesa_sobre_receita
