<?php
class Custo_administrativo_previdencial_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_custo_administrativo_previdencial,
				   cd_indicador_tabela,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_pga.custo_administrativo_previdencial 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_custo_administrativo_previdencial,
				   ...
				   observacao
			  FROM indicador_pga.custo_administrativo_previdencial
			 WHERE cd_custo_administrativo_previdencial = ".intval($args['cd_custo_administrativo_previdencial']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_pga.custo_administrativo_previdencial
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_pga.custo_administrativo_previdencial
