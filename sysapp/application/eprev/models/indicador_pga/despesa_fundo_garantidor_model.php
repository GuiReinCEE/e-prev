<?php
class despesa_fundo_garantidor_model extends Model
{
	...
	{
		$qr_sql = "
			SELECT cd_despesa_fundo_garantidor,
				   cd_indicador_tabela,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_pga.despesa_fundo_garantidor 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_despesa_fundo_garantidor,
				   ...
				   observacao
			  FROM indicador_pga.despesa_fundo_garantidor
			 WHERE cd_despesa_fundo_garantidor = ".intval($args['cd_despesa_fundo_garantidor']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_pga.despesa_fundo_garantidor
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_pga.despesa_fundo_garantidor
