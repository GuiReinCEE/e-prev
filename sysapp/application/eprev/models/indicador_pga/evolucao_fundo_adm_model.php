<?php
class evolucao_fundo_adm_model extends Model
{
	...
	function listar( &$result, $args=array() )
	{
		$qr_sql = "
			SELECT cd_evolucao_fundo_adm,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_pga.evolucao_fundo_adm 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_evolucao_fundo_adm,
				   ...
				   observacao
			  FROM indicador_pga.evolucao_fundo_adm
			 WHERE cd_evolucao_fundo_adm = ".intval($args['cd_evolucao_fundo_adm']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_pga.evolucao_fundo_adm
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_pga.evolucao_fundo_adm
