<?php
class Taxa_administracao_model extends Model
{
	...
	function listar( &$result, $args=array() )
	{
		$qr_sql = "
			SELECT cd_taxa_administracao,
				   ...
				   fl_media,
				   observacao
			  FROM indicador_pga.taxa_administracao 
	...
	function carrega(&$result, $args=array())
	{
		$qr_sql = "
			SELECT cd_taxa_administracao,
				   ...
				   observacao
			  FROM indicador_pga.taxa_administracao
			 WHERE cd_taxa_administracao = ".intval($args['cd_taxa_administracao']).";";
	...
	function salvar(&$result, $args=array())
	{
		...
		{
			$qr_sql = "
				INSERT INTO indicador_pga.taxa_administracao
				     (
                       dt_referencia, 
					   nr_valor_1, 
                       nr_valor_2, 
		...
		{
			$qr_sql = "
				UPDATE indicador_pga.taxa_administracao
