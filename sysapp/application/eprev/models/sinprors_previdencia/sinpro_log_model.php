<?php
class Sinpro_log_model extends Model
{
	...
	public function listar($args = array())
	{
		$qr_sql = "
			SELECT spl.cd_log,
			       ...
			       spl.ds_link
			  FROM sinprors_previdencia.log spl
			  JOIN sinprors_previdencia.usuario spu
	...
	public function get_usuarios()
    {
        $qr_sql = "
            SELECT spl.cd_usuario AS value,
                   nome || (CASE WHEN dt_exclusao IS NOT NULL THEN  ' [Excluído em '|| TO_CHAR(dt_exclusao, 'DD/MM/YYYY') || ']'
                                ELSE ''
                   		   END) AS text
              FROM sinprors_previdencia.log spl
              JOIN sinprors_previdencia.usuario spu 
