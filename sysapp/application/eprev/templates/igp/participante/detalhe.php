...
echo form_hidden( 'cd_participante', intval($row['cd_participante']) );
...
echo form_default_float("nr_semestre", $label_6." *", app_decimal_para_php($row['nr_semestre']), "class='indicador_text'");
