...
,array("nr_peso", "float") 
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("igp/satisfacao_colab"); ?>';
	}
...
echo form_open('igp/satisfacao_colab/salvar');
echo form_hidden( 'cd_satisfacao_colab', intval($row['cd_satisfacao_colab']) );
...
if( intval($row['cd_satisfacao_colab'])>0  )
{
	echo button_delete("igp/satisfacao_colab/excluir",$row["cd_satisfacao_colab"]);
}
