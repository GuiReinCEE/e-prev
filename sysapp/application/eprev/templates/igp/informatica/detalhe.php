...
<script>
	...
	<?php echo form_default_js_submit(array(
		...
		,array("nr_expediente", "float") 
		,array("nr_bco_fora", "float") 
		,array("nr_meta", "float") 
		,array("cd_usuario_inclusao", "float") 
...
echo form_hidden( 'cd_informatica', intval($row['cd_informatica']) );
...
echo form_default_float("nr_expediente", $label_1." *", app_decimal_para_php($row['nr_expediente']), "class='indicador_text'");
echo form_default_float("nr_bco_fora", $label_2." *", app_decimal_para_php($row['nr_bco_fora']), "class='indicador_text'");
echo form_default_float("nr_tempo_perc", "Tempo Indisponível ", app_decimal_para_php($row['nr_tempo_perc']), "class='indicador_text'"); 
