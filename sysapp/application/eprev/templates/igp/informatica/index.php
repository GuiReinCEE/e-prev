...
function load()
{
	...
	$.post( '<?php echo base_url() . index_page(); ?>/igp/informatica/listar',{  nome: $('#nome').val()
...
function gerar_graficos()
{
	...
	{
		url = '<?php echo site_url("igp/informatica/criar_indicador"); ?>';
...
function fechar_periodo()
{
	...
	else if( confirm('Fechar o período?') )
	{
		...
		$.post(url,{},function(data){
			...
			url = '<?php echo site_url("igp/informatica/fechar_periodo")?>';
			location.href=url;
		});
	}
}
