...
<script>
	<?php echo form_default_js_submit(array(
		...
		,array("nr_despesa", "float") 
		,array("nr_contribuicao", "float") 
		,array("nr_meta", "float") 
		,array("nr_peso", "float")
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("igp/custo_administrativo"); ?>';
	}
...
echo form_open('igp/custo_administrativo/salvar');
echo form_hidden( 'cd_custo_administrativo', intval($row['cd_custo_administrativo']) );
...
echo form_default_float("nr_despesa", $label_1." *", app_decimal_para_php($row['nr_despesa']), "class='indicador_text'");
echo form_default_float("nr_contribuicao", $label_2." *", app_decimal_para_php($row['nr_contribuicao']), "class='indicador_text'");
...
if( intval($row['cd_custo_administrativo'])>0  )
{
	echo button_delete("igp/custo_administrativo/excluir",$row["cd_custo_administrativo"]);
}
