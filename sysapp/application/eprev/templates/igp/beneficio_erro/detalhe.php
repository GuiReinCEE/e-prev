...
echo form_default_float("nr_concedido", $label_1, app_decimal_para_php($row['nr_concedido']), "class='indicador_text'");
echo form_default_float("nr_erro", $label_2, app_decimal_para_php($row['nr_erro']), "class='indicador_text'");
