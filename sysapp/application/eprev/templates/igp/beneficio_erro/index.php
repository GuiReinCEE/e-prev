...
function load()
{
	...
	$.post( '<?php echo base_url() . index_page(); ?>/igp/beneficio_erro/listar',{},function(data){ $("#result_div").html(data);configure_result_table(); } );
}
...
function novo()
{
	location.href='<?php echo site_url("igp/beneficio_erro/detalhe/0"); ?>';
}
...
function gerar_graficos()
{
	...
	{
		url = '<?php echo base_url() . index_page(); ?>/igp/beneficio_erro/criar_indicador';
