...
<script>
	...
	<?php echo form_default_js_submit(array(
		...
		,array("nr_hora", "float") 
		,array("nr_homem", "float") 
		,array("nr_meta", "float") 
		,array("nr_meta_ano", "float") 
		,array("nr_peso", "float") 
...
echo form_hidden( 'cd_treinamento', intval($row['cd_treinamento']) );
...
echo form_default_float("nr_hora", $label_1." *", app_decimal_para_php($row['nr_hora']), "class='indicador_text'");
echo form_default_float("nr_homem", $label_2." *", app_decimal_para_php($row['nr_homem']), "class='indicador_text'");
echo form_default_float("nr_meta", "Meta *", app_decimal_para_php($row['nr_meta']), "class='indicador_text'");
echo form_default_float("nr_meta_ano", $label_15." *", app_decimal_para_php($row['nr_meta_ano']), "class='indicador_text'");
