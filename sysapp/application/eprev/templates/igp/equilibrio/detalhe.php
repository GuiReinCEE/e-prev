...
<script>
	...
	<?php echo form_default_js_submit(array(
		...
		,array("nr_tecnica", "float") 
		,array("nr_matematica", "float") 
		,array("nr_meta", "float") 
		,array("nr_peso", "float") 
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("igp/equilibrio"); ?>';
	}
...
echo form_open('igp/equilibrio/salvar');
echo form_hidden( 'cd_equilibrio', intval($row['cd_equilibrio']) );
...
echo form_default_float("nr_tecnica", $label_1." *", app_decimal_para_php($row['nr_tecnica']), "class='indicador_text'");
echo form_default_float("nr_matematica", $label_2." *", app_decimal_para_php($row['nr_matematica']), "class='indicador_text'");
echo form_default_float("nr_meta", $label_4." *", app_decimal_para_php($row['nr_meta']), "class='indicador_text'");
echo form_default_float("nr_peso", $label_5." *", app_decimal_para_php($row['nr_peso']), "class='indicador_text'");
...
if( intval($row['cd_equilibrio'])>0  )
{
	echo button_delete("igp/equilibrio/excluir",$row["cd_equilibrio"]);
}
