...
if ( ! function_exists('form_default_editor_htmlx'))
{
	/**
	 * Text Input Field - Date Object
	 *
	 ...
	 * @return	string
	 */
	function form_default_editor_htmlx($id, $caption="", $value="",$extra="",$fl_url_absoluta=false)
	{
		$height = 0;
		if(trim($extra) != "")
		{
...
";
	...
	$campo_part =  form_input(array( "value"=>$values[$ids[0]], "name"=>$ids[0], "id"=>$ids[0], "title"=>"Código da empresa","style"=>"width:50px; ", "onkeypress"=>"handleEnter(this, event);", "maxlength"=>"2"), "", "") ."
...
function form_default_participante_trigger( $config )
{
	...
	<td class='coluna-padrao-form-objeto' valign='top'>
		" . form_input(array( "value"=>$config['emp']['value'], "name"=>$emp, "id"=>$emp, "title"=>"Código da empresa","style"=>"width:50px;", "onkeypress"=>"handleEnter(this, event);", "maxlength"=>"2"), "", "") . "
