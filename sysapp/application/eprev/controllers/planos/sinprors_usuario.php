<?php
class sinprors_usuario extends Controller
{
	function __construct()
    {
		...
		$this->load->model('sinprors_previdencia/usuario_model');
    }
	...
	function index()
    {
		...
		{		
			$this->load->view('planos/sinprors_usuario/index');
		}
		else
		{
    ...
    {		
		if(gerencia_in(array('GCM')))
		{
			...
			$this->load->view('planos/sinprors_usuario/index_result', $data);
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
    ...
    {	
		if(gerencia_in(array('GCM')))
		{
			...
			$this->load->view('planos/sinprors_usuario/cadastro',$data);
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
    ...
    {	
		if(gerencia_in(array('GCM')))
		{
			...
			redirect("planos/sinprors_usuario", "refresh");
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
