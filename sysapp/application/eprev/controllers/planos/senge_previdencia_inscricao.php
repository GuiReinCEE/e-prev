<?php
class senge_previdencia_inscricao extends Controller
{
	function __construct()
    {
		...
		$this->load->model('senge_previdencia/senge_previdencia_inscricao_model');
    }
	...
	function index()
    {
		...
		{		
			$this->load->view('planos/senge_previdencia_inscricao/index');
		}
		else
		{
    ...
    {		
		if(gerencia_in(array('GRI', 'GI')))
		{
			...
			$this->senge_previdencia_inscricao_model->listar($result, $args);
			$data['collection'] = $result->result_array();
			
			$this->load->view('planos/senge_previdencia_inscricao/index_result', $data);
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
