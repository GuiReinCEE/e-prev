...
class nao_conformidade_auditor extends Controller
{
    ...
    function __construct()
    {
        ...
        CheckLogin();
        $this->load->model('gestao/nao_conformidade_auditor_model');
    }
    ...
    public function index()
    {
        if(($this->session->userdata('indic_12') == '*') OR ($this->session->userdata('indic_05') == 'S')) 
        {
            ...
            $this->nao_conformidade_auditor_model->usuario_auditor($result, $args);
            $data['ar_auditor'] = $result->result_array();		

            $this->nao_conformidade_auditor_model->combo_processo($result, $args);
            $data['ar_processo'] = $result->result_array();				
			
            $this->load->view('gestao/nao_conformidade_auditor/index.php', $data);
        }
        else
        {
    ...
    public function listar()
    {
        if(($this->session->userdata('indic_12') == '*') OR ($this->session->userdata('indic_05') == 'S')) 
        {
            ...
            $this->nao_conformidade_auditor_model->listar($result, $args);
            $data['collection'] = $result->result_array();

            $this->load->view('gestao/nao_conformidade_auditor/partial_result', $data);
        }
        else
        {
            exibir_mensagem("ACESSO NÃO PERMITIDO");
    ...
    public function cadastro($cd_processo)
    {
        if(($this->session->userdata('indic_12') == '*') OR ($this->session->userdata('indic_05') == 'S')) 
        {
            ...
            $this->nao_conformidade_auditor_model->carrega($result, $args);
            ...
            $this->nao_conformidade_auditor_model->usuario_titular($result, $args);
            $data['arr_usuario_titular'] = $result->result_array();

            $this->nao_conformidade_auditor_model->usuario_substituto($result, $args);
            $data['arr_usuario_substituto'] = $result->result_array();

            $this->load->view('gestao/nao_conformidade_auditor/cadastro', $data);
        }
        else
        {
            exibir_mensagem("ACESSO NÃO PERMITIDO");
    ...
    function salvar()
    {
        if(($this->session->userdata('indic_12') == '*') OR ($this->session->userdata('indic_05') == 'S')) 
        {
            ...
            $this->nao_conformidade_auditor_model->salvar($result, $args);
            redirect("gestao/nao_conformidade_auditor/index", "refresh");
        }
        else
        {
            exibir_mensagem("ACESSO NÃO PERMITIDO");
