...
class Pedido_aposentadoria_ceeeprev extends Controller
{
	...
	private function set_liquid($nome_arquivo, $extension, $pasta, $codigo_ficha, $campos_ficha, $dir, $ds_documento)
	{
        ...
        $args['senha']         = 'c8ml09';
        $args['nomeDocumento'] = utf8_encode($nome_arquivo.'.'.$extension);
        $args['pasta']         = utf8_encode($pasta);
        $args['codigoFicha']   = $codigo_ficha;
        $args['camposFicha']   = utf8_encode($campos_ficha);
        $args['nomeArquivo']   = utf8_encode($nome_arquivo.'.'.$extension);
        $args['arquivoBase64'] = base64_encode(file_get_contents($dir.$ds_documento));
