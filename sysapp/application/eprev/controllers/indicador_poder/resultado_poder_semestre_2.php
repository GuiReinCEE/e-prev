<?php
class resultado_poder_semestre_2 extends Controller
{
	var	$label_0 = "Ano";
    ...
    function index()
    {
		...
		if($this->fl_permissao)
		{
	        ...
	        $this->load->view('indicador_poder/resultado_poder_semestre_2/index.php',$data);
		}
		else
		{
    ...
    function listar()
    {
		...
		if($this->fl_permissao)
        {
			...
			if( sizeof($tabela)>0 )
			{
				...
				$this->resultado_poder_semestre_2_model->listar( $result, $args );

				$data['collection'] = $result->result_array();

				$this->load->view('indicador_poder/resultado_poder_semestre_2/partial_result', $data);
			}
			else
			{
	...
	function fechar_periodo()
	{
		...
		if($this->fl_permissao)
		{
			...
			redirect( 'indicador_poder/resultado_poder_semestre_2' );
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
