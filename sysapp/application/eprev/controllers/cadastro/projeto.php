...
class Projeto extends Controller
{
    ...
    function index()
    {
        $this->load->view('cadastro/projetos/index.php');
    }
    ...
    function listar()
    {
        ...
        $this->load->view('cadastro/projetos/partial_result', $data);
    }
    ...
    function detalhe($cd = 0)
    {
        ...
        $this->load->view('cadastro/projetos/detalhe', $data);
    }
    ...
    function salvar()
    {
        ...
        redirect( "cadastro/projeto", "refresh" );
    }
    ...
    function listar_envolvidos()
    {
        ...
        $this->load->view('cadastro/projetos/pessoas_envolvidas_result', $data);
    }
    ...
    function excluir_envolvido($codigo, $cd_envolvido)
    {
        ...
        redirect( 'cadastro/projeto/detalhe/'. $codigo, 'refresh' );
    }
    ...
    function adicionar_pessoas($codigo)
    {
        ...
        $this->load->view('cadastro/projetos/pessoas_envolvidas', $data);
    }
    ...
    function salvar_envolvido()
    {
        ...
        redirect( 'cadastro/projeto/adicionar_pessoas/'. $args['codigo'], 'refresh' );
