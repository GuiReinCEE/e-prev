...
class Investimento_rentabilidade_carteira extends Controller
{
    ...
    public function cadastro($cd_investimento_rentabilidade_carteira = 0)
	{
		if((indicador_db::verificar_permissao($this->cd_usuario, 'GIN')) OR (indicador_db::verificar_permissao($this->cd_usuario, 'CQ')))
		{
			...
			{
				$row = $this->investimento_rentabilidade_carteira_model->carrega_referencia($data['tabela'][0]['cd_indicador_tabela'], intval($data['tabela'][0]['nr_ano_referencia']));
				...
				$data['row'] = array(
					...
					'nr_acumulado_ceeeprev'                  => 0,
					'nr_benchmark_ceeeprev'                  => 0,

					'nr_acumulado_senge'                     => 0,
					'nr_benchmark_senge'                     => 0,

					'nr_acumulado_sinpro'                    => 0,
					'nr_benchmark_sinpro'                    => 0,

					'nr_acumulado_fam_corp'                  => 0,
					'nr_benchmark_fam_corp'                  => 0,

					'nr_acumulado_fam_assoc'                 => 0,
					'nr_benchmark_fam_assoc'                 => 0,

					'nr_acumulado_ceranprev'                 => 0,
					'nr_benchmark_ceranprev'                 => 0,

					'nr_acumulado_fozprev'                   => 0,
					'nr_benchmark_fozprev'                   => 0,

					'nr_acumulado_crmprev'                   => 0,
					'nr_benchmark_cremprev'                  => 0,

					'nr_acumulado_pga'                       => 0,
					'nr_benchmark_pga'                       => 0,

					'nr_acumulado_municipio'                 => 0,
					'nr_benchmark_municipio'                 => 0,
	...
	public function salvar()
	{
		...
		{		
			...
			$args = array(
				...
				'nr_acumulado_ceee'      => app_decimal_para_db($this->input->post('nr_acumulado_ceee', true)),
				'nr_benchmark_ceee'      => app_decimal_para_db($this->input->post('nr_benchmark_ceee', true)),

				'nr_acumulado_rge'       => app_decimal_para_db($this->input->post('nr_acumulado_rge', true)),
				'nr_benchmark_rge'       => app_decimal_para_db($this->input->post('nr_benchmark_rge', true)),

				'nr_acumulado_aes'       => app_decimal_para_db($this->input->post('nr_acumulado_aes', true)),
				'nr_benchmark_aes'       => app_decimal_para_db($this->input->post('nr_benchmark_aes', true)),

				'nr_acumulado_cgte'      => app_decimal_para_db($this->input->post('nr_acumulado_cgte', true)),
				'nr_benchmark_cgte'      => app_decimal_para_db($this->input->post('nr_benchmark_cgte', true)),

				'nr_acumulado_ceeeprev'  => app_decimal_para_db($this->input->post('nr_acumulado_ceeeprev', true)),
				'nr_benchmark_ceeeprev'  => app_decimal_para_db($this->input->post('nr_benchmark_ceeeprev', true)),

				'nr_acumulado_senge'     => app_decimal_para_db($this->input->post('nr_acumulado_senge', true)),
				'nr_benchmark_senge'     => app_decimal_para_db($this->input->post('nr_benchmark_senge', true)),

				'nr_acumulado_sinpro'    => app_decimal_para_db($this->input->post('nr_acumulado_sinpro', true)),
				'nr_benchmark_sinpro'    => app_decimal_para_db($this->input->post('nr_benchmark_sinpro', true)),

				'nr_acumulado_fam_corp'  => app_decimal_para_db($this->input->post('nr_acumulado_fam_corp', true)),
				'nr_benchmark_fam_corp'  => app_decimal_para_db($this->input->post('nr_benchmark_fam_corp', true)),

				'nr_acumulado_fam_assoc' => app_decimal_para_db($this->input->post('nr_acumulado_fam_assoc', true)),
				'nr_benchmark_fam_assoc' => app_decimal_para_db($this->input->post('nr_benchmark_fam_assoc', true)),

				'nr_acumulado_ceranprev' => app_decimal_para_db($this->input->post('nr_acumulado_ceranprev', true)),
				'nr_benchmark_ceranprev' => app_decimal_para_db($this->input->post('nr_benchmark_ceranprev', true)),

				'nr_acumulado_fozprev'   => app_decimal_para_db($this->input->post('nr_acumulado_fozprev', true)),
				'nr_benchmark_fozprev'   => app_decimal_para_db($this->input->post('nr_benchmark_fozprev', true)),

				'nr_acumulado_crmprev'   => app_decimal_para_db($this->input->post('nr_acumulado_crmprev', true)),
				'nr_benchmark_cremprev'  => app_decimal_para_db($this->input->post('nr_benchmark_cremprev', true)),

				'nr_acumulado_pga'       => app_decimal_para_db($this->input->post('nr_acumulado_pga', true)),
				'nr_benchmark_pga'       => app_decimal_para_db($this->input->post('nr_benchmark_pga', true)),

				'nr_acumulado_municipio' => app_decimal_para_db($this->input->post('nr_acumulado_municipio', true)),
				'nr_benchmark_municipio' => app_decimal_para_db($this->input->post('nr_benchmark_municipio', true)),

				'nr_acumulado_ieab'      => app_decimal_para_db($this->input->post('nr_acumulado_ieab', true)),
				'nr_benchmark_ieab'      => app_decimal_para_db($this->input->post('nr_benchmark_ieab', true)),
	...
	private function monta_tabela($args)
	{
        ...
        $tabela .= '<tr>';
        $tabela .= '<th>Plano</th>';
        $tabela .= '<th>Acumulado Ano</th>';
        $tabela .= '<th>Benchmark</th>';
        $tabela .= '</tr>';
        $tabela .= '</thead>';
        ...
        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Plano Único Grupo CEEE</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_ceee'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_ceee'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Plano Único RGE I</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_rge'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_rge'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Plano Único RGE II</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_aes'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_aes'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';
        /*
        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Plano Único CGTEE</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_cgte'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_cgte'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';
		*/
        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">CeeePrev</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_ceeeprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_ceeeprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">SENGE</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_senge'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_senge'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';
        /*
        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">SINPRO</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_sinpro'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_sinpro'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';
		*/
        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Família Corporativo</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_fam_corp'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_fam_corp'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Família Associativo</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_fam_assoc'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_fam_assoc'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">CeranPrev</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_ceranprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_ceranprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">FozPrev</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_fozprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_fozprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">CRMPrev</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_crmprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_cremprev'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">Família Municípios</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_municipio'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_municipio'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">IEAB Prev</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_ieab'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_ieab'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';

        $tabela .= '<tr>';
		$tabela .= '<td style="text-align:left;">PGA</td>';
		$tabela .= '<td style="text-align:center;">'.number_format($args['nr_acumulado_pga'], 2, ',', '.').' %'.'</td>';
        $tabela .= '<td style="text-align:center;">'.number_format($args['nr_benchmark_pga'], 2, ',', '.').' %'.'</td>';
        $tabela .= '</tr>';
	...
	public function criar_indicador()
    {
    	if((indicador_db::verificar_permissao($this->cd_usuario, 'GIN')) OR (indicador_db::verificar_permissao($this->cd_usuario, 'CQ')))	
		{
			...
			$sql .= indicador_db::sql_inserir_celula($tabela[0]['cd_indicador_tabela'], 9, 0, utf8_encode($data['label_10']), 'background,center');
			$sql .= indicador_db::sql_inserir_celula($tabela[0]['cd_indicador_tabela'], 10, 0, utf8_encode(''), 'background,center');
			$sql .= indicador_db::sql_inserir_celula($tabela[0]['cd_indicador_tabela'], 11, 0, utf8_encode($data['label_13']), 'background,center');
			...
			foreach($collection as $key => $item)
			{
				if(intval($item['ano_referencia']) >= intval($tabela[0]['nr_ano_referencia'])-10)
				{
					...
					$indicador[$linha][9]  = $item['nr_poder_resultado'];
					$indicador[$linha][10] = $item['ds_tabela'];
					$indicador[$linha][11] = $item['observacao'];
			...
			if(intval($contador_ano_atual) > 0)
			{
				...
				$indicador[$linha][9]  = $nr_poder_resultado;
				$indicador[$linha][10]  = '';
				$indicador[$linha][11]  = '';
			}
			...
			for($i = 0; $i < sizeof($indicador); $i++)
			{
				...
				$sql .= indicador_db::sql_inserir_celula($tabela[0]['cd_indicador_tabela'], 9, $linha, app_decimal_para_php($indicador[$i][9]), 'center', 'S', 4);
				$sql .= indicador_db::sql_inserir_celula($tabela[0]['cd_indicador_tabela'], 10, $linha, utf8_encode(nl2br($indicador[$i][10])), 'left');
				$sql .= indicador_db::sql_inserir_celula($tabela[0]['cd_indicador_tabela'], 11, $linha, utf8_encode(nl2br($indicador[$i][11])), 'left');

				$linha++;
			}

			$coluna_para_ocultar='3,4,7,8';
