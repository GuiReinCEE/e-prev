<?php
class Controladoria_div_caderno_acom_resultado extends Controller
{	
	...
	function __construct()
    {
		...
		$this->enum_indicador = intval(enum_indicador::CONTROLADORIA_DIV_CADERNO_ACOMP_RESULTADOS);
		...
		$this->load->model('indicador_plugin/controladoria_div_caderno_acom_resultado_model');
    }
	...
	function index()
    {
		if(indicador_db::verificar_permissao(usuario_id(),'GC'))
		{
	        ...
	        $this->load->view('indicador_plugin/controladoria_div_caderno_acom_resultado/index', $data);
		}
		else
		{
	...
	function listar()
    {
		if(indicador_db::verificar_permissao(usuario_id(),'GC'))
        {
			...
			$this->controladoria_div_caderno_acom_resultado_model->listar( $result, $args );
			$data['collection'] = $result->result_array();
			
			$this->load->view('indicador_plugin/controladoria_div_caderno_acom_resultado/index_result', $data);
        }
        else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
	...
	function cadastro($cd_controladoria_div_caderno_acom_resultado = 0)
	{
		if(indicador_db::verificar_permissao(usuario_id(),'GC'))
		{
			$args   = array();
			...
			$args['cd_controladoria_div_caderno_acom_resultado'] = $cd_controladoria_div_caderno_acom_resultado;
			
			if(intval($args['cd_controladoria_div_caderno_acom_resultado']) == 0)
			{
				$this->controladoria_div_caderno_acom_resultado_model->carrega_referencia($result, $args);
				$arr = $result->row_array();
				
				$data['row']['cd_controladoria_div_caderno_acom_resultado'] = $args['cd_controladoria_div_caderno_acom_resultado'];
				$data['row']['nr_valor_1']                                  = "";
				$data['row']['fl_media']                                    = "";
				$data['row']['observacao']                                  = "";
			...
			{
				$this->controladoria_div_caderno_acom_resultado_model->carrega($result, $args);
				$data['row'] = $result->row_array();
			}

			$this->load->view('indicador_plugin/controladoria_div_caderno_acom_resultado/cadastro', $data);
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
	...
	function salvar()
	{
		...
		{		
			...
			$args['cd_controladoria_div_caderno_acom_resultado'] = intval($this->input->post('cd_controladoria_div_caderno_acom_resultado', true));
			...
			$this->controladoria_div_caderno_acom_resultado_model->salvar($result, $args);
			
			$this->criar_indicador();
			
			redirect("indicador_plugin/controladoria_div_caderno_acom_resultado/cadastro", "refresh");
		}
        else
        {
            exibir_mensagem("ACESSO NÃO PERMITIDO");
	...
	function excluir($cd_controladoria_div_caderno_acom_resultado)
	{
		if(indicador_db::verificar_permissao(usuario_id(),'GC'))
		{
			$args   = array();
			...
			$this->controladoria_div_caderno_acom_resultado_model->excluir($result, $args);
			
			$this->criar_indicador();
			
			redirect("indicador_plugin/controladoria_div_caderno_acom_resultado", "refresh");
		}
        else
        {
            exibir_mensagem("ACESSO NÃO PERMITIDO");
	...
	function fechar_periodo()
	{
		if(indicador_db::verificar_permissao(usuario_id(),'GC'))
		{
			...
			if(intval($contador_ano_atual) > 0)
			{
				...
				$this->controladoria_div_caderno_acom_resultado_model->atualiza_fechar_periodo($result, $args);
			}

			$this->controladoria_div_caderno_acom_resultado_model->fechar_periodo($result, $args);
		}
		else
		{
			exibir_mensagem("ACESSO NÃO PERMITIDO");
