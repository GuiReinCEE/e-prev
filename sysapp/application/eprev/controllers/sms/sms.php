...
class sms extends Controller
{
	...
	{
		$_URL = "https://api.mobizon.com.br/service/message/sendSmsMessage?output=json&api=v1&apiKey=brf5fdf9d7d1d9dbfc5a6e322d4cfb3422b6f8db9eace26e2fb008b59d516e3861e305";
		$_RETORNO['fl_erro'] = "N";
		$_RETORNO['retorno'] = "";
		...
		else
		{
			try {
				...
				curl_setopt($ch, CURLOPT_POSTFIELDS,"recipient=55".intval($para)."&text=".$conteudo);
	...
	private function wsSendSMSBKP20230719($para, $assunto, $conteudo)
	{
