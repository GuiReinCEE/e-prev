...
class Chatgoogle extends Controller
{
    ...
    var $API_URL_FFP    = 'https://chat.googleapis.com/v1/spaces/AAAArxWE0FA/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=YSywspWpeq8ICUmMgRA2Zfhe3mi6yROe63vuKG3zrwE'; 
    ...
    function __construct()
    {
        ...
        $this->token_ffp    = md5('integracaoenviarffp'); #"ee22b94279e72d84ebc8e850b68ad4b6"
    }
    ...
    public function sendBotFFP()
    {
        $this->sendBot($this->API_URL_FFP, $this->token_ffp);           
    }	
