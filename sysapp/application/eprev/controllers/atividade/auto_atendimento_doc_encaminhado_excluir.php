<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'GET')
	{
		...
		curl_setopt($ch, CURLOPT_URL, APP_SRV."/srvautoatendimento/index.php/set_excluir_doc_encaminhado");
		curl_setopt($ch, CURLOPT_POST, 1);
		curl_setopt($ch, CURLOPT_POSTFIELDS, "id_app=".$_APP_ID."&re_cripto=".$_SESSION['RE_CRIPTO']."&cd_doc_encaminhado_arquivo=".$_GET['cd']);
		...
		if($FL_RETORNO)
		{
			...
			{
				echo '<META HTTP-EQUIV="Refresh" CONTENT="0;URL=auto_atendimento_doc_encaminhado.php">';
			}
			else
			{
				echo "
