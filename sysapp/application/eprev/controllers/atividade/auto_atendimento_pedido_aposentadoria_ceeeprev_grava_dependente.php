<?php
	...
	$qr_sql = "
		...
		VALUES
			 (
			   ".$_SESSION['SID'].",
			   CURRENT_TIMESTAMP,
			   'PEDIDO_APOSENTADORIA_CEEEPREV_GRAVA_DEPENDENTE'
			 );";
	@pg_query($db,$qr_sql);
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		curl_setopt($ch, CURLOPT_URL, APP_SRV."/srvautoatendimento/index.php/set_pedido_aposentadoria_ceeeprev_dependente");
		...
		curl_setopt($ch, CURLOPT_POSTFIELDS,"id_app=".$_APP_ID.
			...
			"&dt_nascimento=".$_POST['dt_nascimento_dependente'].
