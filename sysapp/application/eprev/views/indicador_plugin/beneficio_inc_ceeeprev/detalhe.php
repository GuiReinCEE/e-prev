...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inc_ceeeprev"); ?>';
	}
    function manutencao()
{
...
echo form_open( 'indicador_plugin/beneficio_inc_ceeeprev/salvar' );
echo form_hidden( 'cd_beneficio_inc_ceeeprev', intval($row['cd_beneficio_inc_ceeeprev']) );
...
if( intval($row['cd_beneficio_inc_ceeeprev'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inc_ceeeprev/excluir",$row["cd_beneficio_inc_ceeeprev"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inc_ceeeprev')."'; }");
