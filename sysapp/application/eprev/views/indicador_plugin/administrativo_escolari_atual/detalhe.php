...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_escolari_atual"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_escolari_atual/salvar' );
echo form_hidden( 'cd_administrativo_escolari_atual', intval($row['cd_administrativo_escolari_atual']) );
...
echo form_default_dropdown('mes_referencia', 'Semestre *', $ar_semestre, Array($row['dt_referencia']));
...
echo form_default_textarea("observacao", $label_11, $row['observacao']);
...
if( intval($row['cd_administrativo_escolari_atual'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_escolari_atual/excluir",$row["cd_administrativo_escolari_atual"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_escolari_atual')."'; }");
