...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inc_patroc"); ?>';
	}
    function manutencao()
    {
...
<? endif; ?>
<?
echo form_open( 'indicador_plugin/beneficio_inc_patroc/salvar' );
echo form_hidden( 'cd_beneficio_inc_patroc', intval($row['cd_beneficio_inc_patroc']) );
...
if( intval($row['cd_beneficio_inc_patroc'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inc_patroc/excluir",$row["cd_beneficio_inc_patroc"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inc_patroc')."'; }");
