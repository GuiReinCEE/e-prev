...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/auditoria_atendimento_prazo/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/auditoria_atendimento_prazo/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if( confirm('Fechar o período?') )
		{
			...
			function(data)
			{
				...
				location.href = '<?= site_url("indicador_plugin/auditoria_atendimento_prazo/fechar_periodo") ?>';
			});
		}
	}
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/auditoria_atendimento_prazo/listar') ?>",
		function(data)
		{ 
