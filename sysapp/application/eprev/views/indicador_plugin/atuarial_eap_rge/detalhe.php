...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atuarial_eap_rge"); ?>';
	}
...
echo form_open( 'indicador_plugin/atuarial_eap_rge/salvar' );
echo form_hidden( 'cd_atuarial_eap_rge', intval($row['cd_atuarial_eap_rge']) );
...
if( intval($row['cd_atuarial_eap_rge'])>0  )
{
	echo button_delete("indicador_plugin/atuarial_eap_rge/excluir",$row["cd_atuarial_eap_rge"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/atuarial_eap_rge')."'; }");
