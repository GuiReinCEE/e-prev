...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/controladoria_certificado_iso/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_certificado_iso/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/controladoria_certificado_iso/listar') ?>",
		function(data)
		{ 
