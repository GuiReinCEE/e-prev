...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_qualidade_vida"); ?>';
	}
...
echo form_open( 'indicador_plugin/atend_qualidade_vida/salvar' );
echo form_hidden( 'cd_atend_qualidade_vida', intval($row['cd_atend_qualidade_vida']) );
...
if( intval($row['cd_atend_qualidade_vida'])>0  )
{
	echo button_delete("indicador_plugin/atend_qualidade_vida/excluir",$row["cd_atend_qualidade_vida"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/atend_qualidade_vida')."'; }");
