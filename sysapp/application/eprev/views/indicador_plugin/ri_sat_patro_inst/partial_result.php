...
$body=array();
$head = array( 
	'#', $label_0, $label_1, $label_2, $label_7, $label_3, $label_4, $label_6, ''
);
...
echo anchor_popup("indicador/apresentacao/detalhe/".intval( $tabela[0]['cd_indicador_tabela'] ), 'Visualizar apresentação', $ar_janela);
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_plugin/ri_sat_patro_inst/detalhe/" . $item["cd_ri_sat_patro_inst"], "editar");
