...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/exp_volume_recursos_inpel/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/exp_volume_recursos_inpel/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/exp_volume_recursos_inpel/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/exp_volume_recursos_inpel/listar') ?>",
		function(data)
		{ 
