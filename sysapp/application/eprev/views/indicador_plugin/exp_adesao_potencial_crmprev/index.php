...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url("indicador_plugin/exp_adesao_potencial_crmprev/listar") ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url("indicador_plugin/exp_adesao_potencial_crmprev/criar_indicador") ?>", 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = "<?= site_url("indicador_plugin/exp_adesao_potencial_crmprev/cadastro") ?>";
	}
