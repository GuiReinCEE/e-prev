...
<script>
	...
	function load()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/atend_call/listar');?>',
			{},
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/atend_call/criar_indicador/"); ?>',
				{
				},
				function(data)
				{
					$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
					location.href = '<?php echo site_url("indicador_plugin/atend_call/fechar_periodo")?>';
				});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_call/detalhe/0"); ?>';
	}
