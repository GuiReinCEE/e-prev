...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_pp_pr_inconsistencia/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_pp_pr_inconsistencia/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		$.post("<?= site_url('indicador_plugin/financeiro_pp_pr_inconsistencia/criar_indicador') ?>", 
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_pp_pr_inconsistencia/fechar_periodo') ?>";
			});
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_pp_pr_inconsistencia/cadastro") ?>';
	}
