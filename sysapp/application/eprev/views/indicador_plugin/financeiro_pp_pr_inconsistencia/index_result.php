<?php
	...
	foreach($collection as $item)
	{
		...
		{
			$link = anchor('indicador_plugin/financeiro_pp_pr_inconsistencia/cadastro/'.$item['cd_financeiro_pp_pr_inconsistencia'], 'editar');
		...
		$body[] = array(
			...
			number_format($item['nr_inconsistencia'], 0, ',', '.'),
	...
	if($contador_ano_atual > 0)
	{
		...
		$body[] = array(
			...
			'<b>'.number_format($nr_inconsistencia, 0, ',', '.').'</b>', 
