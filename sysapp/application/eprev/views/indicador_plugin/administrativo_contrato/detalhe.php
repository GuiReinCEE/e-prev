...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_contrato"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_contrato/salvar' );
echo form_hidden( 'cd_administrativo_contrato', intval($row['cd_administrativo_contrato']) );
...
if( intval($row['cd_administrativo_contrato'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_contrato/excluir",$row["cd_administrativo_contrato"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_contrato')."'; }");
