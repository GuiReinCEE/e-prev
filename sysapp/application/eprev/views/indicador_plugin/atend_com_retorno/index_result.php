...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/atend_com_retorno/cadastro/" . $item["cd_atend_com_retorno"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		number_format($nr_valor_1_total, 2, ',', '.'),
		number_format($nr_valor_2_total, 2, ',', '.'), 
		'<big><b>'.app_decimal_para_php(number_format((($nr_valor_2_total*100) / $nr_valor_1_total), 2)).' %</b></big>', 
