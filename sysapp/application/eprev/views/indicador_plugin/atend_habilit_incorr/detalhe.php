...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_habilit_incorr"); ?>';
	}
...
<? endif; ?>
<?
echo form_open( 'indicador_plugin/atend_habilit_incorr/salvar' );
echo form_hidden( 'cd_atend_habilit_incorr', intval($row['cd_atend_habilit_incorr']) );
...
if( intval($row['cd_atend_habilit_incorr'])>0  )
{
	echo button_delete("indicador_plugin/atend_habilit_incorr/excluir",$row["cd_atend_habilit_incorr"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/atend_habilit_incorr')."'; }");
