...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/financeiro_originais_retificacoes_dirf_erros_operacionais/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dirf_erros_operacionais/criar_indicador") ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dirf_erros_operacionais/cadastro") ?>';
	}
