...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/financeiro_originais_retificacoes_dirf_erros_operacionais/cadastro/".$item["cd_financeiro_originais_retificacoes_dirf_erros_operacionais"], "editar");
	...
	$body[] = array(
		...
		(trim($nr_percentual_f) != '' ? intval($nr_percentual_f) : ''),
		$nr_meta,
