...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/administrativo_aval_fornecedor/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_aval_fornecedor/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/administrativo_aval_fornecedor/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/administrativo_aval_fornecedor/listar') ?>",
		function(data)
		{ 
