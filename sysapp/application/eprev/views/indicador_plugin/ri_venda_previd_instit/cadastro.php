...
<script>
    ...
    function ir_lista()
    {
        location.href='<?php echo site_url("indicador_plugin/ri_venda_previd_instit"); ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?php echo site_url("indicador_plugin/ri_venda_previd_instit/excluir/".$row["cd_ri_venda_previd_instit"]); ?>';
    }
...
echo aba_start($abas);
    echo form_open('indicador_plugin/ri_venda_previd_instit/salvar');
        echo form_start_box("default_box", $tabela[0]['ds_indicador']);
            ...
            echo form_default_hidden('cd_ri_venda_previd_instit', 'Código da tabela', intval($row['cd_ri_venda_previd_instit']));
        ...
        echo form_command_bar_detail_start();
            ...
            if(intval($row['cd_ri_venda_previd_instit']) > 0)
            {
