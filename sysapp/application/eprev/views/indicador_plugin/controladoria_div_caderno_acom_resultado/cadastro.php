...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_div_caderno_acom_resultado") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_div_caderno_acom_resultado/excluir/".$row["cd_controladoria_div_caderno_acom_resultado"]) ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/controladoria_div_caderno_acom_resultado/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_controladoria_div_caderno_acom_resultado', 'Código da tabela', intval($row['cd_controladoria_div_caderno_acom_resultado']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_controladoria_div_caderno_acom_resultado']) > 0)
			{
