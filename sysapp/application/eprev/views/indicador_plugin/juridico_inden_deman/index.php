...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/juridico_inden_deman/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/juridico_inden_deman/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?php echo site_url("indicador_plugin/juridico_inden_deman/fechar_periodo")?>';
			});
		}
	}
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/juridico_inden_deman/detalhe"); ?>';
	}
