...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/secretaria_sumulas_cf") ?>';
	}
    function manutencao()
    {
    ...
    function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/secretaria_sumulas_cf/excluir/".$row["cd_secretaria_sumulas_cf"]) ?>';
	}
...
echo aba_start( $abas );
	echo form_open( 'indicador_plugin/secretaria_sumulas_cf/salvar' );
		echo form_start_box("default_box", 'Cadastro');
			...
			echo form_default_hidden('cd_secretaria_sumulas_cf', 'Código da tabela', intval($row['cd_secretaria_sumulas_cf']));
