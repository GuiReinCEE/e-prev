...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/exp_satisfacao_com_acoes/listar') ?>',
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/exp_satisfacao_com_acoes/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/exp_satisfacao_com_acoes/cadastro") ?>';
	}
