...
<script>
	<?php 
	echo form_default_js_submit(array("mes_referencia", "ano_referencia", "cd_indicador_tabela", "nr_valor_1", "nr_valor_2", "nr_valor_3", "nr_valor_4", "nr_valor_5"),'_salvar(form)');	?>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/investimento_rentabilidade_instituidores") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/investimento_rentabilidade_instituidores/excluir/".$row["cd_investimento_rentabilidade_instituidores"]) ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/investimento_rentabilidade_instituidores/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_investimento_rentabilidade_instituidores', 'Código da tabela', intval($row['cd_investimento_rentabilidade_instituidores']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_investimento_rentabilidade_instituidores']) > 0)
			{
