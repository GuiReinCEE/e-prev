...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/financeiro_divulgacoes_extratos_planos_prazo/cadastro") ?>';
    }
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_divulgacoes_extratos_planos_prazo/criar_indicador') ?>", 
			function(data)
			{ 
        ...
        function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_divulgacoes_extratos_planos_prazo/fechar_periodo') ?>";
			});
		}
	}
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_divulgacoes_extratos_planos_prazo/listar') ?>",
		function(data)
		{ 
