...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/atend_reclamacoes_nao_tratadas/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_reclamacoes_nao_tratadas/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atend_reclamacoes_nao_tratadas/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atend_reclamacoes_nao_tratadas/listar') ?>",
		function(data)
		{ 
