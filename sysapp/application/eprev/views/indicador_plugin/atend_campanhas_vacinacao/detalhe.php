...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_campanhas_vacinacao"); ?>';
	}
...
echo form_open( 'indicador_plugin/atend_campanhas_vacinacao/salvar' );
echo form_hidden( 'cd_atend_campanhas_vacinacao', intval($row['cd_atend_campanhas_vacinacao']) );
...
if( intval($row['cd_atend_campanhas_vacinacao'])>0  )
{
	echo button_delete("indicador_plugin/atend_campanhas_vacinacao/excluir",$row["cd_atend_campanhas_vacinacao"]);
}
