...
function load()
{
	...
	$.post( '<?php echo base_url().index_page(); ?>/indicador_plugin/atend_campanhas_vacinacao/listar',{},
		function(data)
		{ 
...
function novo()
{
	location.href='<?php echo site_url("indicador_plugin/atend_campanhas_vacinacao/detalhe/0"); ?>';
}
...
function gerar_grafico()
{
	...
	{
		url = '<?php echo site_url("indicador_plugin/atend_campanhas_vacinacao/criar_indicador/"); ?>';
...
function fechar_periodo()
{
	if( confirm('Fechar o período?') )
	{
		...
		$.post('<?php echo site_url("indicador_plugin/atend_campanhas_vacinacao/criar_indicador/"); ?>',{},
			function(data)
			{
				location.href = '<?php echo site_url("indicador_plugin/atend_campanhas_vacinacao/fechar_periodo")?>';
			});
	}
}
function manutencao()
