...
<script>
	function filtrar()
		{
			...
			$.post("<?= site_url('indicador_plugin/atend_participante/listar') ?>",
			function(data)
			{ 
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_participante/cadastro"); ?>';
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_participante/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		{
			url = '<?php echo site_url("indicador_plugin/atend_participante/criar_indicador/"); ?>';
			$.post(url,{},function(data){
				$('#div-output').html( "Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				url = '<?php echo site_url("indicador_plugin/atend_participante/fechar_periodo")?>';
				location.href = url;
			});
		}
	}
