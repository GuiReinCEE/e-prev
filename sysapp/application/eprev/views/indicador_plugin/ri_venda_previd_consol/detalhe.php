...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_venda_previd_consol"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/ri_venda_previd_consol/salvar' );
echo form_hidden( 'cd_ri_venda_previd_consol', intval($row['cd_ri_venda_previd_consol']) );
...
if( intval($row['cd_ri_venda_previd_consol'])>0  )
{
	echo button_delete("indicador_plugin/ri_venda_previd_consol/excluir",$row["cd_ri_venda_previd_consol"]);
}
