...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/exp_vendas_ingressos/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/exp_vendas_ingressos/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/exp_vendas_ingressos/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/exp_vendas_ingressos/cadastro") ?>';
	}
