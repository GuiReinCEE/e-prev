...
foreach($collection as $item)
{
    ...
    {
        $link = anchor("indicador_plugin/juridico_revisao_adm_folha_beneficio/cadastro/".$item["cd_juridico_revisao_adm_folha_beneficio"], "editar");
    ...
    $body[] = array(
        ...
        (trim($nr_valor_3) != '' ? number_format($nr_valor_3,2,',','.') : ''),
