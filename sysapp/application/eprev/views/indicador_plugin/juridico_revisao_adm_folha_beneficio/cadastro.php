...
<script>
    <?php 
    echo form_default_js_submit(array("mes_referencia", "ano_referencia", "cd_indicador_tabela", "nr_valor1", "nr_valor_2", "nr_valor_3", "nr_meta"),'_salvar(form)');	
    ?>
    ...
    function ir_lista()
    {
        location.href='<?php echo site_url("indicador_plugin/juridico_revisao_adm_folha_beneficio"); ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?php echo site_url("indicador_plugin/juridico_revisao_adm_folha_beneficio/excluir/".$row["cd_juridico_revisao_adm_folha_beneficio"]); ?>';
    }
...
echo aba_start($abas);
    echo form_open('indicador_plugin/juridico_revisao_adm_folha_beneficio/salvar');
        echo form_start_box("default_box", $tabela[0]['ds_indicador']);
            ...
            echo form_default_hidden('cd_juridico_revisao_adm_folha_beneficio', 'Código da tabela', intval($row['cd_juridico_revisao_adm_folha_beneficio']));
            ...
            echo form_default_numeric("nr_valor_3", $label_3.' :', number_format($row['nr_valor_3'],2,",","."), "class='indicador_text'");
        ...
        echo form_command_bar_detail_start();
            echo button_save();
            if(intval($row['cd_juridico_revisao_adm_folha_beneficio']) > 0)
            {
