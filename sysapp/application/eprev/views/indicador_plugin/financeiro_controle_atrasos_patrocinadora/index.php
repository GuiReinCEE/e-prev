...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/financeiro_controle_atrasos_patrocinadora/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_controle_atrasos_patrocinadora/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_controle_atrasos_patrocinadora/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_controle_atrasos_patrocinadora/fechar_periodo') ?>";
			});
		}
	}
