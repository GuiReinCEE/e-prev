...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/igp_retorno_colaborador"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_plugin/igp_retorno_colaborador/excluir/".$row["cd_igp_retorno_colaborador"]); ?>';
		}
	}
...
echo form_open('indicador_plugin/igp_retorno_colaborador/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_igp_retorno_colaborador', 'Código da tabela', intval($row['cd_igp_retorno_colaborador']));
	...
	echo form_command_bar_detail_start();
		...
		if(intval($row['cd_igp_retorno_colaborador']) > 0)
		{
			echo button_save('Excluir', 'excluir('.$row["cd_igp_retorno_colaborador"].');', 'botao_vermelho');
		}
