...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/controladoria_cumprimento_projeto_modernidade/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_cumprimento_projeto_modernidade/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/controladoria_cumprimento_projeto_modernidade/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_cumprimento_projeto_modernidade/cadastro") ?>';
	}
