...
function load()
{
	...
	$.post( '<?php echo base_url().index_page(); ?>/indicador_plugin/info_satisfacao/listar',{},
		function(data)
		{ 
...
function gerar_grafico()
{
	...
	{
		url = '<?php echo site_url("indicador_plugin/info_satisfacao/criar_indicador/"); ?>';
...
function fechar_periodo()
{
	if( confirm('Fechar o período?') )
	{
		...
		$.post('<?php echo site_url("indicador_plugin/info_satisfacao/criar_indicador/"); ?>',{},
			function(data)
			{
				location.href = '<?php echo site_url("indicador_plugin/info_satisfacao/fechar_periodo")?>';
			});
	}
}
function manutencao()
