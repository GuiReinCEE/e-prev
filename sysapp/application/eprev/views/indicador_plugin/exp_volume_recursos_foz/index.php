...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/exp_volume_recursos_foz/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/exp_volume_recursos_foz/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/exp_volume_recursos_foz/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/exp_volume_recursos_foz/listar') ?>",
		function(data)
		{ 
