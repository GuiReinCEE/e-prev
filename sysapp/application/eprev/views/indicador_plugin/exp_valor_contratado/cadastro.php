...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/exp_valor_contratado"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/exp_valor_contratado/excluir/".$row["cd_exp_valor_contratado"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/exp_valor_contratado/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_exp_valor_contratado', 'Código da tabela', intval($row['cd_exp_valor_contratado']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_exp_valor_contratado']) > 0)
			{
