...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_sat_venda_plano_pos_vendas"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/ri_sat_venda_plano_pos_vendas/excluir/".$row["cd_ri_sat_venda_plano_pos_vendas"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/ri_sat_venda_plano_pos_vendas/salvar');
		echo form_start_box("default_box", $tabela[0]['ds_indicador']);
			...
			echo form_default_hidden('cd_ri_sat_venda_plano_pos_vendas', 'Código da tabela', intval($row['cd_ri_sat_venda_plano_pos_vendas']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_ri_sat_venda_plano_pos_vendas']) > 0)
			{
