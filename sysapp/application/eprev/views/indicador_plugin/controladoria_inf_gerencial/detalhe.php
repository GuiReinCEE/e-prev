...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/controladoria_inf_gerencial"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/controladoria_inf_gerencial/salvar' );
echo form_hidden( 'cd_controladoria_inf_gerencial', intval($row['cd_controladoria_inf_gerencial']) );
...
$ar_semestre = Array(Array('text' => 'Selecione', 'value' => ''),Array('text' => '01', 'value' => '01'),Array('text' => '02', 'value' => '02'),Array('text' => '03', 'value' => '03'),Array('text' => '04', 'value' => '04')) ;
...
if( intval($row['cd_controladoria_inf_gerencial'])>0  )
{
	echo button_delete("indicador_plugin/controladoria_inf_gerencial/excluir",$row["cd_controladoria_inf_gerencial"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/controladoria_inf_gerencial')."'; }");
