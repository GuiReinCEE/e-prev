...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/controladoria_obrigacoes_legais/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_obrigacoes_legais/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/controladoria_obrigacoes_legais/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/controladoria_obrigacoes_legais/listar') ?>",
		function(data)
		{ 
