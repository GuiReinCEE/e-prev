...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atend_avaliacao_exp_atendimento/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_avaliacao_exp_atendimento/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		$.post("<?= site_url('indicador_plugin/atend_avaliacao_exp_atendimento/criar_indicador') ?>", 
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atend_avaliacao_exp_atendimento/fechar_periodo') ?>";
			});
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/atend_avaliacao_exp_atendimento/cadastro") ?>';
	}
