<?php
	...
	foreach($collection as $item)
	{
		...
		{
			$link = anchor('indicador_plugin/atend_avaliacao_exp_atendimento/cadastro/'.$item['cd_atend_avaliacao_exp_atendimento'], 'editar');
		...
		$body[] = array(
			...
			number_format($item['nr_avaliacao'], 0, ',', '.'),
	...
	if($contador_ano_atual > 0)
	{
		...
		$body[] = array(
			...
			'<b>'.number_format($nr_avaliacao, 0, ',', '.').'</b>', 
