...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/atend_reclamacoes_procedentes/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_reclamacoes_procedentes/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atend_reclamacoes_procedentes/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atend_reclamacoes_procedentes/listar') ?>",
		function(data)
		{ 
