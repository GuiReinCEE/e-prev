...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/controladoria_crescimento_patrimonial/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_crescimento_patrimonial/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		$.post("<?= site_url('indicador_plugin/controladoria_crescimento_patrimonial/criar_indicador') ?>", 
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/controladoria_crescimento_patrimonial/fechar_periodo') ?>";
			});
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_crescimento_patrimonial/cadastro") ?>';
	}
