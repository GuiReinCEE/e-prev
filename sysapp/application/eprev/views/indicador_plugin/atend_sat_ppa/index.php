...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/atend_sat_ppa/cadastro/') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_sat_ppa/criar_indicador/') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/atend_sat_ppa/fechar_periodo') ?>";
			});
		}
	}
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atend_sat_ppa/listar') ?>",
		function(data)
		{ 
