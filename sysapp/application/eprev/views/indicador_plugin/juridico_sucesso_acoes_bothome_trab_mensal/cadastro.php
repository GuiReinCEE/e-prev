...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_bothome_trab_mensal/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_bothome_trab_mensal/excluir/".$row['cd_juridico_sucesso_acoes_bothome_trab_mensal']) ?>';
    }
</script>
<?php
...
<?php
        ...
        echo form_open('indicador_plugin/juridico_sucesso_acoes_bothome_trab_mensal/salvar');
        echo form_start_box('cadastro_box', 'Cadastro');
            echo form_default_hidden('cd_juridico_sucesso_acoes_bothome_trab_mensal', '', $row);
        ...
        echo button_save();
        if(intval($row['cd_juridico_sucesso_acoes_bothome_trab_mensal']) > 0) : 
