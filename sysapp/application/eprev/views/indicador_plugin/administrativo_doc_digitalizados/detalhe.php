...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_doc_digitalizados"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_doc_digitalizados/salvar' );
echo form_hidden( 'cd_administrativo_doc_digitalizados', intval($row['cd_administrativo_doc_digitalizados']) );
...
if( intval($row['cd_administrativo_doc_digitalizados'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_doc_digitalizados/excluir",$row["cd_administrativo_doc_digitalizados"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_doc_digitalizados')."'; }");
