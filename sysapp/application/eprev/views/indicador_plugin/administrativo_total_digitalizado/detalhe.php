...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_total_digitalizado"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/administrativo_total_digitalizado/salvar' );
echo form_hidden( 'cd_administrativo_total_digitalizado', intval($row['cd_administrativo_total_digitalizado']) );
...
echo form_default_float("nr_valor_12", $label_12, app_decimal_para_php($row['nr_valor_12']), "class='indicador_text'");
echo form_default_float("nr_valor_11", $label_11, app_decimal_para_php($row['nr_valor_11']), "class='indicador_text'");
echo form_default_float("nr_valor_10", $label_10, app_decimal_para_php($row['nr_valor_10']), "class='indicador_text'");
echo form_default_float("nr_valor_9", $label_9, app_decimal_para_php($row['nr_valor_9']), "class='indicador_text'");
echo form_default_float("nr_valor_8", $label_8, app_decimal_para_php($row['nr_valor_8']), "class='indicador_text'");
echo form_default_float("nr_valor_7", $label_7, app_decimal_para_php($row['nr_valor_7']), "class='indicador_text'");
echo form_default_float("nr_valor_6", $label_6, app_decimal_para_php($row['nr_valor_6']), "class='indicador_text'");
echo form_default_float("nr_valor_5", $label_5, app_decimal_para_php($row['nr_valor_5']), "class='indicador_text'");
echo form_default_float("nr_valor_4", $label_4, app_decimal_para_php($row['nr_valor_4']), "class='indicador_text'");
...
echo form_default_float("nr_valor_13", $label_13, app_decimal_para_php($row['nr_valor_13']), "class='indicador_text'");
...
if( intval($row['cd_administrativo_total_digitalizado'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_total_digitalizado/excluir",$row["cd_administrativo_total_digitalizado"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_total_digitalizado')."'; }");
