...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_pessoal"); ?>';
	}
...
echo form_open( 'indicador_plugin/atend_pessoal/salvar' );
echo form_hidden( 'cd_atend_pessoal', intval($row['cd_atend_pessoal']) );
...
//echo form_default_integer("nr_atendimento_re", $label_1, app_decimal_para_php($row['nr_atendimento_re']), "class='indicador_text'"); 
echo form_default_integer("nr_valor_2", $label_3, app_decimal_para_php($row['nr_valor_2']), "class='indicador_text'"); 

echo form_default_time("nr_valor_time_2", $label_4.": (*)", $row['nr_valor_time_2'], "class='indicador_text'");
//echo form_default_numeric("nr_percentual_f", $label_4, number_format($row['nr_percentual_f'],2,",","."), "class='indicador_text'");
...
if( intval($row['cd_atend_pessoal'])>0  )
{
	echo button_delete("indicador_plugin/atend_pessoal/excluir",$row["cd_atend_pessoal"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/atend_pessoal')."'; }");
