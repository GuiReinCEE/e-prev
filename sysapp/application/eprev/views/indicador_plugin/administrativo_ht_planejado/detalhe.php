...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_ht_planejado"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/administrativo_ht_planejado/salvar' );
echo form_hidden( 'cd_administrativo_ht_planejado', intval($row['cd_administrativo_ht_planejado']) );
...
if( intval($row['cd_administrativo_ht_planejado'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_ht_planejado/excluir",$row["cd_administrativo_ht_planejado"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_ht_planejado')."'; }");
