...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_acessos_email_marketing"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/ri_acessos_email_marketing/excluir/".$row["cd_ri_acessos_email_marketing"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/ri_acessos_email_marketing/salvar');
		echo form_start_box("default_box", $tabela[0]['ds_indicador']);
			echo form_default_hidden('cd_ri_acessos_email_marketing','', intval($row['cd_ri_acessos_email_marketing']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_ri_acessos_email_marketing']) > 0)
			{
