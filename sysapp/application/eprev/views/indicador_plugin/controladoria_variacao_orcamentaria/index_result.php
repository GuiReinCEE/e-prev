...
foreach( $collection as $item )
{
	...
	{
		$link = anchor("indicador_plugin/controladoria_variacao_orcamentaria/cadastro/".$item["cd_controladoria_variacao_orcamentaria"], "editar");
	...
	$body[] = array(
		...
		number_format($item['nr_meta_2'],2,',','.').'%',
...
if(intval($contador_ano_atual) > 0)
{
	$body[] = array(
		...
		'<b>'.number_format(($ultimo_mes_2 / $ultimo_mes_1)*100,2,',','.').'%</b>',
		'<b>'.number_format($ultima_meta_2,2,',','.').'%</b>',
