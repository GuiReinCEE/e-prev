...
function filtrar()
{
	...
	$.post('<?php echo site_url('indicador_plugin/ri_acessos_boletim_on_line/listar');?>',
	function(data)
	{ 
...
function novo()
{
	location.href='<?php echo site_url("indicador_plugin/ri_acessos_boletim_on_line/cadastro"); ?>';
}
...
function gerar_grafico()
{
	...
	{
		$.post('<?php echo site_url("indicador_plugin/ri_acessos_boletim_on_line/criar_indicador/"); ?>', 
		function(data)
		{ 
...
function fechar_periodo()
{
	...
	else if( confirm('Fechar o período?') )
	{
		...
		function(data)
		{
			...
			location.href = '<?php echo site_url("indicador_plugin/ri_acessos_boletim_on_line/fechar_periodo")?>';
		});
	}
}
