...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_acessos_boletim_on_line"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/ri_acessos_boletim_on_line/excluir/".$row["cd_ri_acessos_boletim_on_line"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/ri_acessos_boletim_on_line/salvar');
		echo form_start_box("default_box", $tabela[0]['ds_indicador']);
			echo form_default_hidden('cd_ri_acessos_boletim_on_line','', intval($row['cd_ri_acessos_boletim_on_line']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_ri_acessos_boletim_on_line']) > 0)
			{
