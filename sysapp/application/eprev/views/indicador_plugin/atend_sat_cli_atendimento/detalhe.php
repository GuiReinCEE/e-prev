...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_sat_cli_atendimento"); ?>';
	}
...
echo form_open( 'indicador_plugin/atend_sat_cli_atendimento/salvar' );
echo form_hidden( 'cd_atend_sat_cli_atendimento', intval($row['cd_atend_sat_cli_atendimento']) );
...
echo form_default_float("nr_valor_2", $label_3, app_decimal_para_php($row['nr_valor_2']), "class='indicador_text'");
echo form_default_float("nr_valor_3", $label_5, app_decimal_para_php($row['nr_valor_3']), "class='indicador_text'");
echo form_default_float("nr_meta_1", $label_2, app_decimal_para_php($row['nr_meta_1']), "class='indicador_text'");
echo form_default_float("nr_meta_2", $label_4, app_decimal_para_php($row['nr_meta_2']), "class='indicador_text'");
echo form_default_float("nr_meta_3", $label_6, app_decimal_para_php($row['nr_meta_3']), "class='indicador_text'");
...
if( intval($row['cd_atend_sat_cli_atendimento'])>0  )
{
	echo button_delete("indicador_plugin/atend_sat_cli_atendimento/excluir",$row["cd_atend_sat_cli_atendimento"]);
}
