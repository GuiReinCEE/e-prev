...
function load()
{
	...
	$.post( '<?php echo base_url().index_page(); ?>/indicador_plugin/atend_sat_cli_atendimento/listar',{},
		function(data)
		{ 
...
function gerar_grafico()
{
	...
	{
		url = '<?php echo site_url("indicador_plugin/atend_sat_cli_atendimento/criar_indicador/"); ?>';
...
function fechar_periodo()
{
	if( confirm('Fechar o período?') )
	{
		...
		$.post('<?php echo site_url("indicador_plugin/atend_sat_cli_atendimento/criar_indicador/"); ?>',{},
			function(data)
			{
				location.href = '<?php echo site_url("indicador_plugin/atend_sat_cli_atendimento/fechar_periodo")?>';
			});
	}
}
...
function novo()
{
	location.href='<?php echo site_url("indicador_plugin/atend_sat_cli_atendimento/detalhe/0"); ?>';
}
