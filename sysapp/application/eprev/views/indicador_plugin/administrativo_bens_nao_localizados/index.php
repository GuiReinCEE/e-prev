...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/administrativo_bens_nao_localizados/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/administrativo_bens_nao_localizados/criar_indicador") ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/administrativo_bens_nao_localizados/cadastro") ?>';
	}
