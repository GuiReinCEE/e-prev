...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/administrativo_custo_correspondencia/cadastro/".$item["cd_administrativo_custo_correspondencia"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		'<big><b>'.(trim($nr_valor_1_total) != '' ? number_format($nr_valor_1_total, 2, ",", ".") : '').'</b></big>', 
