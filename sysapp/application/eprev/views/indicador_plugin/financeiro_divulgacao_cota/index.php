...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/financeiro_divulgacao_cota/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_divulgacao_cota/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_divulgacao_cota/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_divulgacao_cota/fechar_periodo') ?>";
			});
		}
	}
