...
<script>
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/controladoria_norma/excluir/".$row["cd_controladoria_norma"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/controladoria_norma/salvar');
		echo form_start_box("default_box", 'Cadastro');
			...
			echo form_default_hidden('cd_controladoria_norma', 'Código da tabela', intval($row['cd_controladoria_norma']));
