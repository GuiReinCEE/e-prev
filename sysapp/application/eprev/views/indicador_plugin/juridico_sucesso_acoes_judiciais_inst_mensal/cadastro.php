...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_judiciais_inst_mensal/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_judiciais_inst_mensal/excluir/".$row['cd_juridico_sucesso_acoes_judiciais_inst_mensal']) ?>';
    }
    ...
    function getValores()
	{
		if(($("#mes_referencia").val() != "") && ($("#ano_referencia").val() != ""))
		{
			...
			$.post('<?php echo site_url("indicador_plugin/juridico_sucesso_acoes_judiciais_inst_mensal/get_valores"); ?>', 
			{
...
<?php
        ...
        echo form_open('indicador_plugin/juridico_sucesso_acoes_judiciais_inst_mensal/salvar');
        echo form_start_box('cadastro_box', 'Cadastro');
            echo form_default_hidden('cd_juridico_sucesso_acoes_judiciais_inst_mensal', '', $row);
        ...
        if(intval($row['cd_juridico_sucesso_acoes_judiciais_inst_mensal']) > 0) : 
