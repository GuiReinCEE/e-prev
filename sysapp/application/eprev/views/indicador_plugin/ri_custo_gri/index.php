...
function load()
{
	...
	$.post( '<?php echo base_url().index_page(); ?>/indicador_plugin/ri_custo_gri/listar',{},
		function(data)
		{ 
...
function novo()
{
	location.href='<?php echo site_url("indicador_plugin/ri_custo_gri/detalhe/0"); ?>';
}
...
function gerar_grafico()
{
	...
	{
		url = '<?php echo site_url("indicador_plugin/ri_custo_gri/criar_indicador/"); ?>';
...
function fechar_periodo()
{
	if( confirm('Fechar o período?') )
	{
		...
		$.post('<?php echo site_url("indicador_plugin/ri_custo_gri/criar_indicador/"); ?>',{},
			function(data)
			{
				location.href = '<?php echo site_url("indicador_plugin/ri_custo_gri/fechar_periodo")?>';
			});
	}
}
function manutencao()
