...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_custo_gri"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/ri_custo_gri/salvar' );
echo form_hidden( 'cd_ri_custo_gri', intval($row['cd_ri_custo_gri']) );
...
if( intval($row['cd_ri_custo_gri'])>0  )
{
	echo button_delete("indicador_plugin/ri_custo_gri/excluir",$row["cd_ri_custo_gri"]);
}
