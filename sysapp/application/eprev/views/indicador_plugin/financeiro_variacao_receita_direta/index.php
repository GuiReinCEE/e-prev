...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_variacao_receita_direta/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_variacao_receita_direta/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		$.post("<?= site_url('indicador_plugin/financeiro_variacao_receita_direta/criar_indicador') ?>", 
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_variacao_receita_direta/fechar_periodo') ?>";
			});
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_variacao_receita_direta/cadastro") ?>';
	}
