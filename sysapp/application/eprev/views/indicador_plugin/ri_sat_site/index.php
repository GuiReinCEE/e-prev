...
function load()
{
	...
	$.post( '<?php echo base_url().index_page(); ?>/indicador_plugin/ri_sat_site/listar',{},
		function(data)
		{ 
...
function novo()
{
	location.href='<?php echo site_url("indicador_plugin/ri_sat_site/detalhe/0"); ?>';
}
...
function gerar_grafico()
{
	...
	{
		url = '<?php echo site_url("indicador_plugin/ri_sat_site/criar_indicador/"); ?>';
...
function fechar_periodo()
{
	if( confirm('Fechar o período?') )
	{
		...
		$.post('<?php echo site_url("indicador_plugin/ri_sat_site/criar_indicador/"); ?>',{},
			function(data)
			{
				location.href = '<?php echo site_url("indicador_plugin/ri_sat_site/fechar_periodo")?>';
			});
	}
}
function manutencao()
