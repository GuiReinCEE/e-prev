...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_sat_site"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/ri_sat_site/salvar' );
echo form_hidden( 'cd_ri_sat_site', intval($row['cd_ri_sat_site']) );
...
if( intval($row['cd_ri_sat_site'])>0  )
{
	echo button_delete("indicador_plugin/ri_sat_site/excluir",$row["cd_ri_sat_site"]);
}
