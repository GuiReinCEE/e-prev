...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_cumprimento_planej_marketing"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/ri_cumprimento_planej_marketing/salvar' );
echo form_hidden( 'cd_ri_cumprimento_planej_marketing', intval($row['cd_ri_cumprimento_planej_marketing']) );
...
if( intval($row['cd_ri_cumprimento_planej_marketing'])>0  )
{
	echo button_delete("indicador_plugin/ri_cumprimento_planej_marketing/excluir",$row["cd_ri_cumprimento_planej_marketing"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/ri_cumprimento_planej_marketing')."'; }");
