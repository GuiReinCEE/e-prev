...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_he_qtd"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_he_qtd/salvar' );
echo form_hidden( 'cd_administrativo_he_qtd', intval($row['cd_administrativo_he_qtd']) );
...
if( intval($row['cd_administrativo_he_qtd'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_he_qtd/excluir",$row["cd_administrativo_he_qtd"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_he_qtd')."'; }");
