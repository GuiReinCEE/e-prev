...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atuarial_exigencia_previc_regulamento/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atuarial_exigencia_previc_regulamento/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/atuarial_exigencia_previc_regulamento/cadastro") ?>';
	}
