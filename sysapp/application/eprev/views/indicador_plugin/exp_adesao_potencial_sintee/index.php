...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/exp_adesao_potencial_sintee/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/exp_adesao_potencial_sintee/criar_indicador") ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/exp_adesao_potencial_sintee/cadastro") ?>';
	}
