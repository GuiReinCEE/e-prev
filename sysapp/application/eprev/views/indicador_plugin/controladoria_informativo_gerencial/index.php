...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/controladoria_informativo_gerencial/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/controladoria_informativo_gerencial/criar_indicador") ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?php echo site_url("indicador_plugin/controladoria_informativo_gerencial/fechar_periodo")?>';
			});
		}
	}
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/controladoria_informativo_gerencial/criar_indicador"); ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/controladoria_informativo_gerencial/cadastro"); ?>';
	}
