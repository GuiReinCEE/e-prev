...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_civel_fundacao_re/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_civel_fundacao_re/excluir/".$row['cd_juridico_sucesso_acoes_civel_fundacao_re']) ?>';
    }
</script>
<?php
...
<?php
        ...
        echo form_open('indicador_plugin/juridico_sucesso_acoes_civel_fundacao_re/salvar');
        echo form_start_box('cadastro_box', 'Cadastro');
            echo form_default_hidden('cd_juridico_sucesso_acoes_civel_fundacao_re', '', $row);
        ...
        echo button_save();
        if(intval($row['cd_juridico_sucesso_acoes_civel_fundacao_re']) > 0) : 
