...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/investimento_rentabilidade_carteira/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/investimento_rentabilidade_carteira/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/investimento_rentabilidade_carteira/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/investimento_rentabilidade_carteira/listar') ?>",
		function(data)
		{ 
