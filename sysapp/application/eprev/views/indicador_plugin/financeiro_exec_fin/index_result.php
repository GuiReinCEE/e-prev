...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/financeiro_exec_fin/cadastro/".$item["cd_financeiro_exec_fin"], "editar");
	...
	$body[] = array(
		$contador--,
		$referencia,
		(trim($nr_valor_1) != '' ? number_format(intval($nr_valor_1), 0, ',', '.') : ''),
		(trim($nr_valor_2) != '' ? number_format(intval($nr_valor_2), 0, ',', '.') : ''),
