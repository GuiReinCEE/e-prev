...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/controladoria_atend_requi_prazo/cadastro/" . $item["cd_controladoria_atend_requi_prazo"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		$nr_valor_1_total, 
		$nr_valor_2_total, 
		'<big><b>'.number_format($resultado, 2, ',', '.').' %</b></big>', 
		'', 
		number_format($nr_meta, 2, ',', '.').' %', 
		'', 
		''
