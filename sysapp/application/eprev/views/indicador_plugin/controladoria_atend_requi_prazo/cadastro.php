...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_atend_requi_prazo") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_atend_requi_prazo/excluir/".$row["cd_controladoria_atend_requi_prazo"]) ?>';
	}
...
?>
	...
	<?
	echo form_open('indicador_plugin/controladoria_atend_requi_prazo/salvar');
		echo form_start_box("default_box", 'Cadastro');
			...
			echo form_default_hidden('cd_controladoria_atend_requi_prazo', 'Código da tabela', intval($row['cd_controladoria_atend_requi_prazo']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_controladoria_atend_requi_prazo']) > 0)
			{
