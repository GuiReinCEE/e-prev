...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/administrativo_retorno_pessoa/listar') ?>",
		function(data)
		{ 
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/administrativo_retorno_pessoa/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_retorno_pessoa/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/administrativo_retorno_pessoa/fechar_periodo') ?>";
			});
		}
	}
