...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atuarial_divulgacao_extratos_prazo/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atuarial_divulgacao_extratos_prazo/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		$.post("<?= site_url('indicador_plugin/atuarial_divulgacao_extratos_prazo/criar_indicador') ?>", 
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atuarial_divulgacao_extratos_prazo/fechar_periodo') ?>";
			});
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/atuarial_divulgacao_extratos_prazo/cadastro") ?>';
	}
