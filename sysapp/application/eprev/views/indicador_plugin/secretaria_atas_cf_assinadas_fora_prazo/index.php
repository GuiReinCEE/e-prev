...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/secretaria_atas_cf_assinadas_fora_prazo/listar') ?>',
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/secretaria_atas_cf_assinadas_fora_prazo/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/secretaria_atas_cf_assinadas_fora_prazo/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/secretaria_atas_cf_assinadas_fora_prazo/cadastro") ?>';
	}
