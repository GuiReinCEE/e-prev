...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/cadastro_atividades/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/cadastro_atividades/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/cadastro_atividades/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/cadastro_atividades/fechar_periodo') ?>";
			});
		}
	}
