...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/atendimento_retencao_cliente_valores/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atendimento_retencao_cliente_valores/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atendimento_retencao_cliente_valores/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atendimento_retencao_cliente_valores/fechar_periodo') ?>";
			});
		}
	}
