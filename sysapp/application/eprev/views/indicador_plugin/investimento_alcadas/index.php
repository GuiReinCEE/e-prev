...
function ir_lista()
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/investimento_alcadas/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/investimento_alcadas/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/investimento_alcadas/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/investimento_alcadas/fechar_periodo') ?>";
			});
		}
	}
