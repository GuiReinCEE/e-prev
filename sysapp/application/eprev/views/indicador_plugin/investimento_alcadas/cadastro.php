...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/investimento_alcadas/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/investimento_alcadas/excluir/".$row['cd_investimento_alcadas']) ?>';
    }
</script>
<?php
...
<?php
	...
	<? endif; ?>
	<?
        echo form_open('indicador_plugin/investimento_alcadas/salvar');
            echo form_start_box('cadastro_box', 'Cadastro');
                echo form_default_hidden('cd_investimento_alcadas', '', $row);
                ...
                echo form_default_integer('nr_alcadas_atendidas', $label_1.': (*)', $row['nr_alcadas_atendidas'], 'class="indicador_text"');
            ...
            echo form_command_bar_detail_start();
                echo button_save();
                if(intval($row['cd_investimento_alcadas']) > 0) : 
