...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url("indicador_plugin/exp_adesao_projetado_inpelprev/listar") ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url("indicador_plugin/exp_adesao_projetado_inpelprev/criar_indicador") ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/exp_adesao_projetado_inpelprev/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = "<?= site_url("indicador_plugin/exp_adesao_projetado_inpelprev/cadastro") ?>";
	}
