...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/atend_numero_atendimentos/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_numero_atendimentos/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atend_numero_atendimentos/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atend_numero_atendimentos/listar') ?>",
		function(data)
		{ 
