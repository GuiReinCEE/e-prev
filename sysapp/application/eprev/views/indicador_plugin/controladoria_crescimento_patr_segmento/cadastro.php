...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_crescimento_patr_segmento") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_crescimento_patr_segmento/excluir/".$row["cd_controladoria_crescimento_patr_segmento"]) ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/controladoria_crescimento_patr_segmento/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_controladoria_crescimento_patr_segmento', 'Código da tabela', intval($row['cd_controladoria_crescimento_patr_segmento']));
			...
			echo form_default_dropdown("mes_referencia", "Trimestre :*", array(array("value" => "01", "text" => "01"), array("value" => "02", "text" => "02"), array("value" => "03", "text" => "03"), array("value" => "04", "text" => "04")), $row['mes_referencia'], "class='indicador_text'");
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_controladoria_crescimento_patr_segmento']) > 0)
			{
