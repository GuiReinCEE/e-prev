...
<script>
	...
	function ir_lista()
	{
		location.href = "<?= site_url("indicador_plugin/atuarial_ceeeprev_migrados") ?>";
	}
	...
	function excluir()
	{
		location.href = "<?= site_url("indicador_plugin/atuarial_ceeeprev_migrados/excluir/".$row["cd_atuarial_ceeeprev_migrados"]) ?>";
	}
...
<? else: ?>
<?= form_open('indicador_plugin/atuarial_ceeeprev_migrados/salvar') ?>
	...
	<?= form_start_box('default_box', 'Cadastro') ?>
		...
		<?= form_default_hidden('cd_atuarial_ceeeprev_migrados', '', intval($row['cd_atuarial_ceeeprev_migrados'])) ?>
	...
	<?= form_command_bar_detail_start()?>
		<?= button_save()?>
		<? if(intval($row['cd_atuarial_ceeeprev_migrados']) > 0) :?>
