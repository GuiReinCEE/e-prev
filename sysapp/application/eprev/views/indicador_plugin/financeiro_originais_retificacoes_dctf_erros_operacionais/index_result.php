...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/financeiro_originais_retificacoes_dctf_erros_operacionais/cadastro/".$item["cd_financeiro_originais_retificacoes_dctf_erros_operacionais"], "editar");
