...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/financeiro_originais_retificacoes_dctf_erros_operacionais/listar') ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dctf_erros_operacionais/criar_indicador") ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dctf_erros_operacionais/fechar_periodo") ?>';
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dctf_erros_operacionais/cadastro") ?>';
	}
