...
<script>
	...
	function ir_lista()
	{
		location.href = "<?= site_url('indicador_plugin/controladoria_divulgacao_ci_prazo') ?>";
	}
	...
	function excluir()
	{
		location.href = "<?= site_url('indicador_plugin/controladoria_divulgacao_ci_prazo/excluir/'.$row['cd_controladoria_divulgacao_ci_prazo']) ?>";
	}
...
?>
	...
	<? endif; ?>
			...
			<?= form_open('indicador_plugin/controladoria_divulgacao_ci_prazo/salvar')?>
				<?= form_start_box("default_box", 'Cadastro')?>
					...
					<?= form_default_hidden('cd_controladoria_divulgacao_ci_prazo', 'Código da tabela', intval($row['cd_controladoria_divulgacao_ci_prazo']))?>
				...
				<?= form_command_bar_detail_start()?>
					...
					<? if(intval($row['cd_controladoria_divulgacao_ci_prazo']) > 0) : ?>
