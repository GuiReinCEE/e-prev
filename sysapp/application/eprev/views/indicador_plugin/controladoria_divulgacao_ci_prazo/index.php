...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/controladoria_divulgacao_ci_prazo/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_divulgacao_ci_prazo/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		$.post("<?= site_url('indicador_plugin/controladoria_divulgacao_ci_prazo/criar_indicador') ?>", 
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/controladoria_divulgacao_ci_prazo/fechar_periodo') ?>";
			});
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_divulgacao_ci_prazo/cadastro") ?>';
	}
