...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/controladoria_implementacao_projetos/listar') ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_implementacao_projetos/criar_indicador') ?>", 
			function(data)
			{
				$("#div-output").html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ...");

				location.href = '<?= site_url("indicador_plugin/controladoria_implementacao_projetos/fechar_periodo") ?>';
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_implementacao_projetos/cadastro") ?>';
	}
