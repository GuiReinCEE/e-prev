...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atuarial_eap_ceeeprev_cd"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/atuarial_eap_ceeeprev_cd/salvar' );
echo form_hidden( 'cd_atuarial_eap_ceeeprev_cd', intval($row['cd_atuarial_eap_ceeeprev_cd']) );
...
if( intval($row['cd_atuarial_eap_ceeeprev_cd'])>0  )
{
	echo button_delete("indicador_plugin/atuarial_eap_ceeeprev_cd/excluir",$row["cd_atuarial_eap_ceeeprev_cd"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/atuarial_eap_ceeeprev_cd')."'; }");
