...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_impressao"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_impressao/salvar' );
echo form_hidden( 'cd_administrativo_impressao', intval($row['cd_administrativo_impressao']) );
...
if( intval($row['cd_administrativo_impressao'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_impressao/excluir",$row["cd_administrativo_impressao"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_impressao')."'; }");
