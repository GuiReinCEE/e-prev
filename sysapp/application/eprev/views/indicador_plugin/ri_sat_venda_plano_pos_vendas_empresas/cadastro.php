...
<script>
	<?php 
	echo form_default_js_submit(array("mes_referencia", "ano_referencia", "cd_indicador_tabela", "cd_empresa", "nr_valor1", "nr_valor_2", "nr_meta"),'_salvar(form)');	?>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_sat_venda_plano_pos_vendas_empresas"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/ri_sat_venda_plano_pos_vendas_empresas/excluir/".$row["cd_ri_sat_venda_plano_pos_vendas_empresas"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/ri_sat_venda_plano_pos_vendas_empresas/salvar');
		echo form_start_box("default_box", $tabela[0]['ds_indicador']);
			...
			echo form_default_hidden('cd_ri_sat_venda_plano_pos_vendas_empresas', 'Código da tabela', intval($row['cd_ri_sat_venda_plano_pos_vendas_empresas']));
            ...
            echo form_default_dropdown('cd_empresa', $label_1.' :*', $arr_empresa, array($row['cd_empresa']));
			echo form_default_integer("nr_valor_1", $label_2.' :', ($row['nr_valor_1']), "class='indicador_text'"); 
			echo form_default_integer("nr_valor_2", $label_3.' :', ($row['nr_valor_2']), "class='indicador_text'");
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_ri_sat_venda_plano_pos_vendas_empresas']) > 0)
			{
