...
function ir_lista()
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/investimento_rentabilidade_competitiva/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/investimento_rentabilidade_competitiva/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/investimento_rentabilidade_competitiva/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/investimento_rentabilidade_competitiva/fechar_periodo') ?>";
			});
		}
	}
