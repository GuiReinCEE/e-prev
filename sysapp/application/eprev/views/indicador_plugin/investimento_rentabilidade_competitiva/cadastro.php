...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/investimento_rentabilidade_competitiva/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/investimento_rentabilidade_competitiva/excluir/".$row['cd_investimento_rentabilidade_competitiva']) ?>';
    }
</script>
<?php
...
<?php
	...
	<?
        echo form_open('indicador_plugin/investimento_rentabilidade_competitiva/salvar');
            echo form_start_box('cadastro_box', 'Cadastro');
                echo form_default_hidden('cd_investimento_rentabilidade_competitiva', '', $row);
                ...
                echo form_default_textarea('observacao', $label_3.':', $row);
            echo form_end_box('cadastro_box');
            echo form_command_bar_detail_start();
                echo button_save();
                if(intval($row['cd_investimento_rentabilidade_competitiva']) > 0) : 
