...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/exp_adesao_potencial_sinpro/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/exp_adesao_potencial_sinpro/criar_indicador") ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/exp_adesao_potencial_sinpro/cadastro") ?>';
	}
