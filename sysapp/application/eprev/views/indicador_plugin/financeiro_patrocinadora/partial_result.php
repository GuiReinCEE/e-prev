...
else
{
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_plugin/financeiro_patrocinadora/detalhe/" . $item["cd_financeiro_patrocinadora"], "editar");
		...
		$body[] = array(
			 $contador--
			, $referencia
			, ($nr_valor!='')?number_format($nr_valor,2,',','.'):''
			, ($nr_execucao!='')?number_format($nr_execucao,2,',','.'):''
