...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_resul_colaborador"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_resul_colaborador/salvar' );
echo form_hidden( 'cd_administrativo_resul_colaborador', intval($row['cd_administrativo_resul_colaborador']) );
...
echo form_default_float("nr_valor_3", $label_5, app_decimal_para_php($row['nr_valor_2']), "class='indicador_text'");
echo form_default_float("nr_meta", $label_8, app_decimal_para_php($row['nr_meta']), "class='indicador_text'");
...
if( intval($row['cd_administrativo_resul_colaborador'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_resul_colaborador/excluir",$row["cd_administrativo_resul_colaborador"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_resul_colaborador')."'; }");
