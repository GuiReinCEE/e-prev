...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/administrativo_horas_ext_realizado_orcado/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_horas_ext_realizado_orcado/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/administrativo_horas_ext_realizado_orcado/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/administrativo_horas_ext_realizado_orcado/listar') ?>",
		function(data)
		{ 
