<?php
    ...
    foreach($collection as $item)
	{
		...
		{
			$link = anchor('indicador_plugin/juridico_sucesso_acoes_castro_barcellos_trab_mensal/cadastro/'.$item['cd_juridico_sucesso_acoes_castro_barcellos_trab_mensal'], 'editar');
