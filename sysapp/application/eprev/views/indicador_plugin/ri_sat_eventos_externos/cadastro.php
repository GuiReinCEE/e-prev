...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_sat_eventos_externos"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_plugin/ri_sat_eventos_externos/excluir/".$row["cd_ri_sat_eventos_externos"]); ?>';
		}
	}
...
echo form_open('indicador_plugin/ri_sat_eventos_externos/salvar');
	echo form_start_box("default_box", "Cadastro");
		echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
		echo form_default_hidden('cd_ri_sat_eventos_externos', 'Código da tabela', intval($row['cd_ri_sat_eventos_externos']));
	...
	echo form_command_bar_detail_start();
		...
		if(intval($row['cd_ri_sat_eventos_externos']) > 0)
		{
