...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/atuarial_atendimento_transferencia_plano") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/atuarial_atendimento_transferencia_plano/excluir/".$row["cd_atuarial_atendimento_transferencia_plano"]) ?>';
	}
...
<?php
	...
	<?
		echo form_open('indicador_plugin/atuarial_atendimento_transferencia_plano/salvar');
			echo form_start_box("default_box", 'Cadastro');
				echo form_default_hidden('cd_indicador_tabela', '', $tabela[0]['cd_indicador_tabela']);
				echo form_default_hidden('cd_atuarial_atendimento_transferencia_plano', '', $row['cd_atuarial_atendimento_transferencia_plano']);
			...
			echo form_command_bar_detail_start();
				echo button_save();
				if(intval($row['cd_atuarial_atendimento_transferencia_plano']) > 0)
				{
