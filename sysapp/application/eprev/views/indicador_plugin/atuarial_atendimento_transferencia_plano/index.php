...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/atuarial_atendimento_transferencia_plano/listar') ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atuarial_atendimento_transferencia_plano/criar_indicador') ?>", 
			function(data)
			{
				$("#div-output").html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ...");

				location.href = '<?= site_url("indicador_plugin/atuarial_atendimento_transferencia_plano/fechar_periodo") ?>';
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/atuarial_atendimento_transferencia_plano/cadastro") ?>';
	}
