...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inc_cgtee"); ?>';
	}
    function manutencao()
{
...
echo form_open( 'indicador_plugin/beneficio_inc_cgtee/salvar' );
echo form_hidden( 'cd_beneficio_inc_cgtee', intval($row['cd_beneficio_inc_cgtee']) );
...
if( intval($row['cd_beneficio_inc_cgtee'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inc_cgtee/excluir",$row["cd_beneficio_inc_cgtee"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inc_cgtee')."'; }");
