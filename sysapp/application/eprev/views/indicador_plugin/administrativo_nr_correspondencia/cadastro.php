...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/administrativo_nr_correspondencia") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/administrativo_nr_correspondencia/excluir/".$row["cd_administrativo_nr_correspondencia"]) ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/administrativo_nr_correspondencia/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_administrativo_nr_correspondencia', 'Código da tabela', intval($row['cd_administrativo_nr_correspondencia']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_administrativo_nr_correspondencia']) > 0)
			{
