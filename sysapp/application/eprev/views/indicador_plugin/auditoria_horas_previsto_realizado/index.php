...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/auditoria_horas_previsto_realizado/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/auditoria_horas_previsto_realizado/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/auditoria_horas_previsto_realizado/listar') ?>",
		function(data)
		{ 
