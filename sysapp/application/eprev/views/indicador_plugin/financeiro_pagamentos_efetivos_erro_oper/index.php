...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_pagamentos_efetivos_erro_oper/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_pagamentos_efetivos_erro_oper/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_pagamentos_efetivos_erro_oper/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_pagamentos_efetivos_erro_oper/cadastro") ?>';
	}
