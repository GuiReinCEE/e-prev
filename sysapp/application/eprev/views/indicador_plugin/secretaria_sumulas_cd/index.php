...
function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/secretaria_sumulas_cd/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
		{
			...
			{
				$.post('<?= site_url("indicador_plugin/secretaria_sumulas_cd/criar_indicador") ?>', 
				function(data)
				{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/secretaria_sumulas_cd/fechar_periodo') ?>";
			});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/secretaria_sumulas_cd/cadastro/"); ?>';
	}
