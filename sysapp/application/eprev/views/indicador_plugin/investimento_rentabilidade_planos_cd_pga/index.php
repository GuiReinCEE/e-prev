...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/investimento_rentabilidade_planos_cd_pga/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/investimento_rentabilidade_planos_cd_pga/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/investimento_rentabilidade_planos_cd_pga/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/investimento_rentabilidade_planos_cd_pga/listar') ?>",
		function(data)
		{ 
