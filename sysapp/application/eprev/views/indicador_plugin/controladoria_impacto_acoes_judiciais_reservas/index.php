...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/controladoria_impacto_acoes_judiciais_reservas/listar') ?>',
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/controladoria_impacto_acoes_judiciais_reservas/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_impacto_acoes_judiciais_reservas/cadastro") ?>';
	}
