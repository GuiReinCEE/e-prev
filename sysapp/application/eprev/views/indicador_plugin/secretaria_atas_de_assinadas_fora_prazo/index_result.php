...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/secretaria_atas_de_assinadas_fora_prazo/cadastro/".$item["cd_secretaria_atas_de_assinadas_fora_prazo"], "editar");
	...
	$body[] = array(
		...
		number_format($item['nr_atas_disp_10_dias'], 0, ',', '.'),
		number_format($item['nr_percent_disp_10_dias'], 2, ',', '.').' %',
...
if($contador_ano_atual > 0)
{
	...
	$body[] = array(
		...
		'<b>'.number_format($nr_atas_disp_10_dias, 0, ',', '.').'</b>', 
		'<b>'.number_format($nr_percent_disp_10_dias, 2, ',', '.').' %</b>',
