...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/investimento_carteira_inv_bd/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/investimento_carteira_inv_bd/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/investimento_carteira_inv_bd/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/investimento_carteira_inv_bd/listar') ?>",
		function(data)
		{ 
