...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/ri_sat_eventos_internos/listar'); ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/ri_sat_eventos_internos/criar_indicador"); ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_sat_eventos_internos/cadastro"); ?>';
	}
