...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/atendimento_retencao_cliente/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atendimento_retencao_cliente/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atendimento_retencao_cliente/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atendimento_retencao_cliente/fechar_periodo') ?>";
			});
		}
	}
