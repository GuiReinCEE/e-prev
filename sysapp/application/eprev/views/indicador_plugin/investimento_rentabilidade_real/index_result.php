...
foreach($collection as $item)
{
	...
	{
		$label_3 = str_replace("1", number_format($item["nr_valor_1"],1,",","."), $label_3);
		$label_5 = str_replace("1", number_format($item["nr_valor_1"],1,",","."), $label_5);

		$label_4 = str_replace("2", number_format($item["nr_valor_2"],1,",","."), $label_4);
		$label_6 = str_replace("2", number_format($item["nr_valor_2"],1,",","."), $label_6);
		break;
	}
}
...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/investimento_rentabilidade_real/cadastro/".$item["cd_investimento_rentabilidade_real"], "editar");
