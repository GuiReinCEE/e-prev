...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/administrativo_acao_corretiva_fora_prazo") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/administrativo_acao_corretiva_fora_prazo/excluir/".$row["cd_administrativo_acao_corretiva_fora_prazo"]) ?>';
	}
...
<?php
	...
	echo aba_start($abas);
		echo form_open('indicador_plugin/administrativo_acao_corretiva_fora_prazo/salvar');
			echo form_start_box("default_box", 'Cadastro');
				echo form_default_hidden('cd_indicador_tabela', '', $tabela[0]['cd_indicador_tabela']);
				echo form_default_hidden('cd_administrativo_acao_corretiva_fora_prazo', '', $row['cd_administrativo_acao_corretiva_fora_prazo']);
			...
			echo form_command_bar_detail_start();
				echo button_save();
				if(intval($row['cd_administrativo_acao_corretiva_fora_prazo']) > 0)
				{
