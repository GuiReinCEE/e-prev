...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/administrativo_acao_corretiva_fora_prazo/listar') ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_acao_corretiva_fora_prazo/criar_indicador') ?>", 
			function(data)
			{
				$("#div-output").html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ...");

				location.href = '<?= site_url("indicador_plugin/administrativo_acao_corretiva_fora_prazo/fechar_periodo") ?>';
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/administrativo_acao_corretiva_fora_prazo/cadastro") ?>';
	}
