...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/comunicacao_sat_canais/cadastro/" . $item["cd_comunicacao_sat_canais"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		'', 
		'', 
		'<big><b>'.app_decimal_para_php($media = number_format(($media / sizeof($media_ano)), 2)).' %</b></big>', 
