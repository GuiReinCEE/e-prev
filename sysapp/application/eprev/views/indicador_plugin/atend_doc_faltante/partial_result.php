...
else
{
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_plugin/atend_doc_faltante/detalhe/" . $item["cd_atend_doc_faltante"], "editar");
			...
			if($nr_percentual_f=='')
			{
				...
				{
					$nr_percentual_f = floatval( ( floatval($nr_valor_1)/floatval($nr_valor_2) )*100 );
					if($nr_percentual_f==0){$nr_percentual_f="0";}
					//echo $nr_percentual_f.br();
				}
				else
				{
					$nr_percentual_f = "0";
