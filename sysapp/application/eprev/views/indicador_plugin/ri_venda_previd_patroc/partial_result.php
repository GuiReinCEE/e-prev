...
else
{
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_plugin/ri_venda_previd_patroc/detalhe/" . $item["cd_ri_venda_previd_patroc"], "editar");
	...
	$body[] = array(
		...
		, '<b>'.number_format($nr_tot_ano_inscricao,0,',','.').'</b>'			
		, '<big><b>'.number_format($resultado_ano,2,',','.').'%</b></big>'
		, ''
		, ''
		, ''
	);
