...
function filtrar()
{
	...
	$.post('<?php echo site_url('indicador_plugin/ri_jogos_interativos/listar');?>',
	function(data)
	{ 
...
function novo()
{
	location.href='<?php echo site_url("indicador_plugin/ri_jogos_interativos/cadastro"); ?>';
}
...
function gerar_grafico()
{
	...
	{
		$.post('<?php echo site_url("indicador_plugin/ri_jogos_interativos/criar_indicador/"); ?>', 
		function(data)
		{ 
...
function fechar_periodo()
{
	...
	else if( confirm('Fechar o período?') )
	{
		...
		function(data)
		{
			...
			location.href = '<?php echo site_url("indicador_plugin/ri_jogos_interativos/fechar_periodo")?>';
		});
	}
}
