...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_jogos_interativos"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/ri_jogos_interativos/excluir/".$row["cd_ri_jogos_interativos"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/ri_jogos_interativos/salvar');
		echo form_start_box("default_box", $tabela[0]['ds_indicador']);
			echo form_hidden('cd_ri_jogos_interativos', intval($row['cd_ri_jogos_interativos']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_ri_jogos_interativos']) > 0)
			{
