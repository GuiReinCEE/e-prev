...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inc_foz"); ?>';
	}
...
echo form_open( 'indicador_plugin/beneficio_inc_foz/salvar' );
echo form_hidden( 'cd_beneficio_inc_foz', intval($row['cd_beneficio_inc_foz']) );
...
if( intval($row['cd_beneficio_inc_foz'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inc_foz/excluir",$row["cd_beneficio_inc_foz"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inc_foz')."'; }");
