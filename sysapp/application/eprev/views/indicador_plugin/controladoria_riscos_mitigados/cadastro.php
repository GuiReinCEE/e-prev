...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_riscos_mitigados") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/controladoria_riscos_mitigados/excluir/".$row["cd_controladoria_riscos_mitigados"]) ?>';
	}
...
?>
	...
	<?
	echo form_open('indicador_plugin/controladoria_riscos_mitigados/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_controladoria_riscos_mitigados', 'Código da tabela', intval($row['cd_controladoria_riscos_mitigados']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_controladoria_riscos_mitigados']) > 0)
			{
