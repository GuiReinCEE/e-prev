...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/exp_numero_vendas_inscricoes_ingressos") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/exp_numero_vendas_inscricoes_ingressos/excluir/".$row["cd_exp_numero_vendas_inscricoes_ingressos"]) ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/exp_numero_vendas_inscricoes_ingressos/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_exp_numero_vendas_inscricoes_ingressos', 'Código da tabela', intval($row['cd_exp_numero_vendas_inscricoes_ingressos']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_exp_numero_vendas_inscricoes_ingressos']) > 0)
			{
