...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/exp_numero_vendas_inscricoes_ingressos/listar') ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/exp_numero_vendas_inscricoes_ingressos/criar_indicador") ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?= site_url("indicador_plugin/exp_numero_vendas_inscricoes_ingressos/fechar_periodo") ?>';
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/exp_numero_vendas_inscricoes_ingressos/cadastro") ?>';
	}
