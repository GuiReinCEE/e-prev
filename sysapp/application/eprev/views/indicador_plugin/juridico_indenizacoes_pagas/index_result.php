...
$body = array();
$head = array( 
    '#', $label_0, $label_1, $label_3, $label_4, $label_5, $label_7, ''
);
...
foreach($collection as $item)
{
    ...
    {
        $link = anchor("indicador_plugin/juridico_indenizacoes_pagas/cadastro/".$item["cd_juridico_indenizacoes_pagas"], "editar");
