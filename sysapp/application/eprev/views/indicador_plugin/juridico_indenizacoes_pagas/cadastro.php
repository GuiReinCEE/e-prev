...
<script>
    ...
    function ir_lista()
    {
        location.href='<?php echo site_url("indicador_plugin/juridico_indenizacoes_pagas"); ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?php echo site_url("indicador_plugin/juridico_indenizacoes_pagas/excluir/".$row["cd_juridico_indenizacoes_pagas"]); ?>';
    }
...
echo aba_start($abas);
    echo form_open('indicador_plugin/juridico_indenizacoes_pagas/salvar');
        echo form_start_box("default_box", $tabela[0]['ds_indicador']);
            ...
            echo form_default_hidden('cd_juridico_indenizacoes_pagas', 'Código da tabela', intval($row['cd_juridico_indenizacoes_pagas']));
        ...
        echo form_command_bar_detail_start();
            echo button_save();
            if(intval($row['cd_juridico_indenizacoes_pagas']) > 0)
            {
