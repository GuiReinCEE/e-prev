...
<script>
	...
	function ir_lista()
	{
		location.href = "<?= site_url("indicador_plugin/controladoria_cobertura_benf_cd_ceran") ?>";
	}
	...
	function excluir()
	{
		location.href = "<?= site_url("indicador_plugin/controladoria_cobertura_benf_cd_ceran/excluir/".$row["cd_controladoria_cobertura_benf_cd_ceran"]) ?>";
	}
...
<? else: ?>
	<?= form_open('indicador_plugin/controladoria_cobertura_benf_cd_ceran/salvar')?>
		...
		<?= form_start_box('default_box', 'Cadastro')?>
			...
			<?= form_default_hidden('cd_controladoria_cobertura_benf_cd_ceran', 'Código da tabela', intval($row['cd_controladoria_cobertura_benf_cd_ceran']))?>
			<?= form_default_row('','','')?>
		...
		<?= form_command_bar_detail_start()?>
			<?= button_save()?>
			<?if(intval($row['cd_controladoria_cobertura_benf_cd_ceran']) > 0) ?>
