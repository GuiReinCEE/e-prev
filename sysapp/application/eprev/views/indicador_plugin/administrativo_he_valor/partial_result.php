...
$body=array();
$head = array( 
	'#', $label_0, $label_1, $label_2, $label_3, $label_4, $label_6, $label_7, ''
);
...
echo "<BR>";
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_plugin/administrativo_he_valor/detalhe/" . $item["cd_administrativo_he_valor"], "editar");
