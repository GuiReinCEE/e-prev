...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_inadimplencia_previdenciaria/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_inadimplencia_previdenciaria/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_inadimplencia_previdenciaria/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_inadimplencia_previdenciaria/cadastro") ?>';
	}
