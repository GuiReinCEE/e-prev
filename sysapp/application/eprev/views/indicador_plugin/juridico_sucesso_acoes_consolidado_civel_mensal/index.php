...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_consolidado_civel_mensal/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/juridico_sucesso_acoes_consolidado_civel_mensal/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/juridico_sucesso_acoes_consolidado_civel_mensal/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/juridico_sucesso_acoes_consolidado_civel_mensal/fechar_periodo') ?>";
			});
		}
	}
