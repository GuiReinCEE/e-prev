...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/administrativo_resul_superior/listar') ?>",
		function(data)
		{ 
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/administrativo_resul_superior/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_resul_superior/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/administrativo_resul_superior/fechar_periodo') ?>";
			});
		}
	}
