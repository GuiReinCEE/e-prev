...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/info_indisp/cadastro/') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/info_indisp/criar_indicador/') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/info_indisp/fechar_periodo') ?>";
			});
		}
	}
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/info_indisp/listar') ?>",
		function(data)
		{ 
