...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_inventario"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_inventario/salvar' );
echo form_hidden( 'cd_administrativo_inventario', intval($row['cd_administrativo_inventario']) );
...
echo form_default_hidden( 'mes_referencia', 'ano_referencia',  01 );
...
if( intval($row['cd_administrativo_inventario'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_inventario/excluir",$row["cd_administrativo_inventario"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_inventario')."'; }");
