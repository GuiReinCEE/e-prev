...
else
{
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_plugin/administrativo_inventario/detalhe/" . $item["cd_administrativo_inventario"], "editar");
		...
		$body[] = array(
			...
			, ($nr_percentual_f!='')?number_format($nr_percentual_f,2,',','.').' %':'0,00 %'
