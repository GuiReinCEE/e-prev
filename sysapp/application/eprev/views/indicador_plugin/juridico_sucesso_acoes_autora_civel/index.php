...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/juridico_sucesso_acoes_autora_civel/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/juridico_sucesso_acoes_autora_civel/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ...<BR><BR>" );

				location.href = '<?php echo site_url("indicador_plugin/juridico_sucesso_acoes_autora_civel/fechar_periodo")?>';
			});
		}
	}
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/juridico_sucesso_acoes_autora_civel/detalhe"); ?>';
	}
