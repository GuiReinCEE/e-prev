...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/administrativo_proposicao_acao_fora_prazo/cadastro/".$item["cd_administrativo_proposicao_acao_fora_prazo"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		(trim($nr_valor_1) != '' ? $nr_valor_1 : ''),
		(trim($nr_valor_2) != '' ? $nr_valor_2 : ''),
		'<big><b>'.(trim($nr_percentual_f) != '' ? number_format($nr_percentual_f, 2, ',', '.').' %' : '').' %</b></big>', 
