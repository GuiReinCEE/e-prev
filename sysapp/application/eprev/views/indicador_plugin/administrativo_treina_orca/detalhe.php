...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_treina_orca"); ?>';
	}
...
echo form_open( 'indicador_plugin/administrativo_treina_orca/salvar' );
echo form_hidden( 'cd_administrativo_treina_orca', intval($row['cd_administrativo_treina_orca']) );
...
#echo form_default_hidden('mes_referencia', 'Mês', '01');
echo form_default_integer('mes_referencia', $label_0.' - Semestre: (*)', $row, "class='indicador_text'");
echo form_default_integer('ano_referencia', $label_0.' - Ano: (*)', $row, "class='indicador_text'");
...
if( intval($row['cd_administrativo_treina_orca'])>0  )
{
	echo button_delete("indicador_plugin/administrativo_treina_orca/excluir",$row["cd_administrativo_treina_orca"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/administrativo_treina_orca')."'; }");
