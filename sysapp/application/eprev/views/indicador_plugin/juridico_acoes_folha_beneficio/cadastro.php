...
<script>
    ...
    function ir_lista()
    {
        location.href='<?php echo site_url("indicador_plugin/juridico_acoes_folha_beneficio"); ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?php echo site_url("indicador_plugin/juridico_acoes_folha_beneficio/excluir/".$row["cd_juridico_acoes_folha_beneficio"]); ?>';
    }
...
echo aba_start($abas);
    echo form_open('indicador_plugin/juridico_acoes_folha_beneficio/salvar');
        echo form_start_box("default_box", $tabela[0]['ds_indicador']);
            ...
            echo form_default_hidden('cd_juridico_acoes_folha_beneficio', 'Código da tabela', intval($row['cd_juridico_acoes_folha_beneficio']));
        ...
        echo form_command_bar_detail_start();
            echo button_save();
            if(intval($row['cd_juridico_acoes_folha_beneficio']) > 0)
            {
