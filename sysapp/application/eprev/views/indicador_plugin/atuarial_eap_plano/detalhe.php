...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atuarial_eap_plano"); ?>';
	}
...
echo form_open( 'indicador_plugin/atuarial_eap_plano/salvar' );
echo form_hidden( 'cd_atuarial_eap_plano', intval($row['cd_atuarial_eap_plano']) );
...
if( intval($row['cd_atuarial_eap_plano'])>0  )
{
	echo button_delete("indicador_plugin/atuarial_eap_plano/excluir",$row["cd_atuarial_eap_plano"]);
}
