...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inc_instituidor"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/beneficio_inc_instituidor/salvar' );
echo form_hidden( 'cd_beneficio_inc_instituidor', intval($row['cd_beneficio_inc_instituidor']) );
...
if( intval($row['cd_beneficio_inc_instituidor'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inc_instituidor/excluir",$row["cd_beneficio_inc_instituidor"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inc_instituidor')."'; }");
