...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/financeiro_originais_retificacoes_dirf/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dirf/criar_indicador") ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dirf/cadastro") ?>';
	}
