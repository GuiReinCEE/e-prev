...
<script>
	...
	function ir_lista()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dirf") ?>';
	}
	...
	function excluir()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_originais_retificacoes_dirf/excluir/".$row["cd_financeiro_originais_retificacoes_dirf"]) ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/financeiro_originais_retificacoes_dirf/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_financeiro_originais_retificacoes_dirf', 'Código da tabela', intval($row['cd_financeiro_originais_retificacoes_dirf']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_financeiro_originais_retificacoes_dirf']) > 0)
			{
