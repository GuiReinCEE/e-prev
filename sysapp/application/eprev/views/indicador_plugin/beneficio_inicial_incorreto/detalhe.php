...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inicial_incorreto"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/beneficio_inicial_incorreto/salvar' );
echo form_hidden( 'cd_beneficio_inicial_incorreto', intval($row['cd_beneficio_inicial_incorreto']) );
...
if( intval($row['cd_beneficio_inicial_incorreto'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inicial_incorreto/excluir",$row["cd_beneficio_inicial_incorreto"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inicial_incorreto')."'; }");
