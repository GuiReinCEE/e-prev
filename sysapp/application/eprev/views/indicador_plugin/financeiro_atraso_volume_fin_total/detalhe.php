...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/financeiro_atraso_volume_fin_total"); ?>';
	}
    function manutencao()
    {
...
<? endif; ?>
<?
echo form_open( 'indicador_plugin/financeiro_atraso_volume_fin_total/salvar' );
echo form_hidden( 'cd_financeiro_atraso_volume_fin_total', intval($row['cd_financeiro_atraso_volume_fin_total']) );
...
if( intval($row['cd_financeiro_atraso_volume_fin_total'])>0  )
{
	echo button_delete("indicador_plugin/financeiro_atraso_volume_fin_total/excluir",$row["cd_financeiro_atraso_volume_fin_total"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/financeiro_atraso_volume_fin_total')."'; }");
