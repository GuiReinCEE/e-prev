...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_trab_fundacao_autora/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_trab_fundacao_autora/excluir/".$row['cd_juridico_sucesso_acoes_trab_fundacao_autora']) ?>';
    }
</script>
<?php
...
<?php
        ...
        echo form_open('indicador_plugin/juridico_sucesso_acoes_trab_fundacao_autora/salvar');
        echo form_start_box('cadastro_box', 'Cadastro');
            echo form_default_hidden('cd_juridico_sucesso_acoes_trab_fundacao_autora', '', $row);
        ...
        echo button_save();
        if(intval($row['cd_juridico_sucesso_acoes_trab_fundacao_autora']) > 0) : 
