...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/juridico_num_sol_par_gere/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/juridico_num_sol_par_gere/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?php echo site_url("indicador_plugin/juridico_num_sol_par_gere/fechar_periodo")?>';
			});
		}
	}
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/juridico_num_sol_par_gere/detalhe"); ?>';
	}
