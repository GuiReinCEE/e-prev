...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_pg_30dias"); ?>';
	}
    function manutencao()
    {
...
<? endif; ?>
<?
echo form_open( 'indicador_plugin/beneficio_pg_30dias/salvar' );
echo form_hidden( 'cd_beneficio_pg_30dias', intval($row['cd_beneficio_pg_30dias']) );
...
if( intval($row['cd_beneficio_pg_30dias'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_pg_30dias/excluir",$row["cd_beneficio_pg_30dias"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_pg_30dias')."'; }");
