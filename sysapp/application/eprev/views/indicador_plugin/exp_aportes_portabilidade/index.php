...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/exp_aportes_portabilidade/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/exp_aportes_portabilidade/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/exp_aportes_portabilidade/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/exp_aportes_portabilidade/listar') ?>",
		function(data)
		{ 
