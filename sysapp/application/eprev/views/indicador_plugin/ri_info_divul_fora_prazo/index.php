...
<script>
	...
	function load()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/ri_info_divul_fora_prazo/listar');?>',
			{},
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/ri_info_divul_fora_prazo/criar_indicador/"); ?>',
				{
				},
				function(data)
				{
					$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
					location.href = '<?php echo site_url("indicador_plugin/ri_info_divul_fora_prazo/fechar_periodo")?>';
				});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_info_divul_fora_prazo/detalhe/0"); ?>';
	}
