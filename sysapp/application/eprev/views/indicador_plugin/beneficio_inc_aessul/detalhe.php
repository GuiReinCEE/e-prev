...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/beneficio_inc_aessul"); ?>';
	}
...
echo form_open( 'indicador_plugin/beneficio_inc_aessul/salvar' );
echo form_hidden( 'cd_beneficio_inc_aessul', intval($row['cd_beneficio_inc_aessul']) );
...
if( intval($row['cd_beneficio_inc_aessul'])>0  )
{
	echo button_delete("indicador_plugin/beneficio_inc_aessul/excluir",$row["cd_beneficio_inc_aessul"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/beneficio_inc_aessul')."'; }");
