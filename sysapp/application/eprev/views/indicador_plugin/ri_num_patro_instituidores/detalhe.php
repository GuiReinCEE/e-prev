...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_num_patro_instituidores"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/ri_num_patro_instituidores/salvar' );
echo form_hidden( 'cd_ri_num_patro_instituidores', intval($row['cd_ri_num_patro_instituidores']) );
...
if( intval($row['cd_ri_num_patro_instituidores'])>0  )
{
	echo button_delete("indicador_plugin/ri_num_patro_instituidores/excluir",$row["cd_ri_num_patro_instituidores"]);
}
