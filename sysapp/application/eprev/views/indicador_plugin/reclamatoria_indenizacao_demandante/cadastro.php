...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/reclamatoria_indenizacao_demandante"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_plugin/reclamatoria_indenizacao_demandante/excluir/".$row["cd_reclamatoria_indenizacao_demandante"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_plugin/reclamatoria_indenizacao_demandante/salvar');
		echo form_start_box("default_box", 'Cadastro');
			...
			echo form_default_hidden('cd_reclamatoria_indenizacao_demandante', 'Código da tabela', intval($row['cd_reclamatoria_indenizacao_demandante']));
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_reclamatoria_indenizacao_demandante']) > 0)
			{
