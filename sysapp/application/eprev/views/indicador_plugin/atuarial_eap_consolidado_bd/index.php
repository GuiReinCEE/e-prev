...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/atuarial_eap_consolidado_bd/listar') ?>',
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atuarial_eap_consolidado_bd/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/atuarial_eap_consolidado_bd/fechar_periodo') ?>";
			});
		}
	}	
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/atuarial_eap_consolidado_bd/cadastro") ?>';
	}
