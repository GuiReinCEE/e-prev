...
<script>
	function cadastro()
	{
		location.href='<?php echo site_url("indicador_plugin/administrativo_absenteismo/detalhe"); ?>';
	}
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/administrativo_absenteismo/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_absenteismo/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if( confirm('Fechar o período?') )
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/administrativo_absenteismo/fechar_periodo') ?>";
			});
		}
	}
