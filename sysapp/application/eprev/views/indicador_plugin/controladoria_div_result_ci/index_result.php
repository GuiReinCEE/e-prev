...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/controladoria_div_result_ci/cadastro/" . $item["cd_controladoria_div_result_ci"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		number_format(($nr_meta_media / sizeof($media_ano)), 2, ",", "."), 
		'', 
		''
	);
}
