...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_sat_fun_revista"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/ri_sat_fun_revista/salvar' );
echo form_hidden( 'cd_ri_sat_fun_revista', intval($row['cd_ri_sat_fun_revista']) );
...
if( intval($row['cd_ri_sat_fun_revista'])>0  )
{
	echo button_delete("indicador_plugin/ri_sat_fun_revista/excluir",$row["cd_ri_sat_fun_revista"]);
}
