...
<script>
    ...
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_trab_cons_inst/index") ?>';
    }
    ...
    function excluir()
    {
        location.href = '<?= site_url("indicador_plugin/juridico_sucesso_acoes_trab_cons_inst/excluir/".$row['cd_juridico_sucesso_acoes_trab_cons_inst']) ?>';
    }
    ...
    function getValores()
	{
		if(($("#mes_referencia").val() != "") && ($("#ano_referencia").val() != ""))
		{
			...
			$.post('<?php echo site_url("indicador_plugin/juridico_sucesso_acoes_trab_cons_inst/get_valores"); ?>', 
			{
...
<?php
        ...
        echo form_open('indicador_plugin/juridico_sucesso_acoes_trab_cons_inst/salvar');
        echo form_start_box('cadastro_box', 'Cadastro');
            echo form_default_hidden('cd_juridico_sucesso_acoes_trab_cons_inst', '', $row);
        ...
        if(intval($row['cd_juridico_sucesso_acoes_trab_cons_inst']) > 0) : 
