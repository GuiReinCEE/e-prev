...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/financeiro_saldo_medio_contas_correntes/cadastro/".$item["cd_financeiro_saldo_medio_contas_correntes"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		'<big><b>'.(trim($nr_valor_2_total) != '' ? number_format(($nr_valor_1_total/$nr_valor_2_total) , 2, ',', '.') : '').' </b></big>', 
