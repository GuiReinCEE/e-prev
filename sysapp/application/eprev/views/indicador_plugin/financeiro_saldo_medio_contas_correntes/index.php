...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/financeiro_saldo_medio_contas_correntes/listar') ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/financeiro_saldo_medio_contas_correntes/criar_indicador") ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?= site_url("indicador_plugin/financeiro_saldo_medio_contas_correntes/fechar_periodo") ?>';
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_saldo_medio_contas_correntes/cadastro") ?>';
	}
