...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/financeiro_deb_participantes"); ?>';
	}
    function manutencao()
    {
...
echo form_open( 'indicador_plugin/financeiro_deb_participantes/salvar' );
echo form_hidden( 'cd_financeiro_deb_participantes', intval($row['cd_financeiro_deb_participantes']) );
...
if( intval($row['cd_financeiro_deb_participantes'])>0  )
{
	echo button_delete("indicador_plugin/financeiro_deb_participantes/excluir",$row["cd_financeiro_deb_participantes"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/financeiro_deb_participantes')."'; }");
