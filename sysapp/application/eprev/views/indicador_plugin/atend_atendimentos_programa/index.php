...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/atend_atendimentos_programa/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/atend_atendimentos_programa/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/atend_atendimentos_programa/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/atend_atendimentos_programa/listar') ?>",
		function(data)
		{ 
