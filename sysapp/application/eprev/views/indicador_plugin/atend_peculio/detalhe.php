...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_peculio"); ?>';
	}
...
echo form_open( 'indicador_plugin/atend_peculio/salvar' );
echo form_hidden( 'cd_atend_peculio', intval($row['cd_atend_peculio']) );
...
if( intval($row['cd_atend_peculio'])>0  )
{
	echo button_delete("indicador_plugin/atend_peculio/excluir",$row["cd_atend_peculio"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_plugin/atend_peculio')."'; }");
