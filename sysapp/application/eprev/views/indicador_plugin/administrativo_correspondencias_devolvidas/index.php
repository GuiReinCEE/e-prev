...
<script>
    ...
    function cadastro()
    {
        location.href = '<?= site_url("indicador_plugin/administrativo_correspondencias_devolvidas/cadastro") ?>';
    }
    ...
    function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/administrativo_correspondencias_devolvidas/listar') ?>",
		function(data)
		{ 
    ...
    function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/administrativo_correspondencias_devolvidas/criar_indicador') ?>", 
			function(data)
			{ 
    ...
    function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/administrativo_correspondencias_devolvidas/fechar_periodo') ?>";
			});
		}
	}
