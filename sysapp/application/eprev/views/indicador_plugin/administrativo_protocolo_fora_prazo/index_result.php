...
foreach($collection as $item)
{
	...
	{
		$link = anchor("indicador_plugin/administrativo_protocolo_fora_prazo/cadastro/".$item["cd_administrativo_protocolo_fora_prazo"], "editar");
...
if(sizeof($media_ano) >0)
{
	...
	$body[] = array(
		...
		'<big><b>'.(trim($nr_valor_1_total) != '' ? number_format(($nr_valor_2_total/$nr_valor_1_total) * 100, 2, ',', '.').' %' : '').' </b></big>', 
