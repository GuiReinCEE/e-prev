...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_plugin/info_backup/cadastro/') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/info_backup/criar_indicador/') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_plugin/info_backup/fechar_periodo') ?>";
			});
		}
	}
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/info_backup/listar/') ?>",
		function(data)
		{ 
