...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url("indicador_plugin/exp_adesao_potencial_senge/listar") ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url("indicador_plugin/exp_adesao_potencial_senge/criar_indicador") ?>", 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = "<?= site_url("indicador_plugin/exp_adesao_potencial_senge/cadastro") ?>";
	}
