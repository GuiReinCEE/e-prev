...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_plugin/financeiro_nr_ingressos_pagamento/listar') ?>",
		function(data)
		{ 
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_plugin/financeiro_nr_ingressos_pagamento/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_plugin/financeiro_nr_ingressos_pagamento/fechar_periodo') ?>";
			});
		}
	}
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/financeiro_nr_ingressos_pagamento/cadastro") ?>';
	}
