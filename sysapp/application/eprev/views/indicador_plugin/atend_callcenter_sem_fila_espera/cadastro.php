...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_callcenter_sem_fila_espera"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_plugin/atend_callcenter_sem_fila_espera/excluir/".$row['cd_atend_callcenter_sem_fila_espera']); ?>';
		}
	}	
</script>
<?php
...
echo form_open('indicador_plugin/atend_callcenter_sem_fila_espera/salvar');
	echo form_start_box("default_box", "Cadastro");
		echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
		echo form_default_hidden('cd_atend_callcenter_sem_fila_espera', 'Código da tabela', intval($row['cd_atend_callcenter_sem_fila_espera']));
		...
		echo form_default_integer("nr_ligacao_sem_fila", $label_1.": (*)", intval($row['nr_ligacao_sem_fila']), "class='indicador_text'");
		echo form_default_integer("nr_ligacao_atendida", $label_2.": (*)", intval($row['nr_ligacao_atendida']), "class='indicador_text'");
	...
	echo form_command_bar_detail_start();
		...
		if( intval($row['cd_atend_callcenter_sem_fila_espera'])>0  )
		{
