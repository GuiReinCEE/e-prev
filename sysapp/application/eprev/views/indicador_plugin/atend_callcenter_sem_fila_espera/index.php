...
<script>
	...
	function load()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/atend_callcenter_sem_fila_espera/listar');?>',
			{},
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/atend_callcenter_sem_fila_espera/criar_indicador/"); ?>',
				{
				},
				function(data)
				{
					$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
					location.href = '<?php echo site_url("indicador_plugin/atend_callcenter_sem_fila_espera/fechar_periodo")?>';
				});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/atend_callcenter_sem_fila_espera/cadastro/0"); ?>';
	}
