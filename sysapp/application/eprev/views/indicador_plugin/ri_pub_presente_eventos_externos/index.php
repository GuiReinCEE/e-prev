...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_plugin/ri_pub_presente_eventos_externos/listar');?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_plugin/ri_pub_presente_eventos_externos/criar_indicador/"); ?>',
			function(data)
			{
				$('#div-output').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );

				location.href = '<?php echo site_url("indicador_plugin/ri_pub_presente_eventos_externos/fechar_periodo")?>';
			});
		}
	}
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_plugin/ri_pub_presente_eventos_externos/cadastro"); ?>';
	}
