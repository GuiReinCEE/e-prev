...
<script>
	function filtrar()
	{
		...
		$.post('<?= site_url('indicador_plugin/exp_adesao_potencial_familia/listar') ?>',
		function(data)
		{ 
	...
	function gerar_graficos()
	{
		...
		{
			$.post('<?= site_url("indicador_plugin/exp_adesao_potencial_familia/criar_indicador") ?>', 
			function(data)
			{ 
	...
	function novo()
	{
		location.href = '<?= site_url("indicador_plugin/exp_adesao_potencial_familia/cadastro") ?>';
	}
