<?php
set_title('Súmulas do Conselho Fiscal - Acompanhamento');
...
{
	location.href='<?php echo site_url("gestao/sumula_conselho_fiscal/responsabilidade/".$cd_sumula_conselho_fiscal); ?>';
}
...
function load()
{
	...
	$.post( '<?php echo site_url('gestao/sumula_conselho_fiscal/listar_acompanhamento'); ?>/',
	{
...
function excluir(cd_sumula_conselho_fiscal_acompanhamento)
{
	...
	{
		location.href='<?php echo site_url("gestao/sumula_conselho_fiscal/excluir_acompanhamento/".$cd_sumula_conselho_fiscal); ?>/' + cd_sumula_acompanhamento_conselho;
	}
}
...
echo aba_start( $abas );
	echo form_open('gestao/sumula_conselho_fiscal/salvar_acompanhamento', 'name="filter_bar_form"');
		echo form_start_box( "default_box", "Cadastro" );
			...
			echo form_default_dropdown('cd_sumula_item', 'Item :', $arr_item);
