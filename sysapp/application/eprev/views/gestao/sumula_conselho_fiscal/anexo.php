<?php
set_title('Súmulas do Conselho Fiscal - Anexo');
...
{
	location.href='<?php echo site_url("gestao/sumula_conselho_fiscal/resposta/".$row['cd_sumula_conselho_fiscal_item']); ?>';
}
...
function listar()
{
	...
	$.post( '<?php echo site_url('gestao/sumula_conselho_fiscal/listar_anexo'); ?>/',
	{
		cd_sumula_conselho_fiscal_item : $('#cd_sumula_conselho_fiscal_item').val()
	},
	function(data)
	{
...
function excluir_anexo(cd_sumula_conselho_fiscal_item_anexo)
{
	if(confirm("ATENÇÃO\n\nDeseja excluir?\n\n"))
	{
		location.href='<?php echo site_url("gestao/sumula_conselho_fiscal/excluir_anexo/".$row['cd_sumula_conselho_fiscal_item']); ?>' + "/" + cd_sumula_conselho_fiscal_item_anexo;
	}
}
...
echo aba_start( $abas );
	echo form_open('gestao/sumula_conselho_fiscal/salvar_anexo', 'name="filter_bar_form"');
		...
		if(trim($row['dt_resposta']) == '')
		{
			echo form_start_box( "default_box", "Anexo" );
				echo form_default_upload_multiplo('arquivo_m', 'Arquivo :*', 'sumula_conselho_fiscal', 'validaArq');
