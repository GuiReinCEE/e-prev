...
{
	location.href='<?php echo site_url("gestao/sumula_conselho/responsabilidade/".$cd_sumula_conselho); ?>';
}
...
function load()
{
	...
	$.post( '<?php echo site_url('gestao/sumula_conselho/listar_acompanhamento'); ?>/',
	{
...
function excluir(cd_sumula_conselho_acompanhamento)
{
	...
	{
		location.href='<?php echo site_url("gestao/sumula_conselho/excluir_acompanhamento/".$cd_sumula_conselho); ?>/' + cd_sumula_acompanhamento_conselho;
	}
}
...
echo aba_start( $abas );
	echo form_open('gestao/sumula_conselho/salvar_acompanhamento', 'name="filter_bar_form"');
