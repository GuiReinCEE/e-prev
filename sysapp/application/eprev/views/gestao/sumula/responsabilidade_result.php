...
{
    $editar = anchor('gestao/sumula/responsabilidade/'.$item['cd_sumula'].'/'.$item['cd_sumula_item'], '[editar]');
    $excluir = '<a href="javascript:void(0);" onclick="excluir('.$item['cd_sumula_item'].')">[excluir]</a>';
    $enviar = '<a href="javascript:void(0);" onclick="enviar('.$item['cd_sumula_item'].')">[enviar]</a>';
    ...
    $checkbox = array(
      'name'  => 'check_'.$item['cd_sumula_item'],
      'id'    => 'check_'.$item['cd_sumula_item'],
      'value' => $item['cd_sumula_item'],
    );
