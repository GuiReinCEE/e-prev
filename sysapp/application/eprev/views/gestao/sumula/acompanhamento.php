...
{
	location.href='<?php echo site_url("gestao/sumula/responsabilidade/".$cd_sumula); ?>';
}

function ir_cadastro()
{
	location.href='<?php echo site_url("gestao/sumula/cadastro/".$cd_sumula); ?>';
}
...
function load()
{
	...
	$.post( '<?php echo site_url('gestao/sumula/listar_acompanhamento'); ?>/',
	{
...
function excluir(cd_sumula_acompanhamento)
{
	...
	{
		location.href='<?php echo site_url("gestao/sumula/excluir_acompanhamento/".$cd_sumula); ?>/' + cd_sumula_acompanhamento;
	}
}
...
echo aba_start( $abas );
	echo form_open('gestao/sumula/salvar_acompanhamento', 'name="filter_bar_form"');
