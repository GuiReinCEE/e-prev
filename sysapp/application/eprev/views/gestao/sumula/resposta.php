...
?>
	...
	function ir_anexo()
	{
		location.href='<?php echo site_url("gestao/sumula/anexo"); ?>/' + $('#cd_sumula_item').val();
	}
	
	function mudar_responsavel()
	{
		if($('#cd_responsavel').val() != '' && $('#cd_responsavel').val() != $('#cd_responsavel_p').val())
		{
			location.href='<?php echo site_url("gestao/sumula/mudar_responsavel/".intval($row['cd_sumula_item'])); ?>/'+$('#cd_responsavel').val();
		}
		else
		{
...
echo aba_start( $abas );
    echo form_open('gestao/sumula/salvar_resposta', 'name="filter_bar_form"');
