<?php
set_title('Súmulas - Responder Itens');
...
function load()
{
    ...
    $.post( '<?php echo base_url() . index_page(); ?>/gestao/sumula/minhas_listar',
    {
...
function novo()
{
    location.href='<?php echo site_url("gestao/sumula/cadastro/"); ?>';
}
...
echo aba_start( $abas );
    ...
    echo form_start_box_filter();
        ...
        echo filter_integer('nr_sumula', 'Súmula :');
