...
<?php
	...
	$abas[] = array('aba_nc', 'Ação Preventiva', FALSE, 'ir_cadastro();');
	$abas[] = array('aba_lista', 'Acompanhamento', FALSE, 'ir_acompanhamento();');
	$abas[] = array('aba_lista', 'Prorrogação', FALSE, 'ir_prorrogacao();');
	...
	echo aba_start($abas);
   		echo form_start_box('default_box', 'Cadastro');
   			echo form_default_row('', 'Número:', '<span class="label label-inverse">'.$row['numero_cad_ap'].'</span>');
   			echo form_default_row('', 'Processo:', $row['procedimento']);
   			echo form_default_row('', 'Gerência:', $row['gerencia']);
   			echo form_default_row('', 'Responsável:', $row['nome_usuario']);
   			echo form_default_row('', 'Substituto:', $row['nome_substituto']);
   			echo form_default_row('', 'Dt. Cadastro:', $row['dt_inclusao']);
			echo form_default_row('', 'Usuário:', $row['usuario_cadastro']);
