...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('gestao/relatorio_avaliacao_pga/listar') ?>",
	...
	function novo()
	{
		location.href = "<?= site_url('gestao/relatorio_avaliacao_pga/cadastro') ?>";
	}
...
<?php
	...
	$config['button'][] = array('Novo Trimestre', 'novo();');
