<?php
set_title('Plano Fiscal - Indicadores PGA - Diretoria');
...
?>
    ...
    {
        location.href='<?php echo site_url("gestao/plano_fiscal_indicador/cadastro/".$row['cd_plano_fiscal_indicador']); ?>';
    }
...
echo aba_start( $abas );
    echo form_open('gestao/plano_fiscal_indicador/salvar_limite_diretoria', 'name="filter_bar_form_cadastro"');
