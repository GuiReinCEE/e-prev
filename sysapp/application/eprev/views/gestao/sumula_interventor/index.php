<?php
set_title('Súmulas Interventor - Lista');
...
function filtrar()
{
    ...
    $.post( '<?php echo base_url() . index_page(); ?>/gestao/sumula_interventor/listar',
...
echo aba_start( $abas );
    echo ((gerencia_in(array('SG'))) ? form_list_command_bar($config) : form_list_command_bar());
    echo form_start_box_filter();
        echo filter_integer('nr_sumula_interventor', 'Nº da súmula :');
