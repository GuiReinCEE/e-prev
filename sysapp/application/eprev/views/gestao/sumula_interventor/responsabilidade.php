<?php
set_title('Súmulas Interventor - Responsabilidades');
...
echo aba_start( $abas );
	echo form_open('gestao/sumula_interventor/salvar_item', 'name="filter_bar_form"');
        echo form_start_box( 'default_box', 'Cadastro' );
            ...
            echo form_default_integer('nr_sumula_interventor', 'Súmula :', $row['nr_sumula_interventor'], "style='width:100%;border: 0px; font-weight:bold;' readonly");
			echo form_default_gerencia('cd_gerencia', 'Gerência :* ', $row_item['cd_gerencia'], 'onchange="set_gerencia_responsaveis(this.value)"');
            echo form_default_integer('nr_sumula_interventor_item', 'Número do Item da Súmula :*', $row_item['nr_sumula_interventor_item']);
