<?php
set_title('Súmulas Interventor - Resposta');
...
?>
	...
	function ir_anexo()
	{
		location.href='<?php echo site_url("gestao/sumula_interventor/anexo"); ?>/' + $('#cd_sumula_interventor_item').val();
	}
	...
	function mudar_responsavel()
	{
		...
		{
			location.href='<?php echo site_url("gestao/sumula_interventor/mudar_responsavel/".intval($row['cd_sumula_interventor_item'])); ?>/'+$('#cd_responsavel').val();
		}
		else
		{
...
echo aba_start( $abas );
    echo form_open('gestao/sumula_interventor/salvar_resposta', 'name="filter_bar_form"');
