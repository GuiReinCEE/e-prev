<?
	set_title('Planejamento Estratégico - Objetivos');
    ...
    echo aba_start($abas);
        ...
        echo form_open('gestao/planejamento_estrategico/salvar_objetivo');
            echo form_start_box('default_box', 'Objetivo');
                ...
                echo form_default_text('ds_planejamento_estrategico_objetivo', 'Descrição: (*)', $row['ds_planejamento_estrategico_objetivo'], 'style="width:450px;"');
            echo form_end_box('default_box');
