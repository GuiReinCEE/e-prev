...
<script>
	...
	function ir_lista()
    {
        location.href = "<?= site_url('gestao/manual_gestao/index') ?>";
    }
    ...
    function enviar()
    {
        ...
        { 
            location.href = "<?= site_url('gestao/manual_gestao/enviar/'.$row['cd_manual_gestao']) ?>";
        }
    }
</script>
<?php
	...
	echo aba_start($abas);
		echo form_open('gestao/manual_gestao/salvar');
			echo form_start_box('default_box', 'Cadastro');
				echo form_default_hidden('cd_manual_gestao', '', $row['cd_manual_gestao']);
				echo form_default_date('dt_referencia', 'Dt. Aprovação: (*)', $row['dt_referencia']);
		        echo form_default_upload_iframe('arquivo', 'manual_gestao', 'Arquivo: (*)', array($row['arquivo'], $row['arquivo_nome']), 'manual_gestao', true);
