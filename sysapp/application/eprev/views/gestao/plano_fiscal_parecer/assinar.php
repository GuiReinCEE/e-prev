<?php
set_title('Plano Fiscal - Parecer - Diretoria Assinar');
$this->load->view('header');
?>
<script>
<?php
    echo form_default_js_submit(Array('cd_plano_fiscal_parecer', 'cd_diretoria'));
?>
    function ir_lista()
    {
        location.href='<?php echo site_url("gestao/plano_fiscal_parecer/diretoria_assinar"); ?>';
    }
</script>
...
echo aba_start( $abas );
    echo form_open('gestao/plano_fiscal_parecer/salvar_diretoria_assinar', 'name="filter_bar_form_cadastro"');
		...
		echo form_start_box("default_pdf_box", "PDF");
			echo '<center><iframe id="iframeParecer" height="600px;" width="100%;"  style="height:500px width:600px;" src="'.site_url("gestao/plano_fiscal_parecer/imprimirPDF/".$row['cd_plano_fiscal_parecer']).'"></iframe></center>';
