<?php
set_title('Ação Preventiva Auditor');
...
?>
    ...
    function ir_lista()
    {
            location.href='<?php echo site_url("gestao/acao_preventiva_auditor"); ?>';
    }
</script>
<?php
...
echo aba_start( $abas );
    echo form_open('gestao/acao_preventiva_auditor/salvar', 'name="filter_bar_form"');
