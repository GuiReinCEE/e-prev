    		...
    		echo form_start_box('default_anexo_box', 'Anexo');
              //if(count($fluxo) == 0)
                ...
                else
                {
                    ...
                    echo form_default_text('codigo', 'Código: (*)', $fluxo['codigo'], 'style="width:400px;"');
                    echo form_default_text('ds_processos_fluxo_anexo', 'Descrição: (*)', $fluxo['ds_processos_fluxo_anexo'], 'style="width:400px;"');
