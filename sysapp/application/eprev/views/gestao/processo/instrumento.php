    	...
    	echo form_open('gestao/processo/salvar_instrumento');
    		...
    		echo form_start_box('default_anexo_box', 'Anexo');
                ...
                else
                {
                    ...
                    echo form_default_text('codigo', 'Código: (*)', $instrumento['codigo'], 'style="width:400px;"');
                    echo form_default_text('ds_processos_instrumento_trabalho_anexo', 'Descrição: (*)', $instrumento['ds_processos_instrumento_trabalho_anexo'], 'style="width:400px;"');
                }
