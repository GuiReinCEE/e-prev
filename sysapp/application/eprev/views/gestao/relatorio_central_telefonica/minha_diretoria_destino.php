...
function load()
{
	...
	$.post( '<?php echo base_url() . index_page(); ?>/gestao/relatorio_central_telefonica/minhaDiretoriaDestino'
		,{
			dt_ini : $('#dt_ini').val(),
			dt_fim : $('#dt_fim').val(),
...
function relMinhaDiretoria()
{
	location.href='<?php echo site_url("gestao/relatorio_central_telefonica/minha_diretoria"); ?>';
}
...
<?php
	...
	$abas[] = array('aba_lista', 'Ramais', FALSE, 'relMinhaDiretoria();');
