...
function load()
{
	...
	$.post( '<?php echo base_url() . index_page(); ?>/gestao/relatorio_central_telefonica/minhaGerenciaResumo'
		,{
			dt_ini : $('#dt_ini').val(),
			dt_fim : $('#dt_fim').val(),
...
function relMinhaGerenciaDestino()
{
	location.href='<?php echo site_url("gestao/relatorio_central_telefonica/minha_gerencia_destino"); ?>';
}
</script>
...
<?php
	...
	$abas[] = array('aba_lista', 'Destinos', FALSE, 'relMinhaGerenciaDestino();');
