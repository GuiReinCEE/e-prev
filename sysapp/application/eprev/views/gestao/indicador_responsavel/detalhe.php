...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("gestao/indicador_responsavel"); ?>';
	}
</script>
<?php
...
echo form_open('gestao/indicador_responsavel/salvar');
...
{
	echo button_delete("gestao/indicador_responsavel/excluir",$row["cd_indicador_administrador"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('gestao/indicador_responsavel')."'; }");
