<?php
set_title('Reunião Sistema de Gestão - Indicador');
...
<?php
    ...
    echo aba_start($abas);
        echo form_open('gestao/reuniao_sistema_gestao/indicador_salvar');
            echo form_start_box('default_box', 'Cadastro');			
                ...
                echo form_default_checkbox_group('indicador_checked', 'Indicador:', $indicador, $indicador_check, 300, 500, "", TRUE);
