<?php
set_title('Consulta - Cenário Legal');
...
<?php
	...
	echo aba_start($abas);
	    ...
	    echo form_start_box_filter(); 
	        echo filter_text('tit_capa', 'Título:','', 'style="width:310px;"');
	        echo filter_text('titulo', 'Cenário:','', 'style="width:310px;"');
	        echo filter_text('referencia', 'Referência:','', 'style="width:310px;"');
