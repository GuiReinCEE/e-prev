...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("gestao/gestao_aviso/aviso_diretoria"); ?>';
	}
	...
	echo aba_start($abas);
		echo form_open('gestao/gestao_aviso/salvar');
			echo form_start_box("default_box", "Cadastro");
				...
				echo form_default_hidden('cd_periodicidade', '', $row['cd_periodicidade']);
				echo form_default_hidden('fl_diretoria', '', 'S');
