...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador/grupo"); ?>';
	}
</script>
<?php
...
echo form_open('indicador/grupo/salvar');
...
{
	echo button_delete("indicador/grupo/excluir",$row["cd_indicador_grupo"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador/grupo')."'; }");
