...
function load()
{
	...
	$.post( '<?php echo base_url() . index_page(); ?>/indicador/grupo/listar',{    },function(data){ $("#result_div").html(data);configure_result_table(); } );
}
...
function novo()
{
	location.href='<?php echo site_url("indicador/grupo/detalhe/0"); ?>';
}
