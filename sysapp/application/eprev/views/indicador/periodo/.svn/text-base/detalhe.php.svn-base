...
,array("dt_fim", "date") 
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador/periodo"); ?>';
	}
</script>
<?php
...
echo form_open('indicador/periodo/salvar');
...
{
	echo button_delete("indicador/periodo/excluir",$row["cd_indicador_periodo"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador/periodo')."'; }");
