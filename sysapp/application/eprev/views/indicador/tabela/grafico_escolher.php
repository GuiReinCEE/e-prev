...
<script>
	...
	function salvar()
	{
		...
		{
			alert('Escolha um tipo de gráfico antes de salvar.');
		...
		if( selecionado=='pizza' )
		{
			...
			{
				alert('Informe a série de células que correspondem as legendas que serão exibidas no gráfico.');
		...
		if( selecionado=='linha' )
		{
			...
			{
				alert('Informe a série de células que correspondem aos rótulos que serão exibidos no gráfico.');
				$('#ds_range_tick').focus();
				return false;
			}
		}
		...
		{
			alert('Informe a série de células que correspondem aos valores que serão exibidos no gráfico.');
	...
	/* FACILITADORES PARA ESCOLHA DAS SÉRIES DE CÉLULAS */
	var textbox_sel='';
...
<tr><td>
	...
	<tr>
	<td valign='top'>
		<?php echo form_start_box('grafico_box', 'Escolha o tipo de gráfico', false); ?>
	...
	<td valign='top'>
		<?
		echo 
			form_start_box('conf_box_2', 'Configure os Parâmetros para o gráfico',true,true,'style="display:none;"')

			.form_default_row( '', 'Série para Legendas', " <input id='cel_1_leg' type='text' style='width:30px;' onfocus='mudar_textbox(this)' /> <input id='cel_2_leg' type='text' style='width:30px;' onfocus='mudar_textbox(this)' /> ".comando("add_legenda_btn", "ADD", "adicionar_celula_legenda();") )
			.form_default_text( 'ds_range_legenda_2', '', '', "style='width:300px;'" )

			.form_default_row( '', 'Série para Rótulos', " <input id='cel_1_tick' type='text' style='width:30px;' onfocus='mudar_textbox(this)' /> <input id='cel_2_tick' type='text' style='width:30px;' onfocus='mudar_textbox(this)' /> ".comando("add_legenda_btn", "ADD", "adicionar_celula_tick();") )
			.form_default_text( 'ds_range_tick_2', '', '', "style='width:300px;'" )

			.form_default_row( '', 'Série para Valores', " <input id='cel_1_val' type='text' style='width:30px;' onfocus='mudar_textbox(this)' /> <input id='cel_2_val' type='text' style='width:30px;' onfocus='mudar_textbox(this)' /> ".comando("add_legenda_btn", "ADD", "adicionar_celula_valor();") )
		...
		echo 
			form_start_box('conf_box', 'Configure os Parâmetros para o gráfico',true,true)
			.form_default_text( 'ds_range_legenda', 'Série de Células para Legenda (C,C,L,L;C,C,L,L)', '', "style='width:300px;'" )
			.form_default_text( 'ds_range_tick', 'Série de Células para Rótulos (C,C,L,L)', '', "style='width:300px;'" )
			.form_default_textarea( 'ds_range_valor', 'Séries de Células para Valores (C,C,L,L;C,C,L,L)', '', "style='width:300px;'" )
...
<tr><td>
	...
	<?php 
	echo 
		form_start_box('visualizar_tabela_box', 'Visualização da Tabela', false,true)
		.form_end_box('visualizar_tabela_box', false)
		;
	echo 
		form_start_box('visualizar_box', 'Visualização do Gráfico', false)
