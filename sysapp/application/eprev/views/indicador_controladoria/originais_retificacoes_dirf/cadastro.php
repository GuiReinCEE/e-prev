...
<script>
	<?php 
	echo form_default_js_submit(array("ano_referencia", "cd_indicador_tabela", "nr_original", "nr_retificacao_1", "nr_retificacao_2", "nr_retificacao_3", "nr_retificacao_4", "nr_retificacao_5", "nr_meta"),'_salvar(form)');	?>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_controladoria/originais_retificacoes_dirf"); ?>';
	}
	...
	function excluir()
	{
		location.href = '<?php echo site_url("indicador_controladoria/originais_retificacoes_dirf/excluir/".$row["cd_originais_retificacoes_dirf"]); ?>';
	}
...
echo aba_start($abas);
	echo form_open('indicador_controladoria/originais_retificacoes_dirf/salvar');
		echo form_start_box("default_box", 'Cadastro');
			echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
			echo form_default_hidden('cd_originais_retificacoes_dirf', 'Código da tabela', intval($row['cd_originais_retificacoes_dirf']));
			...
			echo form_default_integer('ano_referencia', $label_0.' :*', $row['dt_referencia']);
		...
		echo form_command_bar_detail_start();
			...
			if(intval($row['cd_originais_retificacoes_dirf']) > 0)
			{
