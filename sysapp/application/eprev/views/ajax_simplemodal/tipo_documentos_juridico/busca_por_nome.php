<script>
	...
	{
		$("#grid_tipo_documentos_juridico_<?php echo($id); ?>").html("<?php echo loader_html(); ?>");
		$.post("<?php echo site_url('ajax/tipo_documentos_juridico/form_busca_por_nome_post'); ?>",
			{
			...
			function(data)
			{
				$("#grid_tipo_documentos_juridico_<?php echo($id); ?>").html(data);
			});
	}
...
<style>
.resultado_busca_tipo_documentos_juridico{
	height:250px;
	text-align:center;	
}
</style>
...
echo br();
echo '<div class="resultado_busca_tipo_documentos_juridico" id="grid_tipo_documentos_juridico_'.$id.'"></div>';
?>