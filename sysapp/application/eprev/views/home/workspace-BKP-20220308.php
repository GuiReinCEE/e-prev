...
<map name="map">
    <area shape="rect" coords="50,80,360,126" href="https://www.e-prev.com.br/cieprev/up/irpf/IRPF2021Win32v1.0.exe" title="Download do programa">
    ...
    <tr>
        ...
        <td valign="top" class="work_gestao">
            <ul>
                ...
                <li>
                    <a href="<?= base_url('up/par.pdf') ?>" target="_blank">Norma e Manual do Processo de Apuração de Responsabilidades</a>
                </li>	
                <!--			
                ...
                <li>
                    <a href="https://fprev.com.br/sa?!=hml" target="_blank">S.A. (Interact) - HOMOLOGAÇÃO</a>
                </li>
            </ul>
        ...
        <td valign="top" class="work_intranet">
            ...
            <ul>
                ...
                <li><a href="#" onclick="document.getElementById('IR2017').style.display='';">Declaração do IRPF 2021</a> <!--<img src="<?php echo base_url(); ?>skins/skin002/img/workspace/pending.gif" border="0"></li>-->
        ...
        <td valign="top" class="work_internet">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <ul>
                            <li><a href="https://www.fundacaoceee.com.br/unico_aessul/" target="_blank">Plano Único RGE SUL</a></li>
                            <li><a href="https://www.fundacaoceee.com.br/unico_ceee/" target="_blank">Plano Único CEEE</a></li>
                            <li><a href="https://www.fundacaoceee.com.br/unico_rge/" target="_blank">Plano Único RGE</a></li>
