...
<map name="map">
    <area shape="rect" coords="50,80,360,126" href="https://www.e-prev.com.br/cieprev/up/irpf/IRPF2024Win64v1.0.exe" title="Download do programa">
    ...
    <tr>
        ...
        <td valign="top" class="work_gestao">
            <ul>
                ...
                <li>
                    <a href="<?= site_url('gestao/controle_igp/apresentacao') ?>" target="_blank">Indicadores PE</a>
        ...
        <td valign="top" class="work_intranet">
            ...
            <ul>
                ...
                <li><a href="#" onclick="document.getElementById('IR2017').style.display='';">Declaração do IRPF 2023</a> <!--<img src="<?php echo base_url(); ?>skins/skin002/img/workspace/pending.gif" border="0"></li>-->
                ...
                <tr>
                    <td valign="top">
                        <ul>
                            ...
                            <li><a href="<?php echo site_url("ecrm/intranet/pagina/GNR"); ?>">GNR</a></li>
                        </ul>
                    </td>
                    <td valign="top">
                        <ul>
                    ...
                    <td valign="top">
                        <ul>
							<li><a href="<?php echo site_url("ecrm/intranet/pagina/GS"); ?>">GS</a></li>	
                ...
                <tr>
                    <td valign="top">
                        <ul>
                            ...
                            <li><a href="<?php echo site_url("cadastro/equipe/index/GNR"); ?>">GNR</a></li>
                        </ul>
                    </td>
                    <td valign="top">
                        <ul>	
                    ...
                    <td valign="top">
                        <ul>
							<li><a href="<?php echo site_url("cadastro/equipe/index/GS"); ?>">GS</a></li>
