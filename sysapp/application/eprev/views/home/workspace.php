...
<map name="map">
    <area shape="rect" coords="50,80,360,126" href="https://www.e-prev.com.br/cieprev/up/irpf/IRPF2025Win64v1.0.exe" title="Download do programa">
    ...
    <tr>
        ...
        <td valign="top" class="work_intranet">
            ...
            <ul>
                ...
                <li><a href="#" onclick="document.getElementById('IR2017').style.display='';">Declaração do IRPF 2024</a> <!--<img src="<?php echo base_url(); ?>skins/skin002/img/workspace/pending.gif" border="0"></li>-->
