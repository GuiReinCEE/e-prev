...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_poder/equilibrio_atu_plano"); ?>';
	}
...
echo form_open( 'indicador_poder/equilibrio_atu_plano/salvar' );
echo form_hidden( 'cd_equilibrio_atu_plano', intval($row['cd_equilibrio_atu_plano']) );
...
echo form_default_numeric("nr_valor_1", $label_1, app_decimal_para_php($row['nr_valor_1']), "class='indicador_text'"); 
echo form_default_numeric("nr_valor_2", $label_2, app_decimal_para_php($row['nr_valor_2']), "class='indicador_text'"); 
...
if( intval($row['cd_equilibrio_atu_plano'])>0  )
{
	echo button_delete("indicador_poder/equilibrio_atu_plano/excluir",$row["cd_equilibrio_atu_plano"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_poder/equilibrio_atu_plano')."'; }");
