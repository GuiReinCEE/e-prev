...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_poder/custo_est_operacional"); ?>';
	}
...
echo form_open( 'indicador_poder/custo_est_operacional/salvar' );
echo form_hidden( 'cd_custo_est_operacional', intval($row['cd_custo_est_operacional']) );
...
if( intval($row['cd_custo_est_operacional'])>0  )
{
	echo button_delete("indicador_poder/custo_est_operacional/excluir",$row["cd_custo_est_operacional"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_poder/custo_est_operacional')."'; }");
