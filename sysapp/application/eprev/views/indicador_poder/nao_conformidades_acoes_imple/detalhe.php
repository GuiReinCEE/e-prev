...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_poder/nao_conformidades_acoes_imple"); ?>';
	}
...
echo form_open( 'indicador_poder/nao_conformidades_acoes_imple/salvar' );
echo form_hidden( 'cd_nao_conformidades_acoes_imple', intval($row['cd_nao_conformidades_acoes_imple']) );
...
if( intval($row['cd_nao_conformidades_acoes_imple'])>0  )
{
	echo button_delete("indicador_poder/nao_conformidades_acoes_imple/excluir",$row["cd_nao_conformidades_acoes_imple"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_poder/nao_conformidades_acoes_imple')."'; }");
