...
echo form_open('igp/satisfacao_partic/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_satisfacao_partic', 'Código da tabela', intval($row['cd_satisfacao_partic']));
		...
		echo form_default_numeric("nr_satisfacao", $label_1.": (*)", number_format($row['nr_satisfacao'],2,',','.'), "class='indicador_text'");
