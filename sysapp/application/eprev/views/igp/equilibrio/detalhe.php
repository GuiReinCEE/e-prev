...
echo form_open('igp/equilibrio/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_equilibrio', 'Código da tabela', intval($row['cd_equilibrio']));
		...
		echo form_default_numeric("nr_tecnica", $label_1.": (*)", number_format($row['nr_tecnica'],2,',','.'), "class='indicador_text'");
		echo form_default_numeric("nr_matematica", $label_2.": (*)", number_format($row['nr_matematica'],2,',','.'), "class='indicador_text'");
		echo form_default_numeric("nr_meta", $label_4.": (*)", number_format($row['nr_meta'],2,',','.'), "class='indicador_text'");
		echo form_default_numeric("nr_peso", $label_5.": (*)", number_format($row['nr_peso'],2,',','.'), "class='indicador_text'");
