...
<script>
	...
	function load()
	{
		...
		{
			alert("Quantidade mínima de meses é 12");
			$("#qt_limit").focus();
		}
	}	
...
echo form_start_box("default_box", "Cadastro");
	...
	echo form_default_integer('qt_limit', "Qt de meses (mínimo 12):*", 12);
	echo form_default_row("","","");
	echo form_default_row("","",button_save('Filtrar', 'filtrar()') . button_save('Atualizar apresentação', 'gerar_graficos()','botao_disabled'));
