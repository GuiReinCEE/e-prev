...
echo form_open('igp/reclamacao/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_reclamacao', 'Código da tabela', intval($row['cd_reclamacao']));
		...
		echo form_default_integer("nr_total", $label_1.": (*)", number_format($row['nr_total'],0,'',''), "class='indicador_text'");
		echo form_default_integer("nr_reclamacao", $label_2.": (*)", number_format($row['nr_reclamacao'],0,'',''), "class='indicador_text'");
