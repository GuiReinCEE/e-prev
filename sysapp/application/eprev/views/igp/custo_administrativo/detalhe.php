...
echo form_open('igp/custo_administrativo/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_custo_administrativo', 'Código da tabela', intval($row['cd_custo_administrativo']));
		...
		echo form_default_numeric("nr_despesa", $label_1.": (*)", number_format($row['nr_despesa'],2,',','.'), "class='indicador_text'");
		echo form_default_numeric("nr_contribuicao", $label_2.": (*)", number_format($row['nr_contribuicao'],2,',','.'), "class='indicador_text'");
