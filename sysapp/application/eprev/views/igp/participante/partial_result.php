...
$body=array();
$head = array( 
	$label_0, $label_6, $label_2, $label_13, $label_14, $label_3, $label_4, 
	$label_5, $label_7, $label_8, $label_9, $label_10, ''
);
...
foreach($collection as $item)
{
	...
	$body[] = array(
		$item['mes_referencia'],
		number_format($item['nr_participante'],0,',','.'),
		//." [ ".$item['nr_patrocinado']." | ".$item['nr_instituidor']." | ".$item['nr_participante_semestre']." ]",
		number_format($item['nr_meta'],0,',','.'),
		number_format($item['nr_meta_ano_anterior'],0,',','.'),
		...
		number_format($item['nr_media_movel'],0,',','.'),
		number_format($item['nr_media_referencia_mes'],2,',','.'),
		($item['fl_editar'] == "S" ? anchor("igp/participante/detalhe/".$item["cd_participante"], "editar") : "")
	);
}
