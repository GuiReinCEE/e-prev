...
echo form_open('igp/avaliacao/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_avaliacao', 'Código da tabela', intval($row['cd_avaliacao']));
		...
		echo form_default_numeric("nr_ponto", $label_1.": (*)", number_format($row['nr_ponto'],2,',','.'), "class='indicador_text'");
