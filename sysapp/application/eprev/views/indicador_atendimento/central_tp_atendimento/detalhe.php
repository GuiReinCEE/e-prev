...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_atendimento/central_tp_atendimento"); ?>';
	}
...
echo form_open( 'indicador_atendimento/central_tp_atendimento/salvar' );
echo form_hidden( 'cd_central_tp_atendimento', intval($row['cd_central_tp_atendimento']) );
...
if( intval($row['cd_central_tp_atendimento'])>0  )
{
	echo button_delete("indicador_atendimento/central_tp_atendimento/excluir",$row["cd_central_tp_atendimento"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_atendimento/central_tp_atendimento')."'; }");
