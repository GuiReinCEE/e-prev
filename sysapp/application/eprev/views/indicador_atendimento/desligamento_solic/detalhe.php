...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_atendimento/desligamento_solic"); ?>';
	}
...
echo form_open( 'indicador_atendimento/desligamento_solic/salvar' );
echo form_hidden( 'cd_desligamento_solic', intval($row['cd_desligamento_solic']) );
...
echo form_default_integer("nr_valor_3", $label_3.': (*)', intval($row['nr_valor_3']), "class='indicador_text'");
echo form_default_integer("nr_valor_4", $label_4.': (*)', intval($row['nr_valor_4']), "class='indicador_text'");
echo form_default_integer("nr_valor_5", $label_5.': (*)', intval($row['nr_valor_5']), "class='indicador_text'");
echo form_default_integer("nr_valor_6", $label_6.': (*)', intval($row['nr_valor_6']), "class='indicador_text'");
echo form_default_integer("nr_valor_7", $label_7.': (*)', intval($row['nr_valor_7']), "class='indicador_text'");
echo form_default_integer("nr_valor_8", $label_8.': (*)', intval($row['nr_valor_8']), "class='indicador_text'");
echo form_default_integer("nr_valor_9", $label_9.': (*)', intval($row['nr_valor_9']), "class='indicador_text'");
echo form_default_integer("nr_valor_10", $label_10.': (*)', intval($row['nr_valor_10']), "class='indicador_text'");
echo form_default_integer("nr_valor_11", $label_11.': (*)', intval($row['nr_valor_11']), "class='indicador_text'");
...
if( intval($row['cd_desligamento_solic'])>0  )
{
	echo button_delete("indicador_atendimento/desligamento_solic/excluir",$row["cd_desligamento_solic"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_atendimento/desligamento_solic')."'; }");
