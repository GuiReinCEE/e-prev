...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_atendimento/central_quantidade"); ?>';
	}
...
echo form_open( 'indicador_atendimento/central_quantidade/salvar' );
echo form_hidden( 'cd_central_quantidade', intval($row['cd_central_quantidade']) );
...
if( intval($row['cd_central_quantidade'])>0  )
{
	echo button_delete("indicador_atendimento/central_quantidade/excluir",$row["cd_central_quantidade"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_atendimento/central_quantidade')."'; }");
