...
$body=array();
$head = array( 
	'#', $label_0, $label_1, $label_3, $label_2, ''
);
...
else
{
	...
	foreach( $collection as $item )
	{
		...
		{
			$link = anchor("indicador_atendimento/tele_transf/detalhe/" . $item["cd_tele_transf"], "editar");
    ...
    if( sizeof($media_ano)>0 )
	{
		...
		$body[] = array(
			...
			, '<big><b>'.number_format($soma,0,',','.').'</b></big>'
            , number_format($soma_tl,0,',','.')
			, ''
            , ''
		);
	}
