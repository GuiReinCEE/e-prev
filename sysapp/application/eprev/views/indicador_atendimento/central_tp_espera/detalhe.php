...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("indicador_atendimento/central_tp_espera"); ?>';
	}
...
echo form_open( 'indicador_atendimento/central_tp_espera/salvar' );
echo form_hidden( 'cd_central_tp_espera', intval($row['cd_central_tp_espera']) );
...
if( intval($row['cd_central_tp_espera'])>0  )
{
	echo button_delete("indicador_atendimento/central_tp_espera/excluir",$row["cd_central_tp_espera"]);
}

echo form_command_bar_detail_button("Voltar para lista", "if( confirm('Voltar?') ){ location.href='".site_url('indicador_atendimento/central_tp_espera')."'; }");
