...
foreach( $collection as $item )
{
	...
	{
		$link = anchor("indicador_pga/taxa_administracao_consolidada/cadastro/".$item["cd_taxa_administracao_consolidada"], "editar");
...
if(intval($contador_ano_atual) > 0)
{
	$body[] = array(
		...
		'<b>'.number_format(($ultimo_mes_1 / $ultimo_mes_2)*100,2,',','.').'%</b>',
