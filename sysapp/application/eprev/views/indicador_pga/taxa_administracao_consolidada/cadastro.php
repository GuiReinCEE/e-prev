...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_pga/taxa_administracao_consolidada"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_pga/taxa_administracao_consolidada/excluir/".$row["cd_taxa_administracao_consolidada"]); ?>';
		}
	}
...
echo form_open('indicador_pga/taxa_administracao_consolidada/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_taxa_administracao_consolidada', 'Código da tabela', intval($row['cd_taxa_administracao_consolidada']));
	...
	echo form_command_bar_detail_start();
		...
		if(intval($row['cd_taxa_administracao_consolidada']) > 0)
		{
			echo button_save('Excluir', 'excluir('.$row["cd_taxa_administracao_consolidada"].');', 'botao_vermelho');
		}
