...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_pga/limite_taxa_adm/listar') ?>",
		function(data)
		{ 
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_pga/limite_taxa_adm/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_pga/limite_taxa_adm/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_pga/limite_taxa_adm/fechar_periodo') ?>";
			});
		}
	}
