...
<script>
    ...
    function ir_lista()
	{
		location.href = "<?= site_url('indicador_pga/despesa_ativo_total') ?>";
	}
	...
	function excluir()
	{
		...
		{
			location.href = "<?= site_url('indicador_pga/despesa_ativo_total/excluir/'.$row['cd_despesa_ativo_total']) ?>";
		}
	}
...
<? else: ?>
	...
	<?= form_open('indicador_pga/despesa_ativo_total/salvar') ?>
		...
		<?= form_start_box('default_box', 'Cadastro') ?>
			...
			<?= form_default_hidden('cd_despesa_ativo_total', '', intval($row['cd_despesa_ativo_total'])) ?>
		...
		<?= form_command_bar_detail_start() ?>
			...
			<? if(intval($row['cd_despesa_ativo_total']) > 0): ?>	
