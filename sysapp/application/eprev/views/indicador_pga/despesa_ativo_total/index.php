...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_pga/despesa_ativo_total/listar') ?>",
		function(data)
		{ 
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_pga/despesa_ativo_total/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_pga/despesa_ativo_total/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_pga/despesa_ativo_total/fechar_periodo') ?>";
			});
		}
	}
