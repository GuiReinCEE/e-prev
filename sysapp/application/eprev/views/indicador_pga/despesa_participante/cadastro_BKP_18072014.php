...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_pga/despesa_participante"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_pga/despesa_participante/excluir/".$row["cd_despesa_participante"]); ?>';
		}
	}
...
echo form_open('indicador_pga/despesa_participante/salvar');
	echo form_start_box("default_box", "Cadastro");
		echo form_default_hidden('cd_indicador_tabela', 'Código indicador tabela', $tabela[0]['cd_indicador_tabela']);
		echo form_default_hidden('cd_despesa_participante', 'Código da tabela', intval($row['cd_despesa_participante']));
	...
	echo form_command_bar_detail_start();
		...
		{
			echo button_save('Excluir', 'excluir('.$row["cd_despesa_participante"].');', 'botao_vermelho');
		}
