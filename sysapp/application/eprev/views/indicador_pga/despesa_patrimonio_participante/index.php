...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_pga/despesa_patrimonio_participante/listar') ?>",
		function(data)
		{ 
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_pga/despesa_patrimonio_participante/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_pga/despesa_patrimonio_participante/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data){
				...
				location.href = "<?= site_url('indicador_pga/despesa_patrimonio_participante/fechar_periodo') ?>";
			});
		}
	}
