...
foreach($collection as $key => $item)
{
	...
	else
	{
		...
		$link = anchor('indicador_pga/despesa_patrimonio_participante/cadastro/'.$item['cd_despesa_patrimonio_participante'], '[editar]');
	}
	...
	$body[] = array(
		...
		number_format($item['nr_valor_3'], 2, ',', '.'),
...
if($contador_ano_atual > 0)
{
	$body[] = array(
		...
		'<b>'.number_format($nr_valor_3, 2, ',', '.').'</b>',
