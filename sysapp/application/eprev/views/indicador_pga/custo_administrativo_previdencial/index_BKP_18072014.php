...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_pga/custo_administrativo_previdencial/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_pga/custo_administrativo_previdencial/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
				location.href = '<?php echo site_url("indicador_pga/custo_administrativo_previdencial/fechar_periodo")?>';
			});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_pga/custo_administrativo_previdencial/cadastro"); ?>';
	}
