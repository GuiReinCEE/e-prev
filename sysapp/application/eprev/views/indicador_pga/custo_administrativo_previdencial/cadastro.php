...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_pga/custo_administrativo_previdencial"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_pga/custo_administrativo_previdencial/excluir/".$row["cd_custo_administrativo_previdencial"]); ?>';
		}
	}
...
echo form_open('indicador_pga/custo_administrativo_previdencial/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_custo_administrativo_previdencial', 'Código da tabela', intval($row['cd_custo_administrativo_previdencial']));
	...
	echo form_command_bar_detail_start();
		...
		if(intval($row['cd_custo_administrativo_previdencial']) > 0)
		{
