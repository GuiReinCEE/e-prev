...
foreach( $collection as $item )
{
	...
	{
		$link = anchor("indicador_pga/custo_administrativo_previdencial/cadastro/".$item["cd_custo_administrativo_previdencial"], "editar");
...
if(intval($contador_ano_atual) > 0)
{
	$body[] = array(
		...
		'<b>'.number_format($total_1 / $total_2,2,',','.').'%</b>',
