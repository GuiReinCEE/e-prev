...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_pga/despesa_sobre_receita"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_pga/despesa_sobre_receita/excluir/".$row["cd_despesa_sobre_receita"]); ?>';
		}
	}
...
echo form_open('indicador_pga/despesa_sobre_receita/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_despesa_sobre_receita', 'Código da tabela', intval($row['cd_despesa_sobre_receita']));
	...
	echo form_command_bar_detail_start();
		...
		if(intval($row['cd_despesa_sobre_receita']) > 0)
		{
			echo button_save('Excluir', 'excluir('.$row["cd_despesa_sobre_receita"].');', 'botao_vermelho');
		}
