...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_pga/despesa_pessoa_sobre_total/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_pga/despesa_pessoa_sobre_total/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
				location.href = '<?php echo site_url("indicador_pga/despesa_pessoa_sobre_total/fechar_periodo")?>';
			});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_pga/despesa_pessoa_sobre_total/cadastro"); ?>';
	}
