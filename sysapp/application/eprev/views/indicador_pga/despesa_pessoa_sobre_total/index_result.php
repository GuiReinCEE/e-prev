...
$body=array();
$head = array( 
	"#",$label_0, $label_1, $label_2, $label_7, $label_8, $label_3, $label_4, $label_5, ''
);
...
foreach( $collection as $item )
{
	...
	{
		$link = anchor("indicador_pga/despesa_pessoa_sobre_total/cadastro/".$item["cd_despesa_pessoa_sobre_total"], "editar");
	...
	$body[] = array(
		...
		number_format($item['nr_valor_1_acum'],2,',','.'),
		number_format($item['nr_valor_2_acum'],2,',','.'),
...
if(intval($contador_ano_atual) > 0)
{
	...
	$body[] = array(
		...
		'<b>'.number_format($ultimo_mes_1_acum,2,',','.').'</b>',
		'<b>'.number_format($ultimo_mes_2_acum,2,',','.').'</b>',
