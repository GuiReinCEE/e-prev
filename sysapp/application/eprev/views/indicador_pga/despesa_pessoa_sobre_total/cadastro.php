...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_pga/despesa_pessoa_sobre_total"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_pga/despesa_pessoa_sobre_total/excluir/".$row["cd_despesa_pessoa_sobre_total"]); ?>';
		}
	}
...
echo form_open('indicador_pga/despesa_pessoa_sobre_total/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_hidden('cd_despesa_pessoa_sobre_total', 'Código da tabela', intval($row['cd_despesa_pessoa_sobre_total']));
	...
	echo form_command_bar_detail_start();
		...
		if(intval($row['cd_despesa_pessoa_sobre_total']) > 0)
		{
			echo button_save('Excluir', 'excluir('.$row["cd_despesa_pessoa_sobre_total"].');', 'botao_vermelho');
		}
