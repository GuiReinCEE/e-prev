...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_pga/variacao_orcamentaria/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_pga/variacao_orcamentaria/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
				location.href = '<?php echo site_url("indicador_pga/variacao_orcamentaria/fechar_periodo")?>';
			});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_pga/variacao_orcamentaria/cadastro"); ?>';
	}
