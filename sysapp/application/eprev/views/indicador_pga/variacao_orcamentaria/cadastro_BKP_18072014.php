...
<script>
    ...
    function ir_lista()
	{
		location.href='<?php echo site_url("indicador_pga/variacao_orcamentaria"); ?>';
	}
	...
	function excluir()
	{
		...
		{
			location.href='<?php echo site_url("indicador_pga/variacao_orcamentaria/excluir/".$row["cd_variacao_orcamentaria"]); ?>';
		}
	}
...
echo form_open('indicador_pga/variacao_orcamentaria/salvar');
	echo form_start_box("default_box", "Cadastro");
		...
		echo form_default_numeric("nr_meta_min", $label_4.": (*)", number_format($row['nr_meta_min'],2,',','.'), "class='indicador_text'");
		echo form_default_numeric("nr_meta_max", $label_5.": (*)", number_format($row['nr_meta_max'],2,',','.'), "class='indicador_text'");
	...
	echo form_command_bar_detail_start();
		...
		{
			echo button_save('Excluir', 'excluir('.$row["cd_variacao_orcamentaria"].');', 'botao_vermelho');
		}
