...
<script>
	function filtrar()
	{
		...
		$.post('<?php echo site_url('indicador_pga/evolucao_fundo_adm/listar'); ?>',
		function(data)
		{ 
	...
	function fechar_periodo()
	{
		...
		{
			$.post('<?php echo site_url("indicador_pga/evolucao_fundo_adm/criar_indicador/"); ?>',
			function(data)
			{
				$('#output_tela').html("Indicadores atualizados com sucesso, aguarde enquanto o período é fechado ..." );
				location.href = '<?php echo site_url("indicador_pga/evolucao_fundo_adm/fechar_periodo")?>';
			});
		}
	}	
	...
	function novo()
	{
		location.href='<?php echo site_url("indicador_pga/evolucao_fundo_adm/cadastro"); ?>';
	}
