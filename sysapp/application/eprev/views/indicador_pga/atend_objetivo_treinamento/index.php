...
<script>
	...
	function novo()
	{
		location.href = "<?= site_url('indicador_pga/atend_objetivo_treinamento/cadastro') ?>";
	}
	...
	function atualizar_grafico()
	{
		...
		{
			$.post("<?= site_url('indicador_pga/atend_objetivo_treinamento/criar_indicador') ?>", 
			function(data)
			{ 
	...
	function fechar_periodo()
	{
		...
		else if(confirm("Fechar o período?"))
		{
			...
			function(data)
			{
				...
				location.href = "<?= site_url('indicador_pga/atend_objetivo_treinamento/fechar_periodo') ?>";
			});
		}
	}	
	...
	function filtrar()
	{
		...
		$.post("<?= site_url('indicador_pga/atend_objetivo_treinamento/listar') ?>",
		function(data)
		{ 
