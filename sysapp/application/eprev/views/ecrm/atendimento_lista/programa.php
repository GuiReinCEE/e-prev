...
function load()
{
	...
	$.post( '<?php echo base_url() . index_page(); ?>/ecrm/atendimento_lista/listar_programa'
		,{
...
function configure_result_table()
{
	...
	[
		'CaseInsensitiveString','Number','Number'
	]);
...
$abas[] = array('aba_lista', 'Programa', TRUE, 'location.reload();');
