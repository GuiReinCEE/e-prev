<?php
	set_title('Reclamações e Sugestões - Retorno');
	...
	echo aba_start($abas);
		...
		echo form_open('ecrm/reclamacao/salvar_retorno');
			echo form_start_box('default_box', 'Cadastro');
				...
				echo form_default_textarea('ds_observacao_retorno', 'Descrição do Retorno:', $retorno_atendimento['ds_observacao_retorno'], 'style="width:500px; height: 100px;"');
