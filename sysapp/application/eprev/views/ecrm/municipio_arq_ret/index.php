...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('ecrm/municipio_arq_ret/listar') ?>",
	...
	function excluir(cd_municipio_arq_ret)
	{
		var confirmacao = 
		...
		{
			location.href = "<?= site_url('ecrm/municipio_arq_ret/excluir') ?>/" + cd_municipio_arq_ret;
		}
}
</script>
<?php
