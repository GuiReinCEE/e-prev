<?php
set_title('Relatório de Autoatendimento');
...
<script>
    function gerarPDF()
	{
		...
		filter_bar_form.action = '<?php echo site_url("/ecrm/relatorio_autoatendimento/gerarPDF"); ?>';
...
echo aba_start( $abas );
echo form_start_box( "default_box", 'Relatório de Autoatendimento' );
    ...
    echo filter_date_interval('dt_ini', 'dt_fim', 'Período:', '01/'.date('m/Y'), date('d/m/Y'), FALSE);
    echo '</form>';
