<?php
set_title('Sites Institucionais - Histórico Home');
...
<script>
	...
	function load()
	{
		...
		$.post('<?php echo site_url("ecrm/site/historicoListar"); ?>', 
	...
	{
		location.href='<?php echo site_url("ecrm/site/detalhe/".intval($cd_site)."/".intval($cd_versao)); ?>';
	}	
