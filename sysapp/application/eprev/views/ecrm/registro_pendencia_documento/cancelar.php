...
<script>
    ...
    {
        location.href = "<?= site_url('ecrm/registro_pendencia_documento/cadastro/'.intval($row['cd_registro_pendencia_documento'])) ?>";
    }
	...
	function enviar()
	{
        ...
        { 
			location.href = "<?= site_url('ecrm/registro_pendencia_documento/enviar/'.intval($row['cd_registro_pendencia_documento'])) ?>/"+$("#fl_enviar_email").val();
		}
	}
</script>
...
<?php
	...
	echo aba_start($abas);
		echo form_open('ecrm/registro_pendencia_documento/cancelar');
