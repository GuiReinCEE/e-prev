<?php
$head = array('Obs Digitalização', 'Caminho LIQUID', 'RE','Nome', 'Documento', 'Processo - Ano', 'Dt Cadastro', 'Observação', 'Descartar', 'Páginas', 'Arquivo', '', 'Usuário');
$body = array();
...
foreach ($collection as $item)
{
    ...
    $body[] = array(
		...
		(($item['cd_usuario_cadastro'] == usuario_id() AND $item['dt_envio'] == '') ? comando('editar_button', 'Editar', 'editar_documento(' . $item['cd_documento_protocolo_item'] . ')')
