...
<script>
    function filtrar()
	{
		...
		$.post("<?= site_url('ecrm/documento_protocolo_conf_gerencia/listar_documentos') ?>",
...
<?php
    ...
    echo aba_start($abas);
        ...
        echo form_start_box_filter('filter_bar', 'Filtros', TRUE);
        	echo filter_hidden('cd_documento_protocolo_conf_gerencia_item_mes', '', $cd_documento_protocolo_conf_gerencia_item_mes);
