...
<h1 style='font-family: Calibri, Arial; font-size: 17pt; color:red;'>
	Participantes sem Email
</h1>
<table border="0" align="center" cellspacing="20">
	<tr style="height: 30px;">
		<td>
			<input type="button" value="Enviar lista para Cadastro (GCM)" onclick="enviarEmailCadastro();" class="btn btn-primary btn-small" style="width: 200px;">
		</td>		
	</tr>
</table>
<?php
...
foreach($ar_lista as $item)
{
	$body[] = array(
		...
		($item["tp_opcao"] == "C" ? 'CORREIO' : ($item["forma_pagamento"] == "BDL" ? '<span class="label label-important">ELETRONICO</span>' : 'ELETRONICO')),
