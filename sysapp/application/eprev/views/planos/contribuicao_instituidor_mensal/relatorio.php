<?php
	set_title('Contribuição instituidor - Relatório Contribuição Mensal');
...
<script>
	...
	function load()
	{
		if(($("#cd_plano_empresa").val() != "") && ($("#cd_plano").val() != "") && ($("#nr_mes").val() != "") && ($("#nr_ano").val() != ""))
		{
			...
			$.post('<?php echo base_url() . index_page(); ?>/planos/contribuicao_instituidor_mensal/relatorioListar',
				{
	...
	function envia_email_retorno()
	{
		if(($("#cd_plano_empresa").val() != "") && ($("#cd_plano").val() != "") && ($("#nr_mes").val() != "") && ($("#nr_ano").val() != ""))
		{
			location.href='<?php echo site_url("planos/contribuicao_instituidor_mensal/envia_email_retorno"); ?>/'+$("#cd_plano").val()+'/'+$("#cd_plano_empresa").val()+'/'+$("#nr_ano").val()+'/'+$("#nr_mes").val();
		}
		else
		{
			alert("Informe os campos com (*) e clique em filtrar");
	...
	function ir_mensal()
	{
		location.href='<?php echo site_url("planos/contribuicao_instituidor_mensal"); ?>';
	}
</script>
<?php
	$abas[] = array('aba_lista', 'Contribuição Mensal', FALSE, 'ir_mensal();');
