<?php
set_title('Família Previdência - Usuário - Cadastro');
...
<?php
	...
	echo form_start_box( "default_box", "Usuário" );
		...
		$ar_tp_usuario = Array(Array('text' => 'Selecione', 'value' => ''),Array('text' => 'Fundação CEEE', 'value' => 'F'),Array('text' => 'AFCEEE', 'value' => 'A')) ;
		echo form_default_dropdown('tp_usuario', 'Tipo:*', $ar_tp_usuario, Array($row['tp_usuario']));			

		$ar_fl_troca_senha = Array(Array('text' => 'Selecione', 'value' => ''),Array('text' => 'Sim', 'value' => 'S'),Array('text' => 'Não', 'value' => 'N')) ;
		...
		echo form_default_text('funcao', "Função: ", $row, "style='width: 100%;'");
