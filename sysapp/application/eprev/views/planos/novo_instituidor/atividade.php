...
<script>
    ...
    {
        location.href = "<?= site_url('planos/novo_instituidor/instituidor_cadastro/'.$row['cd_novo_instituidor']) ?>";
    }
...
<?php   
    ...
    foreach($collection as $item)
    {
        $body[] = array(
            ...
            array($item['ds_novo_instituidor_atividade'], 'text-align:left'),
    ...
    echo aba_start($abas);
        echo form_start_box('default_box', 'Cadastro');
            ...
            echo form_default_row('ds_nome_instituidor', 'Nome:', $row['ds_nome_instituidor'], 'style="width:300px;"');
