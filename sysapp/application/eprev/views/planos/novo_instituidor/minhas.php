<?php
    set_title('Operacionalização de Novo Instituidor - Minhas');
...
<script>
    function filtrar()
    {
        ...
        $.post("<?= site_url('planos/novo_instituidor/minhas_listar') ?>",
...
<?php   
    ...
    echo form_list_command_bar(array());
    	echo form_start_box_filter(); 
            echo filter_dropdown('cd_novo_instituidor', 'Instituidor:', $instituidor);
