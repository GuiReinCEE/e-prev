...
foreach( $collection as $item )
{
	...
	$body[] = array(
		anchor("planos/ceeeprev_precadastro/acompanhamento/".$item["cd_ceeeprev_precadastro"], $item["cd_ceeeprev_precadastro"]),
		array(anchor("planos/ceeeprev_precadastro/acompanhamento/".$item["cd_ceeeprev_precadastro"],$item["nome"]), "text-align:left;"),
