...
<script>
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("planos/senge_precadastro"); ?>';
	}
	
	function excluir(cd_senge_precadastro_acompanhamento)
	{
		if(confirm("Deseja excluir o acompanhamento"))
		{
			location.href='<?php echo site_url("planos/senge_precadastro/excluir_acompanhamento/".intval($row['cd_senge_precadastro'])); ?>/'+cd_senge_precadastro_acompanhamento;
		}
	}
...
echo aba_start( $abas );
	echo form_open('planos/senge_precadastro/salvar_acompanhamento');
	echo form_start_box( "default_box", "Pré-Cadastro" );
		echo form_default_hidden('cd_senge_precadastro', "", $row['cd_senge_precadastro']);		
