...
<html lang="pt">
	<head>
	    <meta charset="utf-8">
	    <title>Campanha - Senge Previdência</title>
	</head>
	<body>
				...
				<table style="border:none; text-align:center; width:700px; background-color:#F5F4F5;">
					<tr>
			            ...
			            <td style="text-align:right; width:250px;">
			            	<img src="https://www.fcprev.com.br/temp/resources/images/campanha_aumento_contrib_inst/LOGO-SENGE.png" alt="Logo SENGE Previdência"/>
			            </td>
			        </tr>
			        <tr>
