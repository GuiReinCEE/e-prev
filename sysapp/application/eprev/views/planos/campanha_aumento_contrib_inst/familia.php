...
<html lang="pt">
	<head>
	    <meta charset="utf-8">
	    <title>Campanha - Família Previdência</title>
	</head>
	<body>
				...
				<table style="border:none; text-align:center; width:700px; background-color:#F5F4F5;">
					<tr>
			            ...
			            <td style="text-align:right; width:250px;">
			            	<img src="https://www.fcprev.com.br/temp/resources/images/campanha_aumento_contrib_inst/LOGO-FAMILIA.png" alt="Logo Família Previdência"/>
			            </td>
			        </tr>
			        <tr>
					...
					<tr>
			            <td style="text-align:center; background-color:#EBE816" colspan="2">
			            	<span style="font-family:'Century Gothic','Gill Sans MT', Arial, Helvetica; font-weight: bold; color:#606060; font-size: 20px;">
		                        Aproveite! <b><a href="https://www.fundacaofamiliaprevidencia.com.br/auto_atendimento_contrib_proga.php?_p=<?=trim($cripto_re)?>&_valor=<?=$row['SIMULA_CONTRIB_NOVO_C3']['vl_valor'] ?>" style="font-weight: bold;">CLIQUE AQUI</a></b> para aumentar sua contribuição<br/>e investir mais no seu futuro.<br/>
