...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('cadastro/formulario_periodo_experiencia/listar') ?>",
	...
	function novo()
	{
		location.href = "<?= site_url('cadastro/formulario_periodo_experiencia/cadastro') ?>";
	}
...
<?php
	...
	echo aba_start($abas);
		...
		echo form_start_box_filter(); 
			echo filter_dropdown('cd_usuario_avaliador', 'Avaliador:', $avaliador);
