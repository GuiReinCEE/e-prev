...
?>
    ...
    {
        location.href='<?php echo site_url("cadastro/projeto/detalhe/".$codigo); ?>';
    }
    ...
    function excluir_envolvido(cd_envolvido)
    {
        ...
        {
           location.href='<?php echo site_url("cadastro/projeto/excluir_envolvido/".$codigo); ?>/'+ cd_envolvido;
        }
...
echo aba_start($abas);
     echo form_open('cadastro/projeto/salvar_envolvido');
