...
function filtrar()
{
	...
	$.post('<?php echo site_url('/cadastro/avaliacao_responsabilidade/listar_escala');?>',
	{
...
function excluir(cd_escala)
{
	if(confirm("ATENÇÃO\n\nDeseja excluir?\n\n"))
	{
		$.post('<?php echo site_url('/cadastro/avaliacao_responsabilidade/excluir_escala');?>',
		{
			cd_escala : cd_escala
		},
		function(data)
...
function novo()
{
	location.href='<?php echo site_url("cadastro/avaliacao_responsabilidade/cadastro_escala"); ?>';
}
