...
?>
    ...
    function excluir()
    {
        ...
        {
           location.href='<?php echo site_url("cadastro/sistema/excluir/".$row['codigo']); ?>';
        }
    ...
    function excluir_envolvido(cd_envolvido)
    {
        ...
        if(confirm(confirmacao))
        {
           location.href='<?php echo site_url("cadastro/sistema/excluir_envolvido/".$row['codigo']); ?>/'+ cd_envolvido;
        }
    ...
    {
        location.href='<?php echo site_url("cadastro/sistema/adicionar_pessoas/".$row['codigo']); ?>';
    }
...
echo aba_start($abas);
    echo form_open('cadastro/sistema/salvar');
        echo form_start_box("default_box", "Cadastro de Sistemas");
            ...
            echo form_default_text("nome", "Sistema: *", $row, "style='width:300px;'", "50");
            ...
            echo form_default_dropdown('area', "Área / Gerência:".br()."<div style='font-size:90%; font-style:italic;'>Gerência Responsável pela manutenção neste sistema</div>", $arr_areas, array($row['area']));
