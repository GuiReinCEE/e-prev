...
function filtrar()
{
	...
	$.post('<?php echo site_url('/cadastro/avaliacao_competencia_institucional/listar');?>',
	{
		nome : $('#nome').val()
	},
	function(data)
...
function novo()
{
	location.href='<?php echo site_url("cadastro/avaliacao_competencia_institucional/cadastro"); ?>';
}
