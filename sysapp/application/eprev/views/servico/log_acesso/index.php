...
<script>
	function ir_menu()
	{
		location.href = "<?= site_url('servico/log_acesso/menu') ?>";
	}
	...
	function filtrar()
	{
		...
		if(dt_acesso_ini != '' || dt_acesso_fim != '')
		{
			...
			$.post("<?= site_url('servico/log_acesso/listar') ?>",
	...
	$(function(){
		$("#dt_acesso_ini_dt_acesso_fim_shortcut").val("last7days");
...
<?php
	$abas[] = array('aba_acesso', 'Por Acesso', TRUE, 'location.reload();');
	$abas[] = array('aba_menu', 'Por Menu', FALSE, 'ir_menu();');
