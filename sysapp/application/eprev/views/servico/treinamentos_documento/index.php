...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('servico/treinamentos_documento/listar') ?>",
	...
	function ir_documento_diretoria()
	{
		location.href = "<?= site_url('servico/treinamentos_documento/diretoria') ?>";
	}
...
<?php
	$abas[] = array('aba_lista', 'Treinamento Colaborador', TRUE, 'location.reload();');
	$abas[] = array('aba_lista', 'Treinamento Diretoria', FALSE, 'ir_documento_diretoria();');
