...
<script>
	function filtrar()
	{
		...
		$.post("<?= site_url('servico/meus_treinamentos/listar') ?>",
    ...
    {
        location.href = "<?= site_url('servico/meus_treinamentos_diretoria') ?>"
    }
...
<?php
	...
	$abas[] = array('aba_diretoria', 'Treinamento Diretoria', FALSE, 'ir_diretoria();');
