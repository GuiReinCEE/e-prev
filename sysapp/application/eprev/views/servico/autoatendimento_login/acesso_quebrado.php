<?php
	set_title('Login Autoatendimento - Acesso Quebrado');
...
<script>
	...
	function ir_acesso()
    {
        location.href = "<?= site_url('servico/autoatendimento_login/acesso/'.intval($login['cd_login'])) ?>";
    }
...
<?php
	...
	$abas[] = array('aba_acesso', 'Acesso', FALSE, 'ir_acesso();');
    $abas[] = array('aba_acesso_quebrado', 'Acesso Quebrado', TRUE, 'location.reload();');
