...
<script>
    ...
    {
        location.href = "<?= site_url('servico/meus_treinamentos_diretoria/documento/'.$row['cd_treinamento_colaborador_item']) ?>";
    }
...
<?php
    ...
    echo aba_start($abas);
        echo form_open('servico/meus_treinamentos_diretoria/salvar_anexo');
