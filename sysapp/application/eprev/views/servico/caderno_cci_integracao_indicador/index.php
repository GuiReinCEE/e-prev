<?php
set_title('Caderno CCI Integração Indicador');
...
<?php
	...
	$config['button'][] = array('Nova Integração', 'novo();');
	
	echo aba_start($abas);
		echo form_list_command_bar($config);
		echo form_start_box_filter(); 
			echo filter_text('ds_indicador', 'Indicador:', '', 'style="width:300px;"');
			echo filter_text('ds_caderno_cci_integracao_indicador', 'Referência:', '', 'style="width:300px;"');
