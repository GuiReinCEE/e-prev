<?php
	set_title('Documento Digital Erro Autoatendimento');
	$this->load->view('header');
?>
<script>
	function filtrar()
	{
		var dt_inclusao_ini = $("#dt_inclusao_ini").val();
		var dt_inclusao_fim = $("#dt_inclusao_fim").val();

		if(dt_inclusao_ini != '' || dt_inclusao_fim != '')
		{
			$("#result_div").html("<?= loader_html() ?>");
					
			$.post("<?= site_url('servico/autoatendimento_documento_digital_erro/listar') ?>",
