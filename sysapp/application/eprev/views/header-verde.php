 ...
 <table cellpadding="0" cellspacing="0" width="100%" border="0">
  <tr>
	  ...
	  <td background="<?php echo base_url() ?>skins/skin001/menuant/logobackground.jpg" valign="top">
		...
		<tr>
		<td>
			<div id="page_title" class="topo-segundo"><?php echo get_title(); ?></div>
		</td>
		<td valign="bottom">
			<a style="color:white;font-size:12px;" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>/controle_projetos/cad_recurso_workspace.php"><?php echo $this->session->userdata('usuario') . ' - ' . $this->session->userdata('divisao') ?> - </a><a style="color:white;font-size:12px;" href="<?php echo base_url().index_page(); ?>/login/sair">sair</a>
		</td>
		</tr>
		</table>
