...
echo aba_start( $abas );
	echo form_open('atividade/acompanhamento/salvar_escopo');
		...
		echo form_start_box( "default_escopo_box", "Escopo" );
			...
			echo form_default_row('', '', 'Descrever o que se deseja alcançar com a implementação do projeto.<br/>A identificação do objetivo do projeto acontece na fase de análise de requisitos, durante a avaliação do que deve ser feito e o porque.<br/><br/>');
			echo form_default_textarea('ds_regras', '2) Regras de Negócio/Funcionalidas : ', $row_escopo, 'style="height:100px;"');
...
Descrever a avaliação realizada sobre o impacto que este projeto causa nos demais processos e sistemas, tais como integrações e mudanças.<br/><br/>');
			echo form_default_textarea('ds_responsaveis', '4) Responsáveis : ', $row_escopo, 'style="height:100px;"');
			echo form_default_row('', '', '
Apontar os responsáveis pelos processos envolvidos no projeto.<br/>Estas pessoas deverão estar envolvidas na definição, execução e testes do projeto.<br/>Deverá existir também um ou mais responsáveis pela aprovação do pré-escopo (conforme acordo entre analista e envolvidos).<br/><br/>');
			echo form_default_textarea('ds_solucao', '5) Solução Imediata (opcional) : ', $row_escopo, 'style="height:100px;"');
			...
			echo form_default_textarea('ds_viabilidade', '7) Viabilidade/Sugestão (opcional) : ', $row_escopo, 'style="height:100px;"');
			echo form_default_row('', '', '
