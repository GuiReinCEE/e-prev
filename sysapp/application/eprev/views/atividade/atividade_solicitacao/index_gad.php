...
echo aba_start( $abas );
    echo form_open('atividade/atividade_solicitacao/salvar', 'method="post" id="formulario"');
        echo form_start_box( "default_box", "Cadastro" );
            ...
            echo form_default_textarea('descricao', 'Descrição da Solicitação :*', $row['descricao'], 'style="width:450px; height:100px;"');
            echo form_default_hidden('problema', 'Justificativa da Solicitação:', $row['problema']);
