...
<?php
	echo form_default_js_submit
	 (
		Array('cod_solicitante', 'tipo_solicitacao', 'tipo', 'titulo', 'descricao', 'problema', 'cod_atendente', 'dt_limite'),
		'formValidar(form)'
	 );	
?>
...
echo aba_start( $abas );
    echo form_open('atividade/atividade_solicitacao/salvar', 'method="post" id="formulario"');
        ...
        echo form_start_box( "default_box", "Cadastro" );
            ...
            echo form_default_row('gerencia_destino', 'Gerência de Destino :', $row['cd_gerencia_destino']);
			...
			echo form_default_hidden('fl_abrir_encerrar', '', 'N');
