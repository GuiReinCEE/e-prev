...
<script>
	...
	function filtrar()
	{
		...
		$.post( '<?php echo site_url('atividade/pagamento_cheque/listar_anexo'); ?>',
		{
			cd_pagamento_cheque : $('#cd_pagamento_cheque').val()
		},
		function(data)
		{
	...
	function excluir_anexo(cd_pagamento_cheque_anexo)
	{
		...
		{
			$.post('<?php echo site_url('atividade/pagamento_cheque/excluir_anexo'); ?>',
			{
				cd_pagamento_cheque_anexo : cd_pagamento_cheque_anexo
			}, 
			function (data){ 
				filtrar();
			}, 'html', true);
...
echo aba_start( $abas );
	echo form_open('atividade/calculo_irrf/salvar_anexo', 'name="filter_bar_form"');
		echo form_start_box("default_box", "Cadastro");
			...
			{
				echo form_default_upload_iframe('arquivo', 'pagamento_cheque', 'Anexo :*', '', 'pagamento_cheque', false, '$("form").submit();');
			}
