<?php
set_title('Carta de Concessão - Enviar');
...
<script>	
	function filtrar()
    {
		...
		{
			alert("Informe o Período da Carta de Concessão");
			$("#dt_inicio").focus();
		}
    }
	...
	function enviar()
    {
		...
		{
			var confirmacao = 'Confirma o envio da Carta de Concessão?\n\n'+
							  'Clique [Ok] para Sim\n\n'+
		...
		{
			alert("Selecione o(s) Participante(s) para enviar a Carta de Concessão");
		}
    }	
...
echo aba_start( $abas );
	...
	echo form_start_box_filter('filter_bar', 'Filtros', TRUE);
		echo filter_date_interval('dt_inicio', 'dt_final', 'Período da Carta de Concessão:*');
	...
	echo '<div id="result_div">'.br(2).'<span style="color:green;"><b>Informe o Período da Carta de Concessão</b></span></div>';
	echo br(5);
echo aba_end(); 
