<?php
set_title('Carta de Concessão - Emails');
...
<script>	
	function filtrar()
    {
		if($("#dt_email_ini").val() != "" && $("#dt_email_fim").val() != "")
		{
			...
			$.post('<?php echo site_url('atividade/carta_concessao/emails_listar'); ?>',$('#filter_bar_form').serialize(),
			function(data)
			{
	...
	function ir_lista()
	{
		location.href='<?php echo site_url("atividade/carta_concessao"); ?>';
	}
