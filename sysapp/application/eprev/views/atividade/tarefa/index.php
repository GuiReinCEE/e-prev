...
function load()
{
	...
	$.post( '<?php echo site_url('/atividade/tarefa/listar'); ?>',
	{
...
echo aba_start( $abas );
	...
	echo form_start_box_filter('filter_bar', 'Filtros', FALSE);
		...
		echo form_default_dropdown( 'prioridade', 'Prioridade', $dados );
		echo form_default_dropdown( 'cd_solicitante', 'Solicitante', $solicitante_dd );
		echo form_default_dropdown( 'cd_atendente', 'Atendente', $atendente_dd );
		echo form_default_date_interval("dt_encaminhamento_inicio", "dt_encaminhamento_fim", "Data de encaminhamento", "", "");
		echo form_default_date_interval("dt_concluido_inicio", "dt_concluido_fim", "Data de conclusão", "", "");
		echo form_default_text('cd_atividade', 'Atividade');
		echo form_default_text('cd_tarefa', 'Tarefa');
