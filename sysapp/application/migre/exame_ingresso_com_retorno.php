<?
	...
	$tpl = new TemplatePower('tpl/tpl_exame_ingresso_com_retorno.html');
	$tpl->prepare();
	...
	$qr_sql = " 
				...
				".($_REQUEST['dt_retorno']            == "" ? "" : "AND DATE_TRUNC('day',dt_retorno) BETWEEN ".$_REQUEST['dt_retorno'])."
