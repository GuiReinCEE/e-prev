<?
	...
	if( $ret )
	{
		...
		send_email_confirmando_envio($dal, $db, $mm, $aaaa,'COBRANÇA ATRASO');
		echo 'true';
	}
	else
	{
...
http://www.e-prev.com.br/controle_projetos/contribuicao_sintae_relatorio.php?aba=retornados&mes={MES}&ano={ANO}";
		...
		$texto = str_replace( '{NOME_DO_PROCESSO}', 'Envio de cobrança de contribuições atrasadas do SINTAE', $texto );
