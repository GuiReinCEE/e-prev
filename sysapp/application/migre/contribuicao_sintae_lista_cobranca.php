...
$lista = contribuicao_controle::select_1( $tipo, 10, $ano, $mes );
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
 <HEAD>
  <TITLE>(SINTAE) SINPRORS Previdência Lista de Cobranças Geradas </TITLE>
 ...
 <BODY onload="configure_table();">
	...
	<tr>
		...
		<td style="font-family:arial;padding-left:20px;"><b>LISTA DE <?php echo $_REQUEST['tipo'];?> DO PLANO SINPRORS para competência - <?php echo $mes . '/' . $ano; ?> (SINTAE)</b></td>
	</tr>
	</table>
	<br />
