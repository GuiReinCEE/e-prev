...
{ #begin_class
	...
	#### AVALIADO ####
    public function get_val_ci_avaliado()
    {
		#### Competências Institucionais: ####
		global $db;
		$qr_sql = "
                    SELECT * 
                      FROM projetos.avaliacao_nota_avaliado(".intval($this->capa->get_cd_avaliacao_capa()).") 
                        AS (
		...
		return number_format($ar_reg["grau_institucional"], 2);
    }
    public function get_grau_1_avaliado()
    {
		#### Média: (M1) ####
		global $db;
		$qr_sql = "
		...
		$ob_resul = pg_query($db, $qr_sql);
		$ar_reg = pg_fetch_array($ob_resul);        
		return number_format($ar_reg["grau_1"], 2);
    }
    public function get_val_ce_avaliado()
    {
		...
		$ob_resul = pg_query($db, $qr_sql);
		$ar_reg = pg_fetch_array($ob_resul);        
		return number_format($ar_reg["grau_especific"], 2);
    }
    public function get_val_resp_avaliado()
    {
		#### Responsabilidades: ####
		global $db;
		$qr_sql = "
		...
		$ob_resul = pg_query($db, $qr_sql);
		$ar_reg = pg_fetch_array($ob_resul);        
		return number_format($ar_reg["grau_responsabilidade"], 2);
    }
    public function get_grau_2_avaliado()
    {
		#### Média: (M2)####
		global $db;
		$qr_sql = "
		...
		$ob_resul = pg_query($db, $qr_sql);
		$ar_reg = pg_fetch_array($ob_resul);        
		return number_format($ar_reg["grau_2"], 2);
    }
    public function get_grau_final_avaliado()
    {
		#### Resultado: (40% DE M1) + (60% de M2)####
		global $db;
		$qr_sql = "
                    SELECT * 
                      FROM projetos.avaliacao_nota_avaliado(".intval($this->capa->get_cd_avaliacao_capa()).") 
		...
		$ob_resul = pg_query($db, $qr_sql);
		$ar_reg = pg_fetch_array($ob_resul);        
		return number_format($ar_reg["nota_final"], 2);
    }	
	
	
	#### SUPERIOR ####
    public function get_val_ci_superior()
    {
		#### Competências Institucionais: ####
		global $db;
		$qr_sql = "
                    SELECT * 
                      FROM projetos.avaliacao_nota_superior(".intval($this->capa->get_cd_avaliacao_capa()).") 
                        AS (
							grau_institucional numeric, 
							grau_escolaridade numeric, 
							grau_responsabilidade numeric, 
    ...
    public function get_grau_1_superior()
    {
		#### Média: (M1) ####
		global $db;
		$qr_sql = "
    ...
    public function get_val_ce_superior()
    {
		#### Competências Específicas: ####
		global $db;
		$qr_sql = "
    ...
    public function get_val_resp_superior()
    {
		#### Responsabilidades: ####
		global $db;
		$qr_sql = "
    ...
    public function get_grau_2_superior()
    {
		#### Média: (M2)####
		global $db;
		$qr_sql = "
    ...
    public function get_grau_final_superior()
    {
		#### Resultado: (40% DE M1) + (60% de M2)####
		global $db;
		$qr_sql = "
    ...
    public function calcula_media_ci_comite()
    {
		...
		$qr_sql = "
                    SELECT * 
                      FROM projetos.avaliacao_nota_comite(".intval($this->capa->get_cd_avaliacao_capa()).") 
                        AS (
							grau_institucional numeric, 
							grau_escolaridade numeric, 
							grau_responsabilidade numeric, 
		...
		$this->media_ci_comite = number_format($ar_reg["grau_institucional"], 2);
		/*
		$idx=0;
    ...
    public function get_val_ce_comite()
    {
		#### Competências Específicas: ####
		global $db;
		$qr_sql = "
    ...
    public function get_val_resp_comite()
    {
		#### Responsabilidades: ####
		global $db;
		$qr_sql = "
	...
	public function get_grau_2_comite()
    {
		#### Média: (M2) ####
		global $db;
		$qr_sql = "
...
<table width="100%" class="sort-table" id="table-1" align="center" cellspacing="2" cellpadding="2">
	...
	<tbody>
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			...
			<td align="right" width="50"><?php echo number_format($thisPage->get_val_ci_avaliado(), 2,",","."); ?></td>					
		</tr>
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td>Escolaridade:</td>
			<td align="right"></td>
		...
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			...
			<td align="right"></td>
			<td style="font-weight: bold; font-size: 102%;" align="right"><?php echo number_format($thisPage->get_grau_1_avaliado(), 2,",","."); ?></td>					
		</tr>		
		...
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			...
			<td align="right"></td>													
			<td align="right"><?php echo number_format($thisPage->get_val_ce_avaliado(), 2,",","."); ?></td>					
		</tr>		
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td>Responsabilidades:</td>
			<td align="right"></td>	
			<td align="right"><?php echo number_format($thisPage->get_val_resp_avaliado(), 2,",","."); ?></td>					
		</tr>
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td style="font-weight: bold; font-size: 102%;">Média: <span style='font-size: 80%; color:999999; font-weight: bold;'>(<b>M2</b>)</span></td>
			<td></td>
			<td style="font-weight: bold; font-size: 102%;" align="right"><?php echo number_format($thisPage->get_grau_2_avaliado(), 2,",","."); ?></td>					
		</tr>
		...
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			...
			<td></td>
			<td style="font-weight: bold; font-size: 110%;" align="right"><?php echo number_format($thisPage->get_grau_final_avaliado(), 2,",","."); ?></td>					
		</tr>	
	</tbody>
</table>						
<BR>
...
<table width="100%" class="sort-table" id="table-1" align="center" cellspacing="2" cellpadding="2">
	...
	<tbody>
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td>Competências Institucionais:</td>
			<td align="right" width="12"></td>
			<td align="right" width="50"><?php echo number_format($thisPage->get_val_ci_superior(), 2,",","."); ?></td>					
		</tr>
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td>Escolaridade:</td>
			<td align="right"></td>
		...
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td style="font-weight: bold; font-size: 102%;">Média: <span style='font-size: 80%; color:999999; font-weight: bold;'>(<b>M1</b>)</span></td>
			<td align="right"></td>
			<td style="font-weight: bold; font-size: 102%;" align="right"><?php echo number_format($thisPage->get_grau_1_superior(), 2,",","."); ?></td>					
		</tr>		
		...
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			...
			<td align="right"><?php echo number_format($thisPage->get_val_ce_superior(), 2,",","."); ?></td>					
		</tr>		
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td>Responsabilidades:</td>
			<td align="right">
			...
			<td align="right"><?php echo number_format($thisPage->get_val_resp_superior(), 2,",","."); ?></td>					
		</tr>
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td style="font-weight: bold; font-size: 102%;">Média: <span style='font-size: 80%; color:999999; font-weight: bold;'>(<b>M2</b>)</span></td>
			<td></td>
			<td style="font-weight: bold; font-size: 102%;" align="right"><?php echo number_format($thisPage->get_grau_2_superior(), 2,",","."); ?></td>					
		</tr>
		...
		<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
			<td style="font-weight: bold; font-size: 110%;">Resultado: <span style='font-size: 80%; color:999999; font-weight: bold;'>(40% DE M1) + (60% de M2)</span></td>
			<td></td>
			<td style="font-weight: bold; font-size: 110%;" align="right"><?php echo number_format($thisPage->get_grau_final_superior(), 2,",","."); ?></td>					
		</tr>	
	</tbody>
</table>						
								...
								<table width="100%" class="sort-table" id="table-1" align="center" cellspacing="2" cellpadding="2">
									...
									<tbody>
										...
										<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
											<td>Competências Específicas:</td>
											<td></td>
											<td align="right"><?php echo number_format($thisPage->get_val_ce_comite(), 2,",","."); ?></td>		
										</tr>		
										<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
											<td>Responsabilidades:</td>
											<td></td>
											<td align="right"><?php echo number_format($thisPage->get_val_resp_comite(), 2,",","."); ?></td>	
										</tr>
										<tr onmouseover="sortSetClassOver(this);" onmouseout="sortSetClassOut(this);">
											<td style="font-weight: bold; font-size: 102%;">Média: <span style='font-size: 80%; color:999999; font-weight: bold;'>(<b>M2</b>)</span></td>
											<td></td>
											<td style="font-weight: bold; font-size: 102%;" align="right"><?php echo number_format($thisPage->get_grau_2_comite(), 2,",","."); ?></td>
										</tr>
