...
class contribuicao_sintae_partial_atraso
{
	private $command;
	private $params;
	...
	public function get_total_bco()
	{
		...
		$emp = enum_public_patrocinadoras::SINTAE;
...
// endclass
$esta = new contribuicao_sintae_partial_atraso();
?>
...
>
	...
	<tr>
		...
		<td style="font-family:arial;padding-left:20px;"><b>SINTAE - Cobrança Mensal - Lista de participantes sem email</b></td>
	</tr>
	</table>
	<br>
