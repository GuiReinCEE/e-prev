var esta =
{
	...
	aba_atraso__Click : function()
	{
		...
		(
			  'div_content'
			, 'contribuicao_sintae_partial_atraso.php?' + Math.random()
			, {
	...
	aba_primeiro__Click : function()
	{
		...
		(
			  'div_content'
			, 'contribuicao_sintae_partial_primeiro_pgto.php?' + Math.random()
			, {
				parameters: { mes: $F('mes_competencia__text'), ano: $F('ano_competencia__text') },
				onComplete:configure_table__sem_email
			  }
	...
	aba_mensal__Click : function()
	{
		...
		new Ajax.Updater('div_content', 'contribuicao_sintae_partial_mensal.php?' + Math.random(), {
		  parameters: { mes: $F('mes_competencia__text'), ano: $F('ano_competencia__text') },
		  onComplete: configure_table__sem_email
		});
	...
	aba_relatorio__Click : function()
	{
		...
		(
			  'div_content'
			, 'contribuicao_sintae_partial_relatorio.php?' + Math.random()
			, {
				parameters: { mes: $F('mes_competencia__text'), ano: $F('ano_competencia__text') },
	...
	aba_relatorio_email__Click : function()
	{
		...
		(
			  'div_content'
			, 'contribuicao_sintae_partial_email.php?' + Math.random()
			, {
	...
	gerar_cobranca_1ro__click : function()
	{
		...
		{
			url = "contribuicao_sintae_partial_primeiro_pgto.php?" + Math.random();
	...
	gerar_cobranca_mensal__click : function()
	{
		...
		{
			url = "contribuicao_sintae_partial_mensal.php?" + Math.random();
			new Ajax.Updater( 'result_div', url,
			{
				method: 'post',
				parameters: 
	...
	gerar_cobranca_atraso__click : function()
	{
		...
		{
			url = "contribuicao_sintae_partial_atraso.php?" + Math.random();
			new Ajax.Updater( 'result_div', url,
			{
				method: 'post',
				parameters: 
	...
	{
		window.open('contribuicao_sintae_lista_cobranca.php?tipo=primeiro&mes=' + $F('mes_competencia__text') + '&ano=' + $F('ano_competencia__text') + '', '_blank');
	},

	listar_gerados_mensal__click : function()
	{
		window.open('contribuicao_sintae_lista_cobranca.php?tipo=mensal&mes=' + $F('mes_competencia__text') + '&ano=' + $F('ano_competencia__text') + '', '_blank');
	},

	listar_gerados_atraso__click : function()
	{
		window.open('contribuicao_sintae_lista_cobranca.php?tipo=atraso&mes=' + $F('mes_competencia__text') + '&ano=' + $F('ano_competencia__text') + '', '_blank');
	},
	...
	enviar_email_1ro__click : function()
	{
		...
		{
			url="contribuicao_sintae_enviar_email_primeiro.php?" + Math.random();
			new Ajax.Updater( 'result_div', url,
			{
				method: 'post',
				parameters: 
	...
	enviar_email_mensal__click : function()
	{
		if(confirm('ATENÇÃO esta ação é irreversível.\n\n' +
				...
				'Confirma o envio de emails de contribuição para a competência ' + $F('mes_competencia__text') + '/'+ $F('ano_competencia__text') + '?' ))
		{
			url="contribuicao_sintae_enviar_email_mensal.php?" + Math.random();
			new Ajax.Updater( 'result_div', url,
			{
				method: 'post',
				parameters: 
	...
	enviar_email_atraso__click : function()
	{
		...
		{
			url="contribuicao_sintae_enviar_email_atraso.php?" + Math.random();
			new Ajax.Updater( 'result_div', url,
			{
				method: 'post',
				parameters: 
	...
	send_mail__Click : function(sender)
	{
		...
		{
			if(sender=="primeiro") url="contribuicao_sintae_enviar_email_primeiro.php?" + Math.random();
			if(sender=="mensal") url="contribuicao_sintae_enviar_email_mensal.php?" + Math.random();
			new Ajax.Updater( 'result_div', url,
			{
				method: 'post',
				parameters: 
...
{
	window.open( 'contribuicao_sintae_lista_sem_email.php', 'mylist' );
}
