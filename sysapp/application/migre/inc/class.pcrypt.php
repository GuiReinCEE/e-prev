...
class pcrypt
{
    ...
    function pcrypt($blockmode = MODE_ECB, $cipher = 'BLOWFISH', $key = null)
    {
        ...
        if (!file_exists("./inc/cipher/".$cipher.".php")) 
        {
            $this->error("Unknown Cipher ".$cipher);
        }
        include_once "./inc/cipher/".$cipher.".php";
    ...
    /** Decrypt using the selected algorithm
      ...
      * TO DO: Discover the algorithm and mode auto
      *
      * @access public
    ...
    /**
      ...
      * 
      * TO DO: Improve the error handling of the class 
      *
      * @access private
