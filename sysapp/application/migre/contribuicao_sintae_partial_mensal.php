...
using( array('public.titulares_planos', 'public.cobrancas', 'projetos.contribuicao_controle', 'public.bloqueto') );

class contribuicao_sintae_partial_mensal
{
	private $service;
	private $command;
	private $params;
	...
	private function start()
	{
		...
		$totais_pp = $this->service->contribuicao_sinpro__totais__get('mensal internet', $this->params, enum_public_patrocinadoras::SINTAE);

		$totais_bdl = $this->service->contribuicao_sinpro__totais__get('mensal bdl', $this->params, enum_public_patrocinadoras::SINTAE);

		$totais_arrec = $this->service->contribuicao_sinpro__totais__get('mensal arrecadacao', $this->params, enum_public_patrocinadoras::SINTAE);
	...
	{
		return $this->service->contribuicao_sinpro__emails_enviar_mensal__get( $this->params, enum_public_patrocinadoras::SINTAE );
	}
	
	private function get_lista_sem_email()
	{
		return $this->service->contribuicao_sinpro__lista_sem_email_mensal( $this->params, enum_public_patrocinadoras::SINTAE );
	}
	...
	public function get_emails_gerados()
	{
		...
		$args['cd_empresa'] = enum_public_patrocinadoras::SINTAE;
...
// endclass
$esta = new contribuicao_sintae_partial_mensal($db);
?>
...
>
	...
	<tr>
		...
		<td style="font-family:arial;padding-left:20px;"><b>SINPRORS - Cobrança Mensal - Lista de participantes sem email (SINTAE)</b></td>
	</tr>
	</table>
	<br>
