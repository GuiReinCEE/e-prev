<?php
	...
	$txt_dt_limite        = ($dt_limite             == '' ? 'NULL' : "TO_DATE('".trim($dt_limite)."','DD/MM/YYYY')" );
		...
		$sql = " 
				...
				VALUES 
					 (                 
						...
						".$txt_descricao.",            
						'".$cbo_recorrente."',         
						(SELECT divisao FROM projetos.usuarios_controledi WHERE codigo = ".$cbo_analista."),
						".$txt_dt_inicio_prev.",       
						".$txt_problema.",             
						".$txt_solucao.",              
						".$txt_dt_inicio_real.",       
    ...
    else 
    {
		...
		$sql.= (((trim($txt_dt_limite) != "") and (trim($txt_dt_limite) != "NULL")) ? " dt_limite = ".$txt_dt_limite.", " : "");
