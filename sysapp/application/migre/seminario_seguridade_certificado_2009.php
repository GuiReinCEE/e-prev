<?
	...
	$qr_select = "
					SELECT cd_seminario_seguridade, 
					 ...
					 WHERE MD5(cd_seminario_seguridade::TEXT) = '".$_REQUEST['id']."'
				 ";
	...
	{	
		...
		$ob_pdf->AddPage();
		$ob_pdf->Image('img/seminario_seguridade_certificado_2009.jpg', 0, 0, ConvertSize(1123,$ob_pdf->pgwidth), ConvertSize(795,$ob_pdf->pgwidth),'','',false);
		$ob_pdf->SetXY(5,93);
		$ob_pdf->SetFont('Courier','B',22);
		$ob_pdf->MultiCell(295, 4, $ar_reg['nome'],0,"C");
	}
