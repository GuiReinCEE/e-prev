...
<?
    ...
    class atendimento_recadastro_partial_lista
    {
        ...
        function requestParams()
        {
            ...
            {
                $this->filtro->cd_empresa = $_REQUEST["FiltroEmpresaText"];
			}
            if (isset($_REQUEST["FiltroREText"]))
            {
                $this->filtro->cd_registro_empregado = $_REQUEST["FiltroREText"];
			}
            if (isset($_REQUEST["FiltroSeqText"]))
            {
                $this->filtro->seq_dependencia = $_REQUEST["FiltroSeqText"];
			}
                                                ...
                                                <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <tr>
                                                                <th>EMP/RE/SEQ:</th>
                                                                <td><input id="filtro_empresa_text" name="FiltroEmpresaText" style="width:50px" title="Código da Empresa" value="<?=$thisPage->getFiltro()->cd_empresa?>" />
                                                                <input id="filtro_re_text" name="FiltroREText" style="width:70px" title="Registro do Empregado com dígito (apenas números)" value="<?=$thisPage->getFiltro()->cd_registro_empregado?>" />
                                                                <input id="filtro_seq_text" name="FiltroSeqText" style="width:50px" title="Sequência de dependência" value="<?=$thisPage->getFiltro()->seq_dependencia?>" /></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td><input id="filtro_dtgap_text" 
                        											...
                        											maxlenght="10" 
                                                                	/>
                                                                até <input id="filtro_dtgap_final_text"
                                        ...
                                        <td>
                                            ...
                                            <table align='center' class='tb_lista_resultado'>
                                                ...
                                                <tr bgcolor="<?php if($bgcolor!="#ffffff") $bgcolor="#ffffff"; else $bgcolor="#f4f4f4"; echo($bgcolor); ?>">
                                                    ...
                                                    {
                                                    	echo $row["dt_atualizacao"].' por '.$row["nome_usuario_atualizacao"]; 
                                                    }
                                                    ?></td>
